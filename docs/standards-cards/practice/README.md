...
| [form-archetypes.md](./form-archetypes.md) | Архетипы и компоновка форм | Проектируете форму — архетипы по типам (документ/обработка/список/справочник), конвенции именования, принципы компоновки |
