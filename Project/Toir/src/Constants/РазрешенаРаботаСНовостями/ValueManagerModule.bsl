...
Процедура ПриЗаписи(Отказ)
	...
	Если ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации() Тогда
		...
		ТекстСообщения = НСтр("es='Es anotada la constante de RazreshenaRabotaSNovostyami "
"el significado Anterior: %ПредыдущееЗначение del % "
"el Nuevo significado: %НовоеЗначение del %';ru='Записана константа РазрешенаРаботаСНовостями"
