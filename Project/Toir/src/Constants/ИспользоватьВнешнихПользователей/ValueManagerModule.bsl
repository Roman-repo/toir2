...
Процедура ПередЗаписью(Отказ)
	...
	Если ЗначениеИзменено
	   ...
	   И Не ПользователиСлужебный.ВнешниеПользователиВнедрены() Тогда
		ВызватьИсключение НСтр("es='El uso de los usuarios exteriores no es previsto en el programa.';ru='Использование внешних пользователей не предусмотрено в программе.';en='The use of external users is not provided in the program.'");
	КонецЕсли;
