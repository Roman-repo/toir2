...
Процедура ПриЗаписи(Отказ)
	...
	Если ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации() Тогда
		...
		ТекстСообщения = НСтр("es='Es anotada la constante de RazreshenaRabotaSnovostyamiCherezInternet "
"el significado Anterior: %ПредыдущееЗначение del % "
"el Nuevo significado: %НовоеЗначение del %';ru='Записана константа РазрешенаРаботаСНовостямиЧерезИнтернет"
"Предыдущее значение: %ПредыдущееЗначение%"
"Новое значение: %НовоеЗначение%';en='Constant  is written НастройкиНовостей"
"Предыдущее значение:"
"%ПредыдущееЗначение%                                   New value: %                       НовоеЗначение%'");
		...
		ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("es='БИП:Новости. El cambio de los datos';ru='БИП:Новости.Изменение данных';en='BIP: News Data Changes'"), // ИдентификаторШага
