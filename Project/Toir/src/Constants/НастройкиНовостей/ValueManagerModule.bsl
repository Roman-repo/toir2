...
Процедура ПриЗаписи(Отказ)
	...
	Если ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации() Тогда
		...
		ТекстСообщения = НСтр("es='Es anotada la constante de NastroykiNovostey "
"el significado Anterior: "
"%ПредыдущееЗначение del % "
""
"el Nuevo significado: "
"%НовоеЗначение del %';ru='Записана константа НастройкиНовостей"
"Предыдущее значение:"
"%ПредыдущееЗначение%"
""
"Новое значение:"
"%НовоеЗначение%';en='Constant  is written НастройкиНовостей"
"Предыдущее значение:"
"%ПредыдущееЗначение%                                   New value                       %НовоеЗначение%'");
		...
		ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("es='Las novedades. El cambio de los datos. Las constantes. НастройкиНовостей';ru='Новости. Изменение данных. Константы. НастройкиНовостей';en='News. Data change. Constants НастройкиНовостей'"), // ИдентификаторШага
