...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если СведенияОПланеОбмена.РазделенныйРежим Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(
			НСтр("es='La carga de las reglas del cambio para los datos en el régimen dividido es inaccesible.';ru='Загрузка правил обмена данными в разделенном режиме недоступна.';en='Downloading sharing rules in split mode is not available.'"));
		Возврат;
	КонецЕсли;
