...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(ГлавныйУзел) Тогда
		ВызватьИсключение НСтр("es='El nudo principal no es conservado.';ru='Главный узел не сохранен.';en='The master node is not saved.'");
	КонецЕсли;
	
	Если ПланыОбмена.ГлавныйУзел() <> Неопределено Тогда
		ВызватьИсключение НСтр("es='El nudo principal es establecido.';ru='Главный узел установлен.';en='The main node is installed.'");
	КонецЕсли;
