	...
	Если ДоступныеНаборыСвойств.Количество() = 0
	 ИЛИ НЕ ЗначениеЗаполнено(ДоступныеНаборыСвойств[0].Значение) Тогда
		...
		ПоказатьПредупреждение(,
			НСтр("es='No consiguió recibir los juegos de las noticias adicionales del objeto. "
""
"Probablemente cerca del objeto no son rellenados los requisitos necesarios.';ru='Не удалось получить наборы дополнительных сведений объекта."
""
"Возможно у объекта не заполнены необходимые реквизиты.';en='Failed to get sets of additional object information."
""
