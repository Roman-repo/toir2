...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РежимПодбора Тогда
		Заголовок = НСтр("es='La selección de los nudos de los planes del cambio';ru='Подбор узлов планов обмена';en='Selection of nodes of exchange plans'");
	КонецЕсли;
...
Процедура Выбрать(Команда)
	...
	Иначе
		...
		Если ТекущиеДанные = Неопределено Тогда
			ПоказатьПредупреждение(, НСтр("es='El nudo no es escogido.';ru='Узел не выбран.';en='Node selected.'"));
		Иначе
...
Процедура ДобавитьИспользуемыйПланОбмена(ОбъектМетаданных)
	...
	Если Параметры.ВыбиратьВсеУзлы Тогда
		...
		НоваяСтрока.УзелПредставление       = НСтр("es='<Todas las bases informativas>';ru='<Все информационные базы>';en='<Все информационные базы>'");
	КонецЕсли;
