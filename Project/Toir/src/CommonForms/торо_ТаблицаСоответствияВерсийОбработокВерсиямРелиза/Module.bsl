...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Исключение
		ТекстСообщения = НСтр("es='¡No consiguió determinar la versión corriente del tratamiento del cálculo ППР!';ru='Не удалось определить текущую версию обработки расчета ППР!';en='Failed to determine the current version of the processing of the calculation of the outflow!'");
