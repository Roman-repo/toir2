...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СтандартныеПодсистемыСервер.ЭтоБазоваяВерсияКонфигурации() Тогда
		ВызватьИсключение НСтр("es='El régimen corriente del trabajo no es apoyado.';ru='Текущий режим работы не поддерживается.';en='The current operating mode is not supported.'");
	КонецЕсли;
...
Процедура ДекорацияЖурналРегистрацииНажатие(Элемент)
	...
	МассивСобытий.Добавить(НСтр("es='Las correcciones. La instalación';ru='Исправления. Установка';en='Corrections. Installation'"));
	МассивСобытий.Добавить(НСтр("es='Las correcciones. El cambio';ru='Исправления. Изменение';en='Corrections. Change'"));
	МассивСобытий.Добавить(НСтр("es='Las correcciones. La desaparición';ru='Исправления. Удаление';en='Corrections. Delete'"));
...
Процедура УдалитьРасширения(ВыделенныеСтроки)
	...
	Если ВыделенныеСтроки.Количество() > 1 Тогда
		ТекстВопроса = НСтр("es='¿Quitar las correcciones distinguidas?';ru='Удалить выделенные исправления?';en='Delete highlighted fixes?'", "ru");
	Иначе
		ТекстВопроса = НСтр("es='¿Quitar la corrección?';ru='Удалить исправление?';en='Delete fix?'", "ru");
	КонецЕсли;
