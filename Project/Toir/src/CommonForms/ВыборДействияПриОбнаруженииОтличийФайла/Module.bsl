...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТестНовее = " (" + НСтр("es='новее';ru='новее';en='newer'") + ")";
	...
	Иначе
		ВызватьИсключение НСтр("es='La acción desconocida sobre el fichero';ru='Неизвестное действие над файлом';en='Unknown file action.'");
	КонецЕсли;
