...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		Отказ = Истина;
		ВызватьИсключение НСтр("es='La operación no es accesible en el cliente móvil, es necesario usar el cliente delgado.';ru='Операция не доступна в мобильном клиенте, необходимо использовать тонкий клиент.';en='The operation is not available in the mobile client, you must use a thin client.'");
	КонецЕсли;
