...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена = НСтр("es='El ajuste de la sincronización con 1С:ERP, ред. 2.4';ru='Настройка синхронизации с 1С:ERP, ред. 2.4';en='Setting data synchronization with 1C: ERP, ed. 2.4'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена = НСтр("es='La sincronización con 1С:ERP, ред. 2.4';ru='Синхронизация с 1С:ERP, ред. 2.4';en='Synchronization with 1C: ERP, ed. 2.4'");
	
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника = НСтр("es='Los ajustes de la sincronización para EAM ERP';ru='Настройки синхронизации для EAM ERP';en='Sync Settings for EAM ERP'");
	...
	ОписаниеВарианта.КраткаяИнформацияПоОбмену = НСтр("es='El ajuste dado permitirá sincronizar los datos entre los programas 1С: ТОИР la Dirección de las reparaciones y el servicio de la maquinaria 2.0 y 1С: ERP la Dirección de la empresa, la redacción 2.4.';ru='Данная настройка позволит синхронизировать данные между программами 1С: ТОИР Управление ремонтами и обслуживанием оборудования 2.0 и 1С: ERP Управление предприятием, редакция 2.4.';en='This setting will allow you to synchronize data between the programs 1C: MRO Maintenance and repair of equipment 2.0 and 1C: ERP Enterprise management, edition 2.4.'");
	...
	ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "1С:ERP, ред. 2.4";
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента = "1С:ERP, ред. 2.4";
