...
Процедура ВыбратьОрганизации(Команда)
	...
	СписокВыбораОрганизаций.ПоказатьОтметкуЭлементов(ОписаниеОповещения,НСтр("es='Escojan las organizaciones para la selección';ru='Выберите организации для отбора';en='Select organizations to select'"));
...
Процедура УказатьСклады(Команда)
	...
	СписокВыбораСкладов.ПоказатьОтметкуЭлементов(ОписаниеОповещения,НСтр("es='Escojan los almacenes para la selección';ru='Выберите склады для отбора';en='Choose warehouses for selection'"));
