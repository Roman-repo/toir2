...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена = НСтр("es='El ajuste de la sincronización con 1С:УПП, ред. 1.3';ru='Настройка синхронизации с 1С:УПП, ред. 1.3';en='Setting data synchronization with 1C: soft starter, red. 1.3'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена = НСтр("es='La sincronización con 1С:УПП, ред. 1.3';ru='Синхронизация с 1С:УПП, ред. 1.3';en='Synchronization with 1C: SCP, ed. 1.3'");
	
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника = НСтр("es='Los ajustes de la sincronización para EAM УПП';ru='Настройки синхронизации для EAM УПП';en='Sync settings for EAM soft starter'");
	...
	ОписаниеВарианта.КраткаяИнформацияПоОбмену = НСтр("es='El ajuste dado permitirá sincronizar los datos entre los programas 1С: ТОИР la Dirección de las reparaciones y el servicio de la maquinaria 2.0 y 1С: la Dirección de la empresa de producción, la redacción 1.3.';ru='Данная настройка позволит синхронизировать данные между программами 1С: ТОИР Управление ремонтами и обслуживанием оборудования 2.0 и 1С: Управление производственным предприятием, редакция 1.3.';en='This setting will allow you to synchronize data between the programs 1C: MRO Maintenance and repair of equipment 2.0 and 1C: Industrial enterprise management, revision 1.3.'");
	...
	Иначе
		ОписаниеВарианта.ПодробнаяИнформацияПоОбмену =  "ПланОбмена.ОбменТОиР20УПП.Форма.ПодробнаяИнформация";
	КонецЕсли;
	ОписаниеВарианта.ПояснениеДляНастройкиПараметровУчета =  НСтр("es='??????';ru='??????';en='??????'");
