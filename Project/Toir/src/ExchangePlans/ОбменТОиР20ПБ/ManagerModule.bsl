...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	ОписаниеВарианта.ЗаголовокПомощникаСозданияОбмена = НСтр("es='El ajuste de la sincronización con 1С:ПБ, ред. 1.4';ru='Настройка синхронизации с 1С:ПБ, ред. 1.4';en='Setting synchronization with 1C: PB, red. 1.4'");
	ОписаниеВарианта.ЗаголовокУзлаПланаОбмена = НСтр("es='La sincronización con 1С:ПБ, ред. 1.4';ru='Синхронизация с 1С:ПБ, ред. 1.4';en='Synchronization with 1C: PB, ed. 1.4'");
	
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника = НСтр("es='Los ajustes de la sincronización para la seguridad De producción. La seguridad industrial, la redacción 1.0';ru='Настройки синхронизации для Производственная безопасность. Промышленная безопасность, редакция 1.0';en='Sync Settings for Industrial Safety. Industrial Safety Edition 1.0'");
	...
	ОписаниеВарианта.КраткаяИнформацияПоОбмену = НСтр("ru = 'Данная настройка позволит синхронизировать данные между программами 1С: ТОИР Управление ремонтами и обслуживанием оборудования 2.0 и 1С:Производственная безопасность. Промышленная безопасность, редакция 1.0");
	...
	ОписаниеВарианта.ИмяКонфигурацииКорреспондента = "1С:ПБ, ред. 1.4";
	ОписаниеВарианта.НаименованиеКонфигурацииКорреспондента = "1С:ПБ, ред. 1.4";
