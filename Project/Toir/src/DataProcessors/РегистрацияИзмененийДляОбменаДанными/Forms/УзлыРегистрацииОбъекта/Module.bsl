...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЧастиЗаголовка.Добавить(НСтр("es='El registro';ru='Регистрация';en='registration'"));
...
Процедура ИзменитьРегистрацию(Команда)
	...
	Текст = НСтр("es='¿Cambiar el registro ""%1"" "
"sobre los nudos?';ru='Изменить регистрацию ""%1"""
"на узлах?';en='Change registration ""%1"" on the nodes? '");
...
Процедура ИзменитьРегистрациюЗавершение(Знач РезультатВопроса, Знач ДополнительныеПараметры) Экспорт
	...
	Если Количество > 0 Тогда
		Текст = НСтр("es='El registro %1 era cambiado sobre %2 nudos';ru='Регистрация %1 была изменена на %2 узлах';en='Registration%1 has been changed to%2 nodes'");
		ЗаголовокОповещения = НСтр("es='El cambio del registro:';ru='Изменение регистрации:';en='Registration change:'");
...
Процедура УстановитьУсловноеОформление()
	...
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='ДеревоУзловОбменаНомерСообщения';ru='ДеревоУзловОбменаНомерСообщения';en='ДеревоУзловОбменаНомерСообщения'"));
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='ДеревоУзловОбменаНомерСообщения';ru='ДеревоУзловОбменаНомерСообщения';en='ДеревоУзловОбменаНомерСообщения'"));
