...
Процедура АдресатНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Иначе	
		ТекстСообщения = НСтр("es='""el Destinatario""';ru='Не заполнено поле ""Получатель""';en='The field ""Recipient"" is not filled'");
...
"el documento saliente al objeto %1';ru='Перед добавлением печатной формы нужно связать"
"исходящий документ с объектом %1';en='Before adding a printing plate, you need to bind"
"outgoing document with object %1'"), СокращенноеНаименованиеКонфигурации);
