...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("es='Una nueva pregunta';ru='Новый вопрос';en='New question'");
...
Процедура ЗаписатьБизнесПроцесс(Команда)
	...
	Если РезультатЗаписи Тогда
		...
		Заголовок = НСтр("es='La pregunta:';ru='Вопрос:';en='Question:'")+" "+Описание;
...
Процедура СтартоватьИЗакрыть(Команда)
	...
	Если Не ЗначениеЗаполнено(Описание) Тогда 
		...
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
			ОбщегоНазначенияКлиентСервер.ТекстОшибкиЗаполнения(,, НСтр("es='La descripción';ru='Описание';en='Description'")),,
			"РезультатВыполнения");
		Возврат;
	КонецЕсли;
