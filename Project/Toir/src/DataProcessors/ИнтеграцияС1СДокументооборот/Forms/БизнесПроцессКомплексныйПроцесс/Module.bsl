...
Процедура ЗаписатьБизнесПроцесс(Команда)
	...
	Если РезультатЗаписи Тогда
		...
		Состояние(СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("es='El proceso de negocios ""%1"" es conservado.';ru='Бизнес-процесс ""%1"" сохранен.';en=""Business process '%1' saved."""), Представление));
	КонецЕсли;
...
Процедура СтартоватьИЗакрыть(Команда)
	...
	Если РезультатЗапуска Тогда
		...
		ТекстСостояния = НСтр("es='El proceso de negocios ""%Наименование del %"" es con éxito puesto en marcha.';ru='Бизнес-процесс ""%Наименование%"" успешно запущен.';en='The business process ""% Name%"" has been started successfully.'");
