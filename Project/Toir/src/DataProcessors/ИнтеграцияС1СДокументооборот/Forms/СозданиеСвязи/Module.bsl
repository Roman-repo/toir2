...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ПодходящиеДокументы.Количество() <> 0 Тогда
		...
		СтрокаГруппа.Представление = СтрШаблон(
			НСтр("es='Conveniente (%1)';ru='Подходящие (%1)';en='Suitable (%1)'"), 
	...
	СтрокаГруппа = ЭлементыДерева.Добавить();
	СтрокаГруппа.ЭтоГруппа = Истина;
	СтрокаГруппа.Представление = НСтр("es='Posible (3)';ru='Возможные (3)';en='Possible (3)'");
		
	ЭлементыГруппы = СтрокаГруппа.ПолучитьЭлементы();
	
	СтрокаЭлемент = ЭлементыГруппы.Добавить();
	СтрокаЭлемент.Тип = "DMInternalDocument";
	СтрокаЭлемент.Представление = НСтр("es='El documento interior';ru='Внутренний документ';en='Internal document'");
	
	СтрокаЭлемент = ЭлементыГруппы.Добавить();
	СтрокаЭлемент.Тип = "DMIncomingDocument";
	СтрокаЭлемент.Представление = НСтр("es='El documento recibido';ru='Входящий документ';en='Incoming document'");
	
	СтрокаЭлемент = ЭлементыГруппы.Добавить();
	СтрокаЭлемент.Тип = "DMOutgoingDocument";
	СтрокаЭлемент.Представление = НСтр("es='El documento saliente';ru='Исходящий документ';en='Outgoing document'");
