...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДниНедели.Добавить(Нстр("es='El lunes';ru='Понедельник';en='Monday'"));
	ДниНедели.Добавить(Нстр("es='El martes';ru='Вторник';en='Tuesday'"));
	ДниНедели.Добавить(Нстр("es='El ambiente';ru='Среда';en='Wednesday'"));
	ДниНедели.Добавить(Нстр("es='El jueves';ru='Четверг';en='Thursday'"));
	ДниНедели.Добавить(Нстр("es='El viernes';ru='Пятница';en='Friday'"));
	ДниНедели.Добавить(Нстр("es='El sábado';ru='Суббота';en='Saturday'"));
	ДниНедели.Добавить(Нстр("es='El domingo';ru='Воскресенье';en='Sunday'"));
...
Процедура УстановитьПометкуУдаленияНаКлиенте()
	...
	Если Элементы.Список.ВыделенныеСтроки.Количество() = 1 Тогда
		ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			    НСтр("es='¿Marcar ""%1"" a la desaparición?';ru='Пометить ""%1"" на удаление?';en='Mark ""%1"" for deletion?'"), Элементы.Список.ТекущиеДанные.Ссылка);
	Иначе			
