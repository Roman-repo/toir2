...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипОбъектаВыбора = "DMIncomingDocument" 
		...
		ДобавитьРеквизитПоиска("documentType", НСтр("es='El tipo del documento';ru='Вид документа';en='Document type'"), ТипОбъектаВыбора + "Type");
		ДобавитьРеквизитПоиска("summary", НСтр("es='El contenido';ru='Содержание';en='Content'"), "Строка");
		ДобавитьРеквизитПоиска("comment", НСтр("es='El comentario';ru='Комментарий';en='Comment'"), "Строка");
		ДобавитьРеквизитПоиска("regNumber", НСтр("es='Рег. El número';ru='Рег. номер';en='Reg. number'"), "Строка");
		ДобавитьРеквизитПоиска("regDate", НСтр("es='La fecha del registro';ru='Дата регистрации';en='Registration date'"), "Дата");
		ДобавитьРеквизитПоиска("sum", НСтр("es='La suma';ru='Сумма';en='Amount'"), "Число");
		ДобавитьРеквизитПоиска("currency", НСтр("es='La divisa';ru='Валюта';en='Currency'"), "DMCurrency");
		ДобавитьРеквизитПоиска("organization", НСтр("es='La organización';ru='Организация';en='Organization'"), "DMOrganization");
		ДобавитьРеквизитПоиска("subdivision", НСтр("es='La subdivisión';ru='Подразделение';en='Subdivision'"), "DMSubdivision");
		ДобавитьРеквизитПоиска("accessLevel", НСтр("es='El grifo del acceso';ru='Гриф доступа';en='Access bar'"), "DMAccessLevel");
		ДобавитьРеквизитПоиска("performanceDate", НСтр("es='El plazo de la realización';ru='Срок исполнения';en='Period of execution'"), "Дата");
		ДобавитьРеквизитПоиска("activityMatter", НСтр("es='La pregunta de la actividad';ru='Вопрос деятельности';en='Question of activity'"), "DMActivityMatter");
		ДобавитьРеквизитПоиска("responsible", НСтр("es='Responsable';ru='Ответственный';en='Responsible'"), "DMUser");
		ДобавитьРеквизитПоиска("project", НСтр("es='El proyecto';ru='Проект';en='Project'"), "DMProject");
		Если ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("1.4.7.1") Тогда
			ДобавитьРеквизитПоиска("status", НСтр("es='El estado';ru='Состояние';en='Status '"), "DMDocumentStatus");
		КонецЕсли;
	КонецЕсли;
	
	Если ТипОбъектаВыбора = "DMIncomingDocument" Тогда
		ДобавитьРеквизитПоиска("externalNumber", НСтр("es='El número de salida';ru='Исходящий номер';en='Outgoing number'"), "Строка");
		ДобавитьРеквизитПоиска("externalDate", НСтр("es='La fecha saliente';ru='Исходящая дата';en='Outgoing date'"), "Дата");
		ДобавитьРеквизитПоиска("correspondent", НСтр("es='El remitente';ru='Отправитель';en='Sender'"), "DMCorrespondent");
		ДобавитьРеквизитПоиска("signer", НСтр("es='Ha firmado';ru='Подписал';en='Signed'"), "DMContactPerson");
		ДобавитьРеквизитПоиска("addressee", НСтр("es='El destinatario';ru='Адресат';en='Destination'"), "DMUser");
		ДобавитьРеквизитПоиска("deliveryMethod", НСтр("es='El modo de la recepción';ru='Способ получения';en='Receiving method'"), "DMDeliveryMethod");
		
	ИначеЕсли ТипОбъектаВыбора = "DMInternalDocument" Тогда
		ДобавитьРеквизитПоиска("folder", НСтр("es='La carpeta';ru='Папка';en='Folder'"), "DMInternalDocumentFolder");
		ДобавитьРеквизитПоиска("beginDate", НСтр("es='La fecha del comienzo de la acción';ru='Дата начала действия';en='Action start date'"), "Дата");
		ДобавитьРеквизитПоиска("endDate", НСтр("es='La fecha de la terminación de la acción';ru='Дата окончания действия';en='Expiration end date'"), "Дата");
		ДобавитьРеквизитПоиска("openEnded", НСтр("es='Ilimitado';ru='Бессрочный';en='Perpetual'"), "Булево");
		Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
			ДобавитьРеквизитПоиска("correspondent", НСтр("es='El corresponsal';ru='Корреспондент';en='Correspondent'"), "DMCorrespondent");
		Иначе
			ДобавитьРеквизитПоиска("correspondent", НСтр("es='El contratante';ru='Контрагент';en='Counterparty'"), "DMCorrespondent");
		КонецЕсли;
		ДобавитьРеквизитПоиска("contactPerson", НСтр("es='La persona de contacto';ru='Контактное лицо';en='The contact person'"), "DMContactPerson");
		ДобавитьРеквизитПоиска("signer", НСтр("es='Ha afirmado';ru='Утвердил';en='Approved'"), "DMUser");
		ДобавитьРеквизитПоиска("author", НСтр("es='Ha preparado';ru='Подготовил';en='Prepared'"), "DMUser");
		ДобавитьРеквизитПоиска("prolongationProcedure", НСтр("es='El orden de la prolongación';ru='Порядок продления';en='Renewal procedure'"), "DMProlongationProcedure");
		
	ИначеЕсли ТипОбъектаВыбора = "DMOutgoingDocument" Тогда
		ДобавитьРеквизитПоиска("signer", НСтр("es='Ha firmado';ru='Подписал';en='Signed'"), "DMUser");
		ДобавитьРеквизитПоиска("author", НСтр("es='Ha preparado';ru='Подготовил';en='Prepared'"), "DMUser");
		
	ИначеЕсли ТипОбъектаВыбора = "DMCorrespondent" Тогда
		ДобавитьРеквизитПоиска("inn", НСтр("es='EL INN';ru='ИНН';en='TIN'"), "Строка");
		ДобавитьРеквизитПоиска("kpp", НСтр("es='КПП';ru='КПП';en='PPC:'"), "Строка");
		ДобавитьРеквизитПоиска("okpo", НСтр("es='El código por ОКПО';ru='Код по ОКПО';en='OKPO code'"), "Строка");
		ДобавитьРеквизитПоиска("fullName", НСтр("es='El nombre completo';ru='Полное наименование';en='Full name'"), "Строка");
		ДобавитьРеквизитПоиска("comment", НСтр("es='El comentario';ru='Комментарий';en='Comment'"), "Строка");
		ДобавитьРеквизитПоиска("privatePerson", НСтр("es='La persona física';ru='Физическое лицо';en='Individual'"), "DMPrivatePerson");
		ДобавитьРеквизитПоиска("legalPrivatePerson", НСтр("es='Yur./fiz. La persona';ru='Юр./физ. лицо';en='Legal / individual person'"), "DMLegalPrivatePerson");
		ДобавитьРеквизитПоиска("responsible", НСтр("es='Responsable';ru='Ответственный';en='Responsible'"), "DMUser");
...
Процедура ПриОткрытии(Отказ)
	...
	Если КоличествоРезультатов = 0 Тогда
		ПоказатьПредупреждение(, НСтр("es='Las condiciones dadas de la búsqueda no han dado ni un resultado.';ru='Заданные условия поиска не дали ни одного результата.';en='The specified search terms did not return any results.'"));
		
	ИначеЕсли ПредельноеКоличествоРезультатов <> 0 Тогда
		Кнопки = Новый СписокЗначений;
		Кнопки.Добавить(Истина, НСтр("es='Sí, mostrar primero';ru='Да, показать первые';en='Yes, show the first'")
			+ " " + Формат(ПредельноеКоличествоРезультатов, "ЧГ=0"));
		Кнопки.Добавить(Ложь, НСтр("es='No, precisar las condiciones';ru='Нет, уточнить условия';en='No, specify the conditions'"));
		ОписаниеОповещения = Новый ОписаниеОповещения("ВыполнитьПоискЗавершение", ЭтаФорма);
		ПоказатьВопрос(ОписаниеОповещения,
			НСтр("es='Las condiciones dadas de la búsqueda han dejado demasidos resultados. ¿Mostrar resultados?';ru='Заданные условия поиска дали слишком много результатов. Показать результаты?';en='The specified search terms returned too many results. Show results?'"),
			Кнопки);
	...
	Если ЗначениеЗаполнено(Оператор) Тогда
		Если Тип = "Строка" Тогда
			Если Оператор = "=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Es igual ""%1""';ru='равно ""%1""';en='equal to ""%1""'"), Значение);
			ИначеЕсли Оператор = "LIKE" Тогда
				Если Лев(Значение, 1) = "%"	и Прав(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("es='Contiene ""%1""';ru='содержит ""%1""';en='contains ""%1""'"), Сред(Значение, 2, СтрДлина(Значение) - 2));
				ИначеЕсли Лев(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("es='Acaba en ""%1""';ru='заканчивается на ""%1""';en='ends with ""%1""'"), Сред(Значение,2));
				ИначеЕсли Прав(Значение, 1) = "%" Тогда
					Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("es='Comienza con ""%1""';ru='начинается с ""%1""';en='starts with ""%1""'"), Лев(Значение, СтрДлина(Значение) - 1));
				КонецЕсли;
			КонецЕсли;
		ИначеЕсли Тип = "Число" Тогда
			...
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Entre %1 y %2';ru='между %1 и %2';en='between%1 and%2'"), Значение, Значение2);
			ИначеЕсли Оператор = "<=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Por %1';ru='по %1';en='at %1'"), Значение);
			ИначеЕсли Оператор = ">=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='De %1';ru='от %1';en='from %1'"), Значение);
			КонецЕсли;
		ИначеЕсли Тип = "Дата" Тогда
			Если Оператор = "=" Тогда
				...
				Иначе
					Представление = "(" + НСтр("es='Vacío';ru='пустая';en='empty'") + ")";
				КонецЕсли;
			ИначеЕсли ЗначениеЗаполнено(Оператор2) Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Entre %1 y %2';ru='между %1 и %2';en='between%1 and%2'"), Формат(Значение, "ДЛФ=D"), Формат(Значение2, "ДЛФ=D"));
			ИначеЕсли Оператор = "<=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Por %1';ru='по %1';en='at %1'"), Формат(Значение, "ДЛФ=D"));
			ИначеЕсли Оператор = ">=" Тогда
				Представление = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Con %1';ru='с %1';en='from %1'"), Формат(Значение, "ДЛФ=D"));
			КонецЕсли;
