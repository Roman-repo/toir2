...
Процедура ПодписалНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Иначе
		...
		ТекстСообщения = НСтр("es='""el Remitente""';ru='Не заполнено поле ""Отправитель""';en='Sender field is not filled'");
...
"el documento recibido al objeto %1';ru='Перед добавлением печатной формы нужно связать"
"входящий документ с объектом %1';en='Before adding a printing plate, you need to bind"
"incoming document with object %1'"), СокращенноеНаименованиеКонфигурации);
