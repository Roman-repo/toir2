...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(ДокументID) Тогда 
		...
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("es='El estado del documento ""%1""';ru='Состояние документа ""%1""';en=""Status of document '%1'"""),
			Документ);
		
	Иначе
		
		Если ДокументТип = "DMIncomingDocument" Тогда 
			СостояниеРегистрация = НСтр("es='En el registro';ru='На регистрации';en='At registration'");
			СостояниеРегистрацияID = "НаРегистрации";
			СостояниеРегистрацияТип = "DMDocumentStatus";
		Иначе
			СостояниеРегистрация = НСтр("es='El proyecto';ru='Проект';en='Project'");
