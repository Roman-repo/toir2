...
Процедура ОК(Команда)
	...
	Если Не ЗначениеЗаполнено(ИмяПользователя)
		...
		ПоказатьПредупреждение(, НСтр("es='1С:Документооборота.';ru='Не заполнено имя пользователя 1С:Документооборота.';en='The 1C: Document management username is not filled.'"));
		Возврат;
	КонецЕсли;
	...
	Иначе
		...
		ПоказатьВопрос(ОписаниеОповещения, НСтр("es='No consiguió conectarse a 1С:Документообороту con "
"el nombre indicado del usuario y la consigna. Si estáis seguros de su "
"corrección, se dirijan al administrador.';ru='Не удалось подключиться к 1С:Документообороту с указанным"
"именем пользователя и паролем. Если вы уверены в их "
"правильности, обратитесь к администратору.';en='Failed to connect to 1C: Document management with the specified"
"username and password. If you are sure of their"
"correct, contact administrator. '"), Кнопки);
