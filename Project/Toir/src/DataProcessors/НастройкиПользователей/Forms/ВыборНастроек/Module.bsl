...
Процедура ОбновитьЗаголовокСтраницы(КоличествоНастроек)
	...
	Если ВыбраннаяСтраницаНастроек = "НастройкиОтчетовСтраница" Тогда
		...
		Если КоличествоНастроекОтчетов = 0 Тогда
			ТекстЗаголовка = НСтр("es='Los ajustes de los informes';ru='Настройки отчетов';en='Report Settings'");
		Иначе
			ТекстЗаголовка = НСтр("es='Los ajustes de los informes (%1)';ru='Настройки отчетов (%1)';en='Report Settings (%1)'");
	...
	ИначеЕсли ВыбраннаяСтраницаНастроек = "ВнешнийВидСтраница" Тогда
		...
		Если КоличествоНастроекВнешнегоВида = 0 Тогда
			ТекстЗаголовка = НСтр("es='El aspecto exterior';ru='Внешний вид';en='Appearance'");
		Иначе
			ТекстЗаголовка = НСтр("es='El aspecto exterior (%1)';ru='Внешний вид (%1)';en='Appearance (%1)'");
	...
	ИначеЕсли ВыбраннаяСтраницаНастроек = "ПрочиеНастройкиСтраница" Тогда
		...
		Если КоличествоПрочихНастроек = 0 Тогда
			ТекстЗаголовка = НСтр("es='Otros ajustes';ru='Прочие настройки';en='Other settings'");
		Иначе
			ТекстЗаголовка = НСтр("es='Otros ajustes (%1)';ru='Прочие настройки (%1)';en='Other settings (%1)'");
...
Процедура ЗагрузитьЗначенияПометок(ДеревоЗначений, ПомеченныеНастройки, ВидНастроек)
	...
	Если КоличествоПомеченных > 0 Тогда
		...
		Если ВидНастроек = "НастройкиОтчетов" Тогда
			...
			Элементы.НастройкиОтчетовСтраница.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='Los ajustes de los informes (%1)';ru='Настройки отчетов (%1)';en='Report Settings (%1)'"), КоличествоПомеченных);
		ИначеЕсли ВидНастроек = "ВнешнийВид" Тогда
			КоличествоНастроекВнешнегоВида = КоличествоПомеченных;
			Элементы.ВнешнийВидСтраница.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='El aspecto exterior (%1)';ru='Внешний вид (%1)';en='Appearance (%1)'"), КоличествоПомеченных);
		ИначеЕсли ВидНастроек = "ПрочиеНастройки" Тогда
			КоличествоПрочихНастроек = КоличествоПомеченных;
			Элементы.ПрочиеНастройкиСтраница.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='Otros ajustes (%1)';ru='Прочие настройки (%1)';en='Other settings (%1)'"), КоличествоПомеченных);
		КонецЕсли;
