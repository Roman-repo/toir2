...
Функция НастройкиВсехФорм(ИмяПользователя)
	...
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventsJournal", 
		НСтр("es='Estandartizado. La revista del registro';ru='Стандартные.Журнал регистрации';en='Standard. Log'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventForm", 
		НСтр("es='Estandartizado. La revista del registro, el Acontecimiento';ru='Стандартные.Журнал регистрации, Событие';en='Accessories: Log, Event'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardEventLog.Форма.EventsJournalFilter", 
		НСтр("es='Estandartizado. La revista del registro, el Ajuste de la selección de los acontecimientos';ru='Стандартные.Журнал регистрации, Настройка отбора событий';en='Accessories: Log, Configuring event selection'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardFindByRef.Форма.MainForm", 
		НСтр("es='Estandartizado. La búsqueda de las referencias al objeto';ru='Стандартные.Поиск ссылок на объект';en='Standard: Search for object references'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardFullTextSearchManagement.Форма.MainForm", 
		НСтр("es='Estandartizado. La dirección полнотекстовым por la búsqueda';ru='Стандартные.Управление полнотекстовым поиском';en='Standard: Full text search management'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardDocumentsPosting.Форма.MainForm", 
		НСтр("es='Estandartizado. La realización de los documentos';ru='Стандартные.Проведение документов';en='Standard. Conducting documents'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardDeleteMarkedObjects.Форма.Form", 
		НСтр("es='Estandartizado. La desaparición de los objetos marcados';ru='Стандартные.Удаление помеченных объектов';en='Standard: Delete marked objects'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardExternalDataSourceManagement.Форма.Form", 
		НСтр("es='Estandartizado. La dirección de las fuentes exteriores de los datos';ru='Стандартные.Управление внешними источниками данных';en='Standard: Manage external data sources'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardTotalsManagement.Форма.MainForm", 
		НСтр("es='Estandartizado. La dirección de los totales';ru='Стандартные.Управление итогами';en='Standard. Summary management'") , Ложь, БиблиотекаКартинок.Форма);
	СписокФорм.Добавить("ВнешняяОбработка.StandardActiveUsers.Форма.ActiveUsersListForm", 
		НСтр("es='Estandartizado. Los usuarios activos';ru='Стандартные.Активные пользователи';en='Standard.Active users'") , Ложь, БиблиотекаКартинок.Форма);
...
Функция ФормыОбъектовМетаданных()
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.КритерииОтбора, "КритерийОтбора", НСтр("es='El criterio de la selección';ru='Критерий отбора';en='Selection criteria'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.КритерийОтбора, СписокФорм);
		
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ХранилищаНастроек, "ХранилищеНастроек", НСтр("es='El depósito de los ajustes';ru='Хранилище настроек';en='Settings storage'"),
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Справочники, "Справочник", НСтр("es='La guía';ru='Справочник';en='Directory'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Документы, "Документ", НСтр("es='El documento';ru='Документ';en='Document'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Документ, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("Форма");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ЖурналыДокументов, "ЖурналДокументов", НСтр("es='La revista de los documentos';ru='Журнал документов';en='Document log'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.ЖурналДокументов, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Перечисления, "Перечисление", НСтр("es='La enumeración';ru='Перечисление';en='Listing'"),
	...
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Отчеты, "Отчет", НСтр("es='El informe';ru='Отчет';en='Report'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Отчет, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("Форма");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Обработки, "Обработка", НСтр("es='El tratamiento';ru='Обработка';en='Processing'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбораГруппы", "ФормаВыбораГруппы");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыВидовХарактеристик, "ПланВидовХарактеристик", НСтр("es='El plan de los tipos de las características';ru='План видов характеристик';en='Feature type plan'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыСчетов, "ПланСчетов", НСтр("es='El plan de las cuentas';ru='План счетов';en='Chart of accounts'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ПланыВидовРасчета, "ПланВидовРасчета", НСтр("es='El plan de los tipos del cálculo';ru='План видов расчета';en='Plan of calculation types'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.ПланВидовРасчета, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаЗаписи");
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыСведений, "РегистрСведений", НСтр("es='El registro de las noticias';ru='Регистр сведений';en='Information register'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрСведений, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыНакопления, "РегистрНакопления", НСтр("es='El registro de la acumulación';ru='Регистр накопления';en='Accumulation register'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрНакопления, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыБухгалтерии, "РегистрБухгалтерии", НСтр("es='El registro de la contabilidad';ru='Регистр бухгалтерии';en='Accounting register'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.РегистрБухгалтерии, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.РегистрыРасчета, "РегистрРасчета", НСтр("es='El registro del cálculo';ru='Регистр расчета';en='Calculation register'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.БизнесПроцессы, "БизнесПроцесс", НСтр("es='El proceso de negocios';ru='Бизнес-процесс';en='Buisness process'"),
	...
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ИменаСтандартныхФорм.Добавить("ФормаДляВыбора", "ФормаВыбора");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.Задачи, "Задача", НСтр("es='La tarea';ru='Задача';en='Task'"),
		ИменаСтандартныхФорм, БиблиотекаКартинок.Задача, СписокФорм);
	
	ИменаСтандартныхФорм = Новый СписокЗначений;
	ИменаСтандартныхФорм.Добавить("ФормаЗаписи");
	ИменаСтандартныхФорм.Добавить("ФормаСписка");
	ЗаполнитьФормыОбъектовМетаданных(Метаданные.ВнешниеИсточникиДанных, "ВнешнийИсточникДанных", НСтр("es='Las fuentes exteriores de los datos';ru='Внешние источники данных';en='External data sources'"),
...
Процедура ДобавитьТипФормыВПредставление(Объект, Форма, ИмяФормы)
	...
	Если Форма = Объект.ОсновнаяФормаСписка Тогда
		ИмяФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='%1 (lista)';ru='%1 (список)';en='%1 (list)'"), ИмяФормы);
	ИначеЕсли Форма = Объект.ОсновнаяФормаДляВыбора Тогда
		ИмяФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='%1 (elección)';ru='%1 (выбор)';en='%1 (select)'"), ИмяФормы);
	ИначеЕсли Форма = Объект.ОсновнаяФормаГруппы Тогда
		ИмяФормы = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='%1 (grupo)';ru='%1 (группа)';en='%1 (group)'"), ИмяФормы);
	КонецЕсли;
...
Функция ФормированиеОтчетаОКопировании(НеСкопированныеНастройкиОтчетов,
	...
	Если ТаблицаПользовательскихВариантовОтчетов <> Неопределено
		...
		ОбластьЗаголовок.Параметры.Описание = 
			НСтр("es='Es imposible copiar las variantes personales de los informes. "
"Para que la variante personal del informe se haga accesible a otros usuarios, "
"lo es necesario пересохранить con la marca quitada ""Solamente para el autor"". "
"La lista de las variantes dejadas pasar de los informes:';ru='Невозможно скопировать личные варианты отчетов."
...
"Список пропущенных вариантов отчетов:';en='Unable to copy personal report options."
"In order for the personal version of the report to be available to other users,"
"it must be re-saved with unchecked "" Only for the author ""."
"List of missing report options:'");
	...
	Если НеСкопированныеНастройкиОтчетов.Количество() <> 0 Тогда
		ОбластьЗаголовок = ТабМакет.ПолучитьОбласть("Заголовок");
		ОбластьЗаголовок.Параметры.Описание = 
			НСтр("es='A los usuarios siguientes es insuficientemente derecho a los informes:';ru='У следующих пользователей недостаточно прав на отчеты:';en='The following users do not have sufficient rights to reports:'");
		ТабДок.Вывести(ОбластьЗаголовок);
...
Процедура ЗаполнитьСписокНастроекВнешнегоВида(Параметры)
	...
	Для Каждого НастройкаФормы Из НастройкиФорм Цикл
		...
		ИначеЕсли ПредставлениеОбъектаМетаданных[0] = НСтр("es='Estandartizado';ru='Стандартные';en='Standard'") Тогда
	...
	Настройка = НСтр("es='La interfaz de mando y la página inicial';ru='Командный интерфейс и начальная страница';en='Command Interface and start page'");
...
Процедура ЗаполнитьСписокПрочихНастроек(Параметры)
	...
	Если Ключи.Количество() > 0 Тогда
		...
		Если Не ПустаяСтрока(Параметры.Поиск) Тогда
			Если СтрНайти(ВРег(НСтр("es='Los ajustes personales';ru='Персональные настройки';en='Personal settings'")), ВРег(Параметры.Поиск)) = 0 Тогда
				ВыводитьНастройку = Ложь;
			КонецЕсли;
		КонецЕсли;
		
		Если ВыводитьНастройку Тогда
			Настройка = НСтр("es='Los ajustes personales';ru='Персональные настройки';en='Personal settings'");
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("es='Los ajustes de la prensa de los documentos tabulares';ru='Настройки печати табличных документов';en='Printing Options for Tabular Documents'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если ЕстьНастройкиПечати
		...
		Настройка = НСтр("es='Los ajustes de la prensa de los documentos tabulares';ru='Настройки печати табличных документов';en='Printing Options for Tabular Documents'");
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("es='Elegido';ru='Избранное';en='Elected'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если ЕстьИзбранное
		...
		Настройка = НСтр("es='Elegido';ru='Избранное';en='Elected'");
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		...
		Если СтрНайти(ВРег(НСтр("es='Otros ajustes';ru='Прочие настройки';en='Other settings'")), ВРег(Параметры.Поиск)) = 0 Тогда
			ВыводитьНастройку = Ложь;
		КонецЕсли;
	...
	Если ПрочиеКлючи.Количество() <> 0
		И ВыводитьНастройку Тогда
		Настройка = НСтр("es='Otros ajustes';ru='Прочие настройки';en='Other settings'");
		Картинка = БиблиотекаКартинок.ПрочиеПользовательскиеНастройки;
...
Процедура ДобавитьНастройкиРабочегоСтолаИКомандногоИнтерфейса(Параметры, ДеревоНастроек)
	...
	Если Не ПустаяСтрока(Параметры.Поиск) Тогда
		Если СтрНайти(ВРег(НСтр("es='La interfaz de mando y la página inicial';ru='Командный интерфейс и начальная страница';en='Command Interface and start page'")), ВРег(Параметры.Поиск)) = 0 Тогда
			Возврат;
		КонецЕсли;
	КонецЕсли;
	...
	Если КлючиВсехНастроек.Количество() > 0 Тогда
		...
		НоваяСтрокаИнтерфейса.Настройка = НСтр("es='La interfaz de mando y la página inicial';ru='Командный интерфейс и начальная страница';en='Command Interface and start page'");
		НоваяСтрокаИнтерфейса.Картинка = БиблиотекаКартинок.Картинка;
		НоваяСтрокаИнтерфейса.ТипСтроки = НСтр("es='La interfaz de mando y la página inicial';ru='Командный интерфейс и начальная страница';en='Command Interface and start page'");
	...
	Если КлючиНастроекРабочегоСтола.Количество() > 0 Тогда
		...
		НоваяПодстрокаИнтерфейса.Настройка = НСтр("es='La página inicial';ru='Начальная страница';en='start page'");
	...
	Если КлючиНастроекИнтерфейса.Количество() > 0 Тогда
		...
		НоваяПодстрокаИнтерфейса = НоваяСтрокаИнтерфейса.Строки.Добавить();
		НоваяПодстрокаИнтерфейса.Настройка = НСтр("es='La interfaz de mando';ru='Командный интерфейс';en='Command interface'");
		НоваяПодстрокаИнтерфейса.Картинка = БиблиотекаКартинок.Картинка;
