...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_Т1") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
						...
						"ПФ_MXL_Т1", НСтр("es='La orden de la recepción';ru='Приказ о приеме';en='Admission order'"),
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_Т8") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
						КоллекцияПечатныхФорм,
						"ПФ_MXL_Т8", НСтр("es='La orden del despido';ru='Приказ об увольнении';en='Dismissal order'"),
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_Т5") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
						КоллекцияПечатныхФорм,
						"ПФ_MXL_Т5", НСтр("es='La orden de la traducción';ru='Приказ о переводе';en='Transfer order'"),
...
Функция ПолучитьДанныеДляПечатиКадровогоПриказаТ5(МассивОбъектов)
	...
	Пока Выборка.Следующий() Цикл
		...
		Если ЗначениеЗаполнено(Параметры.ДатаОкончания) Тогда
			Параметры.ВидПеревода = НСтр("es='Temporalmente';ru='Временно';en='temporarily'");
		Иначе
			Параметры.ВидПеревода = НСтр("es='Constantemente';ru='Постоянно';en='Constantly'");
		КонецЕсли;
		//Если ЗначениеЗаполнено(Параметры.ДатаОкончания) Тогда
...
Функция ПолучитьСтруктуруПараметровПриказаТ1()
	...
	// >> [Деснол] [Ушаков А.Д.] [26.09.2019] 
	Параметры.Вставить("ВалютаТарифнойСтавки", НСтр("es='rub.';ru='руб.';en='rub.'"));
	Параметры.Вставить("КопейкиТарифнойСтавки", НСтр("es='cop.';ru='коп.';en='cop.'"));
