...
#Если ВебКлиент Тогда
	ПоказатьПредупреждение(,
		НСтр("es='En el cliente web algunas referencias pueden trabajar incorrectamente. "
"Presentamos las excusas por las incomodidades.';ru='В веб-клиенте некоторые ссылки могут работать неправильно."
"Приносим извинения за неудобства.';en='In the web client, some links may not work correctly."
