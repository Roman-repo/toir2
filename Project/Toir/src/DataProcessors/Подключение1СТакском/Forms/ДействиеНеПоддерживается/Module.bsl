...
Процедура ПриОткрытии(Отказ)
	...
	Иначе
		Элементы.ДекорацияСообщение.Заголовок = НСтр("es='La acción escogida es inaccesible para esta configuración.';ru='Выбранное действие недоступно для этой конфигурации.';en='The selected action is not available for this configuration.'");
	КонецЕсли;
