...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если Модифицированность И Не ПрограммноеЗакрытие Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения(
			...
			ЭтотОбъект);
		ТекстВопроса = НСтр("es='La dirección del participante del cambio para los documentos electrónicos es cambiada. "
"¿Conservar los cambios?';ru='Адрес участника обмена электронными документами изменен."
"Сохранить изменения?';en='The address of the electronic document interchange participant has been changed."
"Save changes?'");
...
Процедура КодРегионаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если СписокКодовРегионов = Неопределено Тогда
		...
		ТекстПредупреждения = НСтр("es='La lista de los códigos no es cargada. Presionen la referencia ""Cargar"" o introduzcan el código de la región a mano.';ru='Список кодов еще не загружен. Нажмите на ссылку ""Загрузить"" или введите код региона вручную.';en='List of codes not yet loaded. Click on the Download link or enter the region code manually.'");
	...
	СписокКодовРегионов.ПоказатьВыборЭлемента(
		ОписаниеОповещения,
		НСтр("es='Los códigos de las regiones';ru='Коды регионов';en='Region codes'"),
