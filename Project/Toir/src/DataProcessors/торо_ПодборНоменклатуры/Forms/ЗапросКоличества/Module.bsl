...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.СкрытьЦену Тогда
		...
		ЭтаФорма.Заголовок         = НСтр("es='La introducción de la cantidad';ru='Ввод количества';en='Enter quantity'");
	КонецЕсли;
	...
	Элементы.ВидЦены.СписокВыбора.Добавить(Справочники.ВидыЦен.ПустаяСсылка(), НСтр("es='<cualquiera>';ru='<произвольная>';en='<произвольная>'"));
...
Процедура ОК(Команда)
	...
	Если КоличествоУпаковок = 0 Тогда
		ТекстСообщения = НСтр("es='la cantidad';ru='Не заполнено количество';en='Quantity is not filled'");
