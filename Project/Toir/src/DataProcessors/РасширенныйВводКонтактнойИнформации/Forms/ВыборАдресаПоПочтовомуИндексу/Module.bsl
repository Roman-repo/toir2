...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		КраткоеПредставлениеОшибки = НСтр("es='El índice no es encontrado en el clasificador de domicilios.';ru='Индекс не найден в адресном классификаторе.';en='Index not found in address classifier.'");
		Возврат;
	КонецЕсли;
