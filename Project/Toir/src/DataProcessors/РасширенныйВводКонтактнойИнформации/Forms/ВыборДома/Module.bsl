...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		Заголовок = НСтр("es='Escoger la parcela de tierra';ru='Выбрать земельный участок';en='Choose land'");
		Элементы.Найти.Подсказка = НСтр("es='La búsqueda por el número de la parcela de tierra';ru='Поиск по номеру земельного участка';en='Search by land number'");
		Элементы.Найти.ПодсказкаВвода = НСтр("es='El número de la parcela de tierra';ru='Номер земельного участка';en='Land number'");
	КонецЕсли;
