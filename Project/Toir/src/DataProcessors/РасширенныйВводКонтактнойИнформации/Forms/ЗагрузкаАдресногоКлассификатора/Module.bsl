...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ЗначениеЗаполнено(Параметры.НазваниеРегиона) Тогда
		ТекстВопроса = НСтр("es='Para la autoselección y la elección de las noticias de domicilios es necesario cargar el clasificador por la región ""%1"".';ru='Для автоподбора и выбора адресных сведений необходимо загрузить классификатор по региону ""%1"".';en='For automatic selection and selection address information, you need to download the classifier by region ""%1"".'");
