...
Процедура ПолеКаталогРезервнойКопииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Диалог.Заголовок = НСтр("es='La elección del catálogo de la copia ИБ de reserva';ru='Выбор каталога резервной копии ИБ';en='Selecting a backup directory for information security'");
