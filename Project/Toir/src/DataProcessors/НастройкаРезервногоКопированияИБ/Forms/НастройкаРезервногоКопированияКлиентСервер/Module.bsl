...
Процедура ПриОткрытии(Отказ)
	...
	Если Не ОбщегоНазначенияКлиент.ЭтоWindowsКлиент() Тогда
		Отказ = Истина;
		ТекстСообщения = НСтр("es='La copia de reserva es apoyada solamente en el cliente bajo la dirección la SO Windows.';ru='Резервное копирование поддерживается только в клиенте под управлением ОС Windows.';en='Backup is only supported on a client running Windows.'");
