...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ТекстСообщенияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='A la renovación de la versión del programa ha surgido la falta: "
""
"%1';ru='При обновлении версии программы возникла ошибка:"
""
"%1';en='An error occurred while updating the version of the program:"
""
"%1'"),
...
Процедура ОткрытьВнешнююОбработкуПослеПодтвержденияБезопасности(Результат, ДополнительныеПараметры) Экспорт
	...
	ПараметрыЗагрузки.Диалог.Фильтр = НСтр("es='El tratamiento exterior';ru='Внешняя обработка';en='External processing'") + "(*.epf)|*.epf";
	ПараметрыЗагрузки.Диалог.МножественныйВыбор = Ложь;
	ПараметрыЗагрузки.Диалог.Заголовок = НСтр("es='Escojan el tratamiento exterior';ru='Выберите внешнюю обработку';en='Choose external processing'");
