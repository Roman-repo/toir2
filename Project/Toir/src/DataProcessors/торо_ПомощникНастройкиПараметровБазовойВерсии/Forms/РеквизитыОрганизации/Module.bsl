...
Процедура ПроверитьКорректностьИНН()
	...
	ПозицияДолжен = Найти(СообщениеОшибки, НСтр("es='Debe';ru='должен';en='must'"));
	СообщениеОшибки = СтрЗаменить(СообщениеОшибки, НСтр("es='Debe';ru='должен';en='must'"), НСтр("es='Debe';ru='Должен';en='Must'"));
