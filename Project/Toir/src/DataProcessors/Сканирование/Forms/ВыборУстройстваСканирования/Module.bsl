...
Процедура ПриОткрытии(Отказ)
	...
	Если КоличествоЭлементов = 0 Тогда
		Отказ = Истина;
		ПоказатьПредупреждение(, НСтр("es='el escáner. Se dirijan al administrador del programa.';ru='Не установлен сканер. Обратитесь к администратору программы.';en='No scanner installed. Contact the program administrator.'"));
	Иначе
...
Процедура ВыбратьСканер(Команда)
	...
	Если ПустаяСтрока(ИмяУстройства) Тогда
		ТекстСообщения = НСтр("es='el escáner.';ru='Не выбран сканер.';en='No scanner selected.'");
