...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ИспользоватьImageMagickДляПреобразованияВPDF Тогда
		Элементы.ФорматСканированногоИзображения.Заголовок = НСтр("es='El formato';ru='Формат';en='Format'");
	Иначе
		Элементы.ФорматСканированногоИзображения.Заголовок = НСтр("es='El tipo';ru='Тип';en='Type '");
	КонецЕсли;
...
Процедура ПутьКПрограммеКонвертацииНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Фильтр = НСтр("es='Los ficheros cumplidos (*.exe) |*.exe';ru='Исполняемые файлы(*.exe)|*.exe';en='Executable files (*. Exe) | * .exe'");
	ДиалогОткрытияФайла.Фильтр = Фильтр;
	ДиалогОткрытияФайла.МножественныйВыбор = Ложь;
	ДиалогОткрытияФайла.Заголовок = НСтр("es='Escojan el fichero para la transformación en PDF';ru='Выберите файл для преобразования в PDF';en='Select a file to convert to PDF'");
