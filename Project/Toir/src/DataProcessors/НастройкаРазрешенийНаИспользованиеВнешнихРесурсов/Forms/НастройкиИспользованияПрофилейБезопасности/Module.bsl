...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не РаботаВБезопасномРежимеСлужебный.ВозможноИспользованиеПрофилейБезопасности() Тогда
		ВызватьИсключение НСтр("es='¡La atención! El uso de los perfiles de la seguridad es inaccesible para la configuración dada';ru='Внимание! Использование профилей безопасности недоступно для данной конфигурации';en='Warning! Security profiles are not available for this configuration'");
	КонецЕсли;
	
	Если Не РаботаВБезопасномРежимеСлужебный.ДоступнаНастройкаПрофилейБезопасности() Тогда
		ВызватьИсключение НСтр("es='¡La atención! El ajuste de los perfiles de la seguridad es inaccesible';ru='Внимание! Настройка профилей безопасности недоступна';en='Warning! Security profiles not available'");
	КонецЕсли;
	
	Если Не Пользователи.ЭтоПолноправныйПользователь(, Истина) Тогда
		ВызватьИсключение НСтр("es='No basta los derechos de admisión';ru='Недостаточно прав доступа';en='Not enough access rights'");
	КонецЕсли;
...
Процедура НачатьПрименениеНастроекПрофилейБезопасности(Знач УникальныйИдентификатор)
	...
	Если Не РаботаВБезопасномРежимеСлужебный.ВозможноИспользованиеПрофилейБезопасности() Тогда
		ВызватьИсключение НСтр("es='¡La atención! La inclusión de la interpelación automática de los permisos es inaccesible';ru='Внимание! Включение автоматического запроса разрешений недоступно';en='Warning! Enabling automatic permission request is not available'");
	КонецЕсли;
