...
Функция СформироватьТабличныйДокументСервер()
	...
	ПараметрыВыполнения.НаименованиеФоновогоЗадания = 
		НСтр("es='La formación del informe por la composición de los datos para el envío a la sincronización';ru='Формирование отчета по составу данных для отправки при синхронизации';en='Formation of a report on the composition of the data to be sent during synchronization'");
