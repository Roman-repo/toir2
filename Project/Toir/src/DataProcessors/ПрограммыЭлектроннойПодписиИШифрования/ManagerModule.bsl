...
Процедура ДобавитьПоставляемыеНастройкиПрограмм(Настройки) Экспорт
	...
	Настройка.Представление       = НСтр("es='ViPNet CSP (EL GOST 2012)';ru='ViPNet CSP (ГОСТ 2012)';en='ViPNet CSP (GOST 2012)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("es='КриптоПро CSP (el GOST 2012)';ru='КриптоПро CSP (ГОСТ 2012)';en='КриптоПро CSP (GOST 2012)'");
	...
	// ЛИССИ CSP (ГОСТ 2012)
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("es='ЛИССИ CSP (EL GOST 2012)';ru='ЛИССИ CSP (ГОСТ 2012)';en='LISSI CSP (GOST 2012)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("es='La señal CSP (el GOST 2012)';ru='Сигнал-КОМ CSP (ГОСТ 2012)';en='Signal-COM CSP (GOST 2012)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("es='ViPNet CSP (EL GOST 2001)';ru='ViPNet CSP (ГОСТ 2001)';en='ViPNet CSP (GOST 2001)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("es='КриптоПро CSP (el GOST 2001)';ru='КриптоПро CSP (ГОСТ 2001)';en='КриптоПро CSP (GOST 2001)'");
	...
	// ЛИССИ CSP (ГОСТ 2001)
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("es='ЛИССИ CSP (EL GOST 2001)';ru='ЛИССИ CSP (ГОСТ 2001)';en='LISSI CSP (GOST 2001)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("es='La señal CSP (RFC 4357, el GOST 2001)';ru='Сигнал-КОМ CSP (RFC 4357, ГОСТ 2001)';en='Signal-KOM CSP (RFC 4357, GOST 2001)'");
	...
	Настройка = Настройки.Добавить();
	Настройка.Представление       = НСтр("es='La señal CSP (ITU-T X.509 v.3, el GOST 2001)';ru='Сигнал-КОМ CSP (ITU-T X.509 v.3, ГОСТ 2001)';en='Signal-KOM CSP (ITU-T X.509 v.3, GOST 2001)'");
...
Процедура ОбновитьПрограммуОблачногоСервиса(Отложенно = Ложь, ОбъектовОбработано = 0, ПроблемныхОбъектов = 0) Экспорт
	...
	Представление = НСтр("es='El servicio nuboso';ru='Облачный сервис';en='Cloud service'");
...
"%2 '"), Строка(Программа), ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		...
		Иначе
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='No consiguió añadir el programa ""%1"" por la causa: "
"%2';ru='Не удалось добавить программу ""%1"" по причине:"
"%2';en='Failed to add program"" ""%1"" due to:"
