...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(ВидКонтактнойИнформации) Тогда
		ВызватьИсключение НСтр("es='La orden no puede ser cumplida para el objeto indicado por la introducción incorrecta de la información de contacto.';ru='Команда не может быть выполнена для указанного объекта из-за некорректного внедрения контактной информации.';en='The command cannot be executed for the specified object due to incorrect implementation of contact information.'");
	КонецЕсли;
