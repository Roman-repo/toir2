...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	Если ПодсистемаСуществует("СтандартныеПодсистемы.ДополнительныеОтчетыИОбработки") Тогда
		...
		НоваяКоманда.Представление = НСтр("es='El cambio de grupo de los requisitos';ru='Групповое изменение реквизитов';en='Group change of details'");
	...
	Для Каждого ОбъектМетаданных Из ОбъектыМетаданных Цикл
		...
		Для Каждого ТабличнаяЧасть Из СтруктураОбъектов.ТабличныеЧасти Цикл
			...
			Для Каждого ИмяРеквизита Из РеквизитыТабличнойЧасти Цикл
				...
				// ТОИР++
				Если ИмяРеквизита = "Иерархия" или ИмяРеквизита = "иерархия" Тогда
					СтрокаРеквизитов = СтрокаРеквизитов + ИмяТабличнойЧасти + "." + ИмяРеквизита;
				Иначе
