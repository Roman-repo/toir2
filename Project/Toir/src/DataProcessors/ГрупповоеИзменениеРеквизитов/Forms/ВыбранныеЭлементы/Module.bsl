...
Процедура ОбновитьСписокВыбранныхНаСервере()
	...
	Если КоличествоВыбранных > 1000 Тогда
		КоличествоВыбранных = НСтр("es='> 1000';ru='> 1000';en='> 1000'");
	...
	КонецЕсли;
	Элементы.ГруппаВыбранныеОбъекты.Заголовок = ПодставитьПараметрыВСтроку(НСтр("es='Los elementos escogidos (%1)';ru='Выбранные элементы (%1)';en='Selected Items (%1)'"), КоличествоВыбранных);
