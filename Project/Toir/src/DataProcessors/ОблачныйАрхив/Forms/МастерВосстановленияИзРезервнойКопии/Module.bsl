...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("es='La carga del fichero de la copia de reserva';ru='Загрузка файла резервной копии';en='Download backup file'"));
	...
	Если ЭтотОбъект.filesize = 0 Тогда
		...
		ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
			...
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='La tentativa de la carga del fichero con la dimensión de cero. La carga es anulada. "
"El login: %1 "
"UIDFile: %2 "
"DBName: %3 "
"UIDName: %4 "
"Dimensión del fichero: %5';ru='Попытка загрузки файла с нулевым размером. Загрузка отменена."
"Логин: %1"
"UIDFile: %2"
"DBName: %3"
"UIDName: %4"
"Размер файла: %5';en='Attempt was made to download a file with a size of zero. Download canceled."
"Login:%1"
"UIDFile:%2"
"DBName:%3"
"UIDName:%4"
...
#Область НастройкаСтраницы_ЗагрузкаФайла_СозданиеСтруктурыКаталогов_UIDName
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("es='El ajuste de la carga del fichero de la copia de reserva, la creación de la estructura de los catálogos (UIDName)';ru='Настройка загрузки файла резервной копии, создание структуры каталогов (UIDName)';en='Configuring the download of the backup file, create directory structure (UIDName)'"));
		...
		Исключение
			...
			ОписаниеРезультата = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='La falta de la creación de la estructura del catálogo de trabajo: "
"%1 "
"por la causa: "
"%2';ru='Ошибка создания структуры рабочего каталога:"
"%1"
"по причине:"
"%2';en='Error creating working directory structure:"
"%one"
"due to:"
"%2'"),
				лкКаталогВременныхФайлов,
	...
	ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
		...
		КодРезультата,
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("es='Es acabada la creación "
"del catálogo %1 "
"la Descripción del resultado: "
"%2';ru='Завершено создание каталога"
"%1"
"Описание результата:"
"%2';en='Completed directory creation"
"%1"
...
#Область НастройкаСтраницы_ЗагрузкаФайла_СозданиеСтруктурыКаталогов_UIDName_UIDFile
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("es='El ajuste de la carga del fichero de la copia de reserva, la creación de la estructura de los catálogos (UIDName\UIDFile)';ru='Настройка загрузки файла резервной копии, создание структуры каталогов (UIDName\UIDFile)';en='Configuring the download of the backup file, creating the directory structure (UIDName \ UIDFile)'"));
...
#Область НастройкаСтраницы_ЗагрузкаФайла_СозданиеСтруктурыКаталогов_UIDName_UIDFile_BackUp
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("es='El ajuste de la carga del fichero de la copia de reserva, la creación de la estructura de los catálogos (UIDName\UIDFile\BackUp)';ru='Настройка загрузки файла резервной копии, создание структуры каталогов (UIDName\UIDFile\BackUp)';en='Configuring the download of the backup file, creating the directory structure (UIDName \ UIDFile \ BackUp)'"));
...
#Область НастройкаСтраницы_ЗагрузкаФайла_СозданиеСтруктурыКаталогов_UIDName_UIDFile_Downloads
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("es='El ajuste de la carga del fichero de la copia de reserva, la creación de la estructura de los catálogos (UIDName\UIDFile\Downloads)';ru='Настройка загрузки файла резервной копии, создание структуры каталогов (UIDName\UIDFile\Downloads)';en='Configuring the download of the backup file, creating the directory structure (UIDName \ UIDFile \ Downloads)'"));
...
#Область НастройкаСтраницы_ЗагрузкаФайла_СозданиеСтруктурыКаталогов_UIDName_UIDFile_Scripts
	...
	ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
		...
		НСтр("es='El ajuste de la carga del fichero de la copia de reserva, la creación de la estructura de los catálogos (UIDName\UIDFile\Scripts)';ru='Настройка загрузки файла резервной копии, создание структуры каталогов (UIDName\UIDFile\Scripts)';en='Configuring the download of the backup file, creating the directory structure (UIDName \ UIDFile \ Scripts)'"));
...
#Область ПолучениеКлючаАвторизации
	Если ПустаяСтрока(ЭтотОбъект.authKey) Тогда
		...
		ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
			...
			НСтр("es='La recepción de la llave de la autorización (authKey) de los servicios web particulares';ru='Получение ключа авторизации (authKey) из приватных веб-сервисов';en='Obtaining an authorization key (authKey) from private web services'"));
		...
		ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
			...
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='Es acabada la recepción de la llave de la autorización. "
"El código del resultado: %1 "
"Descripción del resultado: "
"%2';ru='Завершено получение ключа авторизации."
"Код результата: %1"
"Описание результата:"
"%2';en='Completed receipt of authorization key."
"Result Code:%1"
"Description of the result:"
"%2 '"),
				ВложенныйКонтекстВыполненияПолученияКлючаАвторизации.КодРезультата,
...
#КонецОбласти
	...
	ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
		...
		0,
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("es='Es acabada la inicialización (ПриСозданииНаСервере): "
"el Login: %1 "
"UIDFile: %2 "
"DBName: %3 "
"UIDName: %4 "
"Dimensión del fichero: %5';ru='Завершена инициализация (ПриСозданииНаСервере):"
"Логин: %1"
"UIDFile: %2"
"DBName: %3"
"UIDName: %4"
"Размер файла: %5';en='Initialization Complete (ПриСозданииНаСервере):"
"Login %1"
"UIDFile: %2"
"DBName: %3"
"UIDName: %4"
...
Процедура ПередЗакрытием(Отказ, ЗавершениеРаботы, ТекстПредупреждения, СтандартнаяОбработка)
	...
	Если ЭтотОбъект.ИдентификаторСостоянияЗагрузкиФайла = "ЗагрузкаФайла" Тогда // Идентификатор: ЗагрузкаФайла, ОтменаЗагрузки, ФайлЗагружен, ОшибкиЗагрузки, РаспаковкаФайла, ФайлРаспакован, ОшибкиРаспаковки.
		ПоказатьОповещениеПользователя(
			, // Текст.
			, // НавигационнаяСсылка.
			НСтр("es='No es posible cerrar la forma, mientras haya una carga del fichero. "
"Al principio anulen la carga.';ru='Нельзя закрывать форму, пока происходит загрузка файла."
"Вначале отмените загрузку.';en='R[-1]C'"), // Пояснение.
...
Процедура ПриОткрытии(Отказ)
	...
	#Если НЕ ВебКлиент Тогда
		...
		ЭтотОбъект.Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("es='La carga de la copia de reserva de la base %1';ru='Загрузка резервной копии базы %1';en='Downloading database backup% 1'"),
			ЭтотОбъект.DBName);

		// Текущее состояние загрузки.
		ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='La comprobación del fichero cargado...';ru='Проверка загруженного файла...';en='Checking the downloaded file ...'");
		...
		Иначе
			...
			// Текущее состояние загрузки.
			ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='La carga del fichero...';ru='Загрузка файла...';en='Downloading file ...'");
			ЭтотОбъект.ОбновитьОтображениеДанных();
			Элементы.ДекорацияОшибкаТекст.Подсказка = "";
			Элементы.ГруппаСтраницыСостояниеЗагрузки.ТекущаяСтраница = Элементы.ГруппаСостояние;
...
Процедура ПутьДругогоКаталогаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	#Если Не ВебКлиент Тогда
		...
		ДиалогВыбора.Заголовок = НСтр("es='La elección del catálogo de la reconstitución de la copia de reserva';ru='Выбор каталога восстановления резервной копии';en='Select backup recovery directory'");
...
Процедура КомандаВосстановить(Команда)
	...
	Если НЕ ПустаяСтрока(Результат) Тогда
		...
		Если Каталог.Существует() Тогда
			...
			Иначе
				ТекстСообщения = НСтр("es='Es necesario indicar el nombre del catálogo, y no el nombre del fichero.';ru='Необходимо указать имя каталога, а не имя файла.';en='Required to specify a directory name, not a file name.'");
		...
		Иначе
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='El catálogo %1 no existe. Comprueben la corrección de la escritura del nombre del catálogo.';ru='Каталога %1 не существует. проверьте правильность написания имени каталога.';en='Directory %1 does not exist. check the spelling of the directory name.'"),
				Результат);
			Сообщение = Новый СообщениеПользователю();
			Сообщение.Текст = ТекстСообщения;
			Сообщение.Поле  = "ПутьДругогоКаталога";
		...
		КонецЕсли;
	Иначе
		ТекстСообщения = НСтр("es='Es necesario escoger el catálogo de la reconstitución de la copia de reserva.';ru='Необходимо выбрать каталог восстановления резервной копии.';en='Required to select a backup recovery directory.'");
		Сообщение = Новый СообщениеПользователю();
		Сообщение.Текст = ТекстСообщения;
		Сообщение.Поле  = "ПутьДругогоКаталога";
		Сообщение.УстановитьДанные(Объект);
...
Процедура КомандаОтменаЗагрузки(Команда)
	...
	Если ЭтотОбъект.ИдентификаторСостоянияЗагрузкиФайла = "ЗагрузкаФайла" Тогда // Идентификатор: ЗагрузкаФайла, ОтменаЗагрузки, ФайлЗагружен, ОшибкиЗагрузки, РаспаковкаФайла, ФайлРаспакован, ОшибкиРаспаковки.
		...
		ПоказатьВопрос(
			...
			НСтр("es='¿Anular la carga?';ru='Отменить загрузку?';en='Cancel download?'"), // ТекстВопроса
			РежимДиалогаВопрос.ДаНет, // Кнопки
			10, // Таймаут
			КодВозвратаДиалога.Нет, // КнопкаПоУмолчанию
			НСтр("es='La confirmación';ru='Подтверждение';en='Confirmation'"), // Заголовок
...
Процедура КомандаДалее(Команда)
	...
	ИначеЕсли ТекущаяСтраница = Элементы.СтраницаВыборКаталога Тогда
		...
		Если ПустаяСтрока(ЭтотОбъект.ПутьДругогоКаталога) Тогда
			ТекстСообщения = НСтр("es='Es necesario escoger el catálogo para la reconstitución.';ru='Необходимо выбрать каталог для восстановления.';en='Required to select a directory to restore.'");
			Сообщение = Новый СообщениеПользователю();
			Сообщение.Текст = ТекстСообщения;
			Сообщение.Поле  = "ПутьДругогоКаталога";
			Сообщение.УстановитьДанные(Объект);
		...
		Иначе
			...
			Если ТекущийКаталогИБ = КаталогВосстановления Тогда
				Элементы.ДекорацияВыборКаталогаОшибкаТекст.Заголовок =
					НСтр("es='No es posible restablecer la copia de reserva en el catálogo con la base corriente informativa.';ru='Нельзя восстанавливать резервную копию в каталог с текущей информационной базой.';en='Can not restore a backup to a directory with the current infobase.'");
			...
			Иначе
				...
				Иначе
					Элементы.ДекорацияВыборКаталогаОшибкаТекст.Заголовок =
						СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("es='El catálogo %1 no existe.';ru='Каталог %1 не существует.';en='Directory %1 does not exist.'"),
...
#Область СтраницаЗагрузкаФайла
		...
		лкДалее.Заголовок       = НСтр("es='Cargar';ru='Загрузить';en='Download'");
		...
		ИначеЕсли Форма.ИдентификаторСостоянияЗагрузкиФайла = "ФайлЗагружен" Тогда
			...
			лкДалее.Заголовок   = НСтр("es='Распаковать';ru='Распаковать';en='Unpack'");
		...
		ИначеЕсли Форма.ИдентификаторСостоянияЗагрузкиФайла = "ОшибкиЗагрузки" Тогда
			лкДалее.Заголовок   = НСтр("es='Cargar de nuevo';ru='Загрузить заново';en='Download again'");
			лкДалее.Доступность    = Истина;
			лкЗакрыть.Доступность  = Истина;
...
#Область СтраницаВыборКаталога
		...
		Форма.Заголовок = НСтр("es='Escojan el catálogo para разархивации';ru='Выберите каталог для разархивации';en='Select the directory to unzip'");

		лкОтмена.Видимость    = Ложь;
		лкНазад.Видимость     = Ложь;
		лкДалее.Видимость     = Истина;
		лкДалее.Доступность   = Истина;
		лкДалее.Заголовок     = НСтр("es='Разархивировать';ru='Разархивировать';en='Unzip'");
		лкЗакрыть.Видимость   = Истина;
		лкЗакрыть.Доступность = Истина;
...
#Область СтраницаОтключениеСеансов
		...
		Форма.Заголовок = НСтр("es='La desconexión de las sesiones activas';ru='Отключение активных сеансов';en='Disabling Active Sessions'");
...
#Область СтраницаУспешноеЗавершение
		...
		лкЗакрыть.Заголовок = НСтр("es='Es preparado';ru='Готово';en='Done'");
	...
	#Если НЕ ВебКлиент Тогда
		...
		Попытка
			ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
				...
				НСтр("es='La unión con el servidor para la carga del fichero de la copia de reserva';ru='Соединение с сервером для загрузки файла резервной копии';en='Connecting to a server to download a backup file'"));
			...
			ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
				ЭтотОбъект.КонтекстВыполнения,
				0,
				НСтр("es='La conexión exitosa al servidor para la carga del fichero de la copia de reserva';ru='Успешное подключение к серверу для загрузки файла резервной копии';en='Successfully connecting to the server to download the backup file'"),
				Неопределено);
		...
		Исключение
			...
			ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
				...
				1001,
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='La falta de la conexión al servidor: "
"%1';ru='Ошибка подключения к серверу:"
"%1';en='Error connecting to server:"
"%1'"),
					ПодробноеПредставлениеОшибки),
				Неопределено);
		...
		Иначе
			...
			// Текущее состояние загрузки.
			ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='La falta de la conexión a los http-servicios.';ru='Ошибка подключения к http-сервисам.';en='Error connecting to http services.'");
			ЭтотОбъект.ОбновитьОтображениеДанных();
			Элементы.ДекорацияОшибкаТекст.Подсказка =
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='La falta de la conexión a los http-servicios: "
"%1';ru='Ошибка подключения к http-сервисам:"
"%1';en='Error connecting to http services:"
"%1'"),
					ПодробноеПредставлениеОшибки);
			Элементы.ГруппаСтраницыСостояниеЗагрузки.ТекущаяСтраница = Элементы.ГруппаОшибка;
		КонецЕсли;
	...
	#Если НЕ ВебКлиент Тогда
		...
		Если ЭтотОбъект.ИдентификаторСостоянияЗагрузкиФайла = "ЗагрузкаФайла" Тогда // Идентификатор: ЗагрузкаФайла, ОтменаЗагрузки, ФайлЗагружен, ОшибкиЗагрузки, РаспаковкаФайла, ФайлРаспакован, ОшибкиРаспаковки.
			...
			ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
				...
				НСтр("es='La carga de la parte del fichero de la copia de reserva';ru='Загрузка части файла резервной копии';en='Downloading part of the backup file'"));
			КодРезультата = 0;
			ОписаниеРезультата = "";
			...
			Если ТекущаяСтрока <> Неопределено Тогда
				...
				Исключение
					...
					ОписаниеРезультата = ОписаниеРезультата
						+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("es='Había una falta de la carga de la parte del fichero: "
"%1';ru='Произошла ошибка загрузки части файла:"
"%1';en='An error occurred loading part of the file:"
"%1'")
								+ Символы.ПС,
							ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
				КонецПопытки;
				...
				ИначеЕсли (ХТТПОтвет.КодСостояния <> 200) Тогда
					...
					ОписаниеРезультата = ОписаниеРезультата
						+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
							НСтр("es='El código incorrecto del regreso (en HTTP la respuesta): "
""
"%1 %2';ru='Неправильный код возврата (в HTTP ответе):"
"%1"
"%2';en='Wrong return code (in HTTP response):"
"%1"
"%2 '")
								+ Символы.ПС,
				...
				Иначе
					...
					ИначеЕсли КодВозврата = "7" Тогда // Переполучить ключ авторизации
						...
						ОписаниеРезультата = ОписаниеРезультата
							+ НСтр("es='El proceso de la carga era demasiado largo, la llave de la autorización se ha sida retrasado y será recibido de nuevo.';ru='Процесс загрузки был слишком длительный, ключ авторизации просрочился и будет получен заново.';en='The download process was too long, the authorization key has expired and will be received again.'")
								+ Символы.ПС;
					Иначе
						ОписаниеРезультата = ОписаниеРезультата
							+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
								НСтр("es='El código del regreso (errorCode) ha devuelto la falta: %1';ru='Код возврата (errorCode) вернул ошибку: %1';en='The return code (errorCode) returned an error:%1'")
									+ Символы.ПС,
								КодВозврата);
					КонецЕсли;
					...
					Если Файл.Существует() Тогда
						...
						Если ТекущаяСтрока.Размер = ТекущаяСтрока.РазмерЗагруженного Тогда
							...
							Если ТекущаяСтрока.КонтрольнаяСумма = ТекущаяСтрока.КонтрольнаяСуммаЗагруженного Тогда
								...
								ОписаниеРезультата = ОписаниеРезультата
									+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
										НСтр("es='Es con éxito cargada la parte del fichero. "
"El nombre del fichero temporal: %1 "
"Dimensión del fichero (el byte): %2 "
"suma De control (md5): %3';ru='Успешно загружена часть файла."
"Имя временного файла: %1"
"Размер файла (байт): %2"
"Контрольная сумма (md5): %3';en='Successfully uploaded part of the file."
"Temporary file name:%1"
"File Size (Bytes):%2"
"Checksum (md5):%3'")
											+ Символы.ПС,
							...
							Иначе
								...
								ОписаниеРезультата = ОписаниеРезультата
									+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
										НСтр("es='No coincide esperado (%1) y (%2) suma real de control (md5) las partes del fichero.';ru='Не совпадает ожидаемая (%1) и реальная (%2) контрольная сумма (md5) части файла.';en='The expected (%1) and real (%2) checksum (md5) parts of the file do not match.'")
											+ Символы.ПС,
										ТекущаяСтрока.КонтрольнаяСумма,
						...
						Иначе
							...
							ОписаниеРезультата = ОписаниеРезультата
								+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
									НСтр("es='No coincide esperado (%1) y (%2) dimensión real de la parte del fichero.';ru='Не совпадает ожидаемый (%1) и реальный (%2) размер части файла.';en='The expected (%1) and real (%2) file part sizes do not match.'")
										+ Символы.ПС,
									ТекущаяСтрока.Размер,
					...
					Иначе
						...
						ОписаниеРезультата = ОписаниеРезультата
							+ СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
								НСтр("es='(%1). Probablemente, él no era cargado.';ru='Не найден временный файл (%1). Возможно, он не был загружен.';en='Temporary file not found (%1). It may not have been downloaded.'")
									+ Символы.ПС,
								ТекущаяСтрока.ИмяВременногоФайла);
					КонецЕсли;
				КонецЕсли;
			...
			Если ЭтотОбъект.КоличествоСбойныхЧастей = 0 Тогда
				ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Es cargado %1 partes de %2 (%3 de %4).';ru='Загружено %1 частей из %2 (%3 из %4).';en='Downloaded% 1 parts of% 2 (% 3 of% 4).'"),
			...
			Иначе
				ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Es cargado %1 partes de %2 (%3 de %4). "
"Durante la carga había unas intermitencias: %5';ru='Загружено %1 частей из %2 (%3 из %4)."
"Во время загрузки были сбои: %5';en='Downloaded%1 parts of%2 (%3 of%4)."
"There were crashes during loading:%5 '"),
					ЭтотОбъект.ЧастиФайла.Индекс(ТекущаяСтрока) + 1,
					ЭтотОбъект.ЧастиФайла.Количество(),
					ОблачныйАрхивКлиентСервер.ПолучитьПредставлениеРазмера(ЭтотОбъект.ВсегоЗагруженоБайт),
					ОблачныйАрхивКлиентСервер.ПолучитьПредставлениеРазмера(ЭтотОбъект.filesize),
			...
			ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
				...
				НСтр("es='La terminación de la carga del fichero de la copia de reserva';ru='Завершение загрузки файла резервной копии';en='Completing the download of the backup file'"));
			КодРезультата = 0;
			ОписаниеРезультата = "";
			...
			Если МассивНеЗагруженных.Количество() = 0 Тогда
				...
				ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='La asociación de las partes del fichero en un archivo...';ru='Объединение частей файла в один архив...';en='Combining parts of a file into one archive ...'");
				ЭтотОбъект.ОбновитьОтображениеДанных();
				...
				ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
					ЭтотОбъект.КонтекстВыполнения,
					КодРезультата,
					НСтр("es='La carga del fichero de la copia de reserva es con éxito acabada';ru='Загрузка файла резервной копии успешно завершена';en='Backup file upload completed successfully'"),
					Неопределено);
			...
			Иначе // Есть незагруженные части файлов
				...
				Если ЕстьЧтоЗагружать = Ложь Тогда
					...
					ЭтотОбъект.ИдентификаторСостоянияЗагрузкиФайла = "ОшибкиЗагрузки"; // Идентификатор: ЗагрузкаФайла, ОтменаЗагрузки, ФайлЗагружен, ОшибкиЗагрузки, РаспаковкаФайла, ФайлРаспакован, ОшибкиРаспаковки.
					// Текущее состояние загрузки.
					ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='Había unas partes no cargadas del fichero.';ru='Остались незагруженные части файла.';en='Unloaded parts of the file remain.'");
					Элементы.ДекорацияОшибкаТекст.Подсказка =
						НСтр("es='Había unas partes no cargadas del fichero, "
"por que no se quedó las tentativas de la carga. "
"La carga es acabada con las faltas.';ru='Остались незагруженные части файла,"
"по которым не осталось попыток загрузки."
"Загрузка завершена с ошибками.';en='Unloaded parts of the file remain"
"for which there are no download attempts left."
"Download completed with errors.'");
					...
					ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
						ЭтотОбъект.КонтекстВыполнения,
						1002,
						НСтр("es='La carga del fichero de la copia de reserva no es acabada por las faltas';ru='Загрузка файла резервной копии не завершена из-за ошибок';en='Backup file upload not completed due to errors'"),
						Неопределено);
	...
	#Если НЕ ВебКлиент Тогда
		...
		Элементы.ДекорацияУспешноеЗавершениеТекст.Заголовок =
			Новый ФорматированнаяСтрока(
				НСтр("es='La base informativa de la copia de reserva es con éxito restablecida en el catálogo';ru='Информационная база из резервной копии успешно восстановлена в каталог';en='The infobase from the backup was successfully restored to the directory'"),
				Символы.ПС,
				Новый ФорматированнаяСтрока(
					ЭтотОбъект.ПутьДругогоКаталога,
					,
		...
		// Текущее состояние загрузки.
		ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='La limpieza del catálogo ante el desempaquetamiento del fichero...';ru='Очистка каталога перед распаковкой файла...';en='Clearing the directory before unpacking the file ...'");
		Элементы.ДекорацияВыборКаталогаОшибкаТекст.Заголовок = "";
		Элементы.ГруппаВыборКаталогаПодвал.ТекущаяСтраница = Элементы.ГруппаВыборКаталогаПодвалПредупреждения;
		...
		ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
			...
			НСтр("es='La limpieza del catálogo-destinatario ante разархивацией del fichero cargado de la copia de reserva';ru='Очистка каталога-получателя перед разархивацией загруженного файла резервной копии';en='Clearing the destination directory before unzipping the downloaded backup file'"));
		...
		Если ЕстьОшибкиУдаления = Истина Тогда
			...
			// Текущее состояние загрузки.
			ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='La falta разархивации del fichero.';ru='Ошибка разархивации файла.';en='Unarchiving file error.'");
			ЭтотОбъект.ОбновитьОтображениеДанных();
			...
			Элементы.ДекорацияВыборКаталогаОшибкаТекст.Подсказка =
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='La información sobre la falta: "
"%1';ru='Информация об ошибке:"
"%1';en='Error information:"
"%1'"),
					ПодробноеПредставлениеОшибки);
			Элементы.ДекорацияВыборКаталогаОшибкаТекст.Заголовок =
					НСтр("es='La falta de la limpieza del catálogo. "
"Probablemente, es puesta en marcha la base informativa vinculada a este catálogo.';ru='Ошибка очистки каталога."
"Возможно, запущена информационная база, связанная с этим каталогом.';en='Error clearing directory."
"The infobase associated with this directory may be running.'");
			Элементы.ГруппаВыборКаталогаПодвал.ТекущаяСтраница = Элементы.ГруппаВыборКаталогаПодвалОшибка;
			УправлениеФормой(ЭтотОбъект);
			...
			ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
				...
				1006,
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='Las faltas de la limpieza del catálogo-receptor ante el desempaquetamiento de la copia de reserva. "
"La vía al archivero: %1 "
"Vía al fichero cargado: %2 "
"Vía para la limpieza: %3 "
"Falta: "
"%4';ru='Ошибки очистки каталога-приемника перед распаковкой резервной копии."
"Путь к архиватору: %1"
"Путь к загруженному файлу: %2"
"Путь для очистки: %3"
"Ошибка:"
"%4';en='Errors in cleaning the destination directory before unpacking the backup."
"Path to the archiver:%1"
"The path to the downloaded file:%2"
"Cleaning path:%3"
"Error:"
"%4'")
						+ Символы.ПС,
		...
		Иначе
			...
			ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
				...
				0,
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='La limpieza exitosa del catálogo-receptor. "
"La vía al archivero: %1 "
"Vía al fichero cargado: %2 "
"Vía para la limpieza: %3';ru='Успешная очистка каталога-приемника."
"Путь к архиватору: %1"
"Путь к загруженному файлу: %2"
"Путь для очистки: %3';en='Successfully clean up the destination directory."
"Path to the archiver:%1"
"The path to the downloaded file:%2"
"Cleaning path:%3 '")
						+ Символы.ПС,
			...
			// Текущее состояние загрузки.
			ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='El desempaquetamiento del fichero...';ru='Распаковка файла...';en='Unpacking the file ...'");
			...
			Попытка
				ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
					...
					НСтр("es='Разархивация del fichero cargado de la copia de reserva';ru='Разархивация загруженного файла резервной копии';en='Unzip the downloaded backup file'"));
				...
				Иначе
					...
					ПодробноеПредставлениеОшибки = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("es='El código del regreso del programa разархивации se distingue de 0. "
"La línea de la orden: "
"%1 "
"Código del regreso: %2 "
"Flujo de las faltas: "
"%3';ru='Код возврата программы разархивации отличается от 0."
"Строка команды:"
"%1"
"Код возврата: %2"
"Поток ошибок:"
"%3';en='The unarchiving program return code is not 0."
"Command line:"
"%one"
"Return code:%2"
"Error stream:"
"%3'"),
			...
			Если ЕстьОшибки = Ложь Тогда
				...
				ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
					...
					0,
					СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("es='Exitoso разархивация del fichero de la copia de reserva. "
"La vía al archivero: %1 "
"Vía al fichero cargado: %2 "
"Dimensión del fichero cargado: %3 "
"Código del regreso del programa: %4 "
"línea De mando: %5 "
"Vía al fichero de mando: %6';ru='Успешная разархивация файла резервной копии."
"Путь к архиватору: %1"
"Путь к загруженному файлу: %2"
"Размер загруженного файла: %3"
"Код возврата программы: %4"
"Командная строка: %5"
"Путь к командному файлу: %6';en='Successfully unzipping the backup file."
"Path to the archiver:%1"
"The path to the downloaded file:%2"
"Uploaded file size:%3"
"Program Return Code:%4"
"Command line:%5"
"Path to batch file:%6 '")
							+ Символы.ПС,
						ПутьКАрхиватору,
						ПутьКЗагруженномуФайлу,
			...
			Иначе
				...
				ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
					...
					1005,
					СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("es='La falta разархивации del fichero de la copia de reserva. "
"La vía al archivero: %1 "
"Vía al fichero cargado: %2 "
"Dimensión del fichero cargado: %3 "
"Código del regreso del programa: %4 "
"línea De mando: %5 "
"Vía al fichero de mando: %6 "
"Falta: "
"%7';ru='Ошибка разархивации файла резервной копии."
"Путь к архиватору: %1"
"Путь к загруженному файлу: %2"
"Размер загруженного файла: %3"
"Код возврата программы: %4"
...
"Ошибка:"
"%7';en='Error unzipping the backup file."
"Path to the archiver:%1"
"The path to the downloaded file:%2"
"Uploaded file size:%3"
"Program Return Code:%4"
...
"%1'"),
				...
				Элементы.ДекорацияВыборКаталогаОшибкаТекст.Заголовок =
					СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
						НСтр("es='La falta разархивации del fichero: "
"%1';ru='Ошибка разархивации файла:"
"%1';en='Error unarchiving file:"
"%1'"),
						ПодробноеПредставлениеОшибки);
				УправлениеФормой(ЭтотОбъект);
			КонецЕсли;
...
Процедура УдалитьВременныеФайлы()
	...
	ЭтотОбъект.ПредставлениеТекущегоСостоянияЗагрузкиФайла = НСтр("es='La desaparición de los ficheros temporales...';ru='Удаление временных файлов...';en='Deleting temporary files ...'");
	ЭтотОбъект.ОбновитьОтображениеДанных();
	УдалитьФайлы(
		ЭтотОбъект.КаталогРабочий
			+ ПолучитьРазделительПутиКлиента()
...
Процедура ЗаписатьСообщениеВЛогНаСервере()
	...
	ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("es='La carga del fichero de la copia de reserva, el informe total. "
"El tiempo del comienzo (мс): %1 "
"Tiempo de la terminación (мс): %2 "
"Duración (мс): %3 "
"Resultado de la ejecución: "
"%4';ru='Загрузка файла резервной копии, итоговый отчет."
"Время начала (мс): %1"
"Время окончания (мс): %2"
"Длительность (мс): %3"
"Результат выполнения:"
"%4';en='Download backup file, summary report."
"Start Time (ms):%1"
"End Time (ms):%2"
"Duration (ms):%3"
"Execution Result:"
"%4'")
	...
	ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
		...
		НСтр("es='El archivo nuboso. Los servicios Web. La carga del fichero de la copia de reserva';ru='Облачный архив. Веб-сервисы. Загрузка файла резервной копии';en='Cloud archive. Web services Download backup file'"), // ИмяСобытия
...
Процедура ПослеВопросаПодтвержденияОтменыЗагрузки(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	Если РезультатВопроса = КодВозвратаДиалога.Да Тогда
		...
		ИнтернетПоддержкаПользователейКлиентСервер.НачатьРегистрациюРезультатаВыполненияОперации(
			...
			НСтр("es='La anulación de la carga del fichero de la copia de reserva';ru='Отмена загрузки файла резервной копии';en='Cancel download backup file'"));
		...
		ИнтернетПоддержкаПользователейКлиентСервер.ЗавершитьРегистрациюРезультатаВыполненияОперации(
			ЭтотОбъект.КонтекстВыполнения,
			0,
			НСтр("es='Es anulada la carga del fichero de la copia de reserva';ru='Отменена загрузка файла резервной копии';en='Backup file canceled'"),
			Неопределено);
