...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.КоманднаяСтрокаДругойКомпьютер = 
		НСтр("es='<la Vía al Agente establecido de la copia de reserva>';ru='<Путь к установленному Агенту резервного копирования>';en='<Путь к установленному Агенту резервного копирования>'")
		+ ПолучитьРазделительПути()
	...
	Если НЕ РезультатЗапроса.Пустой() Тогда
		...
		ТекстПодсказки = НСтр("es='Los agentes de la copia de reserva eran establecidos en los ordenadores siguientes:';ru='Агенты резервного копирования были установлены на следующих компьютерах:';en='Backup agents were installed on the following computers:'")
			+ Символы.ПС
			+ ТекстПодсказки;
