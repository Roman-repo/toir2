...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(1, НСтр("es='El lunes';ru='Понедельник';en='Monday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(2, НСтр("es='El martes';ru='Вторник';en='Tuesday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(3, НСтр("es='El ambiente';ru='Среда';en='Wednesday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(4, НСтр("es='El jueves';ru='Четверг';en='Thursday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(5, НСтр("es='El viernes';ru='Пятница';en='Friday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(6, НСтр("es='El sábado';ru='Суббота';en='Saturday'"), Ложь);
	ЭтотОбъект.Еженедельно_ДниНедели.Добавить(7, НСтр("es='El domingo';ru='Воскресенье';en='Sunday'"), Ложь);

	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Очистить();
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(1, НСтр("es='El lunes';ru='Понедельник';en='Monday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(2, НСтр("es='El martes';ru='Вторник';en='Tuesday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(3, НСтр("es='El ambiente';ru='Среда';en='Wednesday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(4, НСтр("es='El jueves';ru='Четверг';en='Thursday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(5, НСтр("es='El viernes';ru='Пятница';en='Friday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(6, НСтр("es='El sábado';ru='Суббота';en='Saturday'"), Ложь);
	ЭтотОбъект.Ежемесячно_ПоДнямНедели_ДниНедели.Добавить(7, НСтр("es='El domingo';ru='Воскресенье';en='Sunday'"), Ложь);
...
Процедура КомандаЗаписатьИЗакрыть(Команда)
	...
	Если ПустаяСтрока(ЭтотОбъект.Вариант) Тогда
		ПоказатьОповещениеПользователя(
			,
			,
			НСтр("es='El horario no era ajustado';ru='Расписание не было настроено';en='Schedule has not been configured'"),
