...
Функция РезультатСопоставленияОбъектов(Параметры)
	...
	Если Параметры.РеквизитыФормы.ТолькоПрименитьТаблицуНеутвержденныхЗаписей Тогда
		...
		Если Отказ Тогда
			ВызватьИсключение НСтр("es='Han surgido las faltas durante la comparación de los objetos.';ru='Возникли ошибки в процессе сопоставления объектов.';en='Errors occurred while matching objects.'");
		КонецЕсли;
...
Функция РезультатАвтоматическогоСопоставленияОбъектов(Параметры)
	...
	Если Отказ Тогда
		ВызватьИсключение НСтр("es='Han surgido las faltas durante la comparación automática de los objetos.';ru='Возникли ошибки в процессе автоматического сопоставления объектов.';en='Errors occurred while automatically matching objects.'");
	КонецЕсли;
