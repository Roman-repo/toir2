...
Процедура Применить(Команда)
	...
	ИначеЕсли МассивОтмеченныхЭлементовСписка.Количество() > МаксимальноеКоличествоПользовательскихПолей() Тогда
		...
		СтрокаСообщения = НСтр("es='Reduzcan la cantidad de los campos (se puede escoger no más [KolichestvoPoley] los campos)';ru='Уменьшите количество полей (можно выбирать не более [КоличествоПолей] полей)';en='Reduce the number of fields (you can select no more than [КоличествоПолей] fields)'");
