...
Процедура ПриОткрытии(Отказ)
	...
	Если ЭтотОбъект.ТаблицаНовостей.Количество() <= 0 Тогда
		...
		ТекстСообщения     = НСтр("es='Para esta forma no hay novedades de contexto.';ru='Для этой формы нет контекстных новостей.';en='There is no contextual news for this form.'");
		ПояснениеСообщения = НСтр("es='Presionen aquí para la presentación de todas las novedades.';ru='Нажмите здесь для просмотра всех новостей.';en='Click here to view all news.'");
