...
Процедура КомандаЗагрузить(Команда)
	...
	Диалог.Заголовок = НСтр("es='Escojan el fichero, de donde tomar el contenido de la novedad en el formato XML';ru='Выберите файл, откуда взять содержимое новости в формате XML';en='Choose a file where to get the news content in XML format'");
