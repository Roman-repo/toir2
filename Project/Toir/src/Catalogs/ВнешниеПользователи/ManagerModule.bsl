	...
	Если ВидФормы = "ФормаОбъекта" И Параметры.Свойство("ОбъектАвторизации") Тогда
		...
		Иначе
			ОписаниеОшибкиКакПредупреждения =
				НСтр("es='El permiso para la entrada en el programa no era concedido.';ru='Разрешение на вход в программу не предоставлялось.';en='Permission to enter the program was not granted.'");
