...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок =  СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("es='La elección del requisito %1';ru='Выбор реквизита %1';en='Props selection%1'"), ?(Объект.Синоним = "", Объект.Имя, Объект.Синоним));
...
Процедура ЗаполнитьДеревоРеквизитов(ИмяМетаданных,
	...
	НоваяСтрока.Представление = НСтр("es='La representación';ru='Представление';en='Performance'");
	НоваяСтрока.ПредставлениеПути = НСтр("es='La representación';ru='Представление';en='Performance'");
...
Процедура ЗаполнитьПодчиненныеРеквизиты(Строка, ИмяМетаданных)
	...
	НоваяСтрока.Представление = НСтр("es='La representación';ru='Представление';en='Performance'");
	НоваяСтрока.ПредставлениеПути = ДанныеСтроки.ПредставлениеПути + "." + НСтр("es='La representación';ru='Представление';en='Performance'");
	НоваяСтрока.Тип = "Строка";
