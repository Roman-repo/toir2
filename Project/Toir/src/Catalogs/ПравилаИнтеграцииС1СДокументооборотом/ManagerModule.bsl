...
Функция ПолучитьРеквизитыОбъектаДокументооборота(ТипОбъектаДокументооборота, Параметры = Неопределено) Экспорт 
		...
		Если ДоступенПакетныйЗапрос Тогда
			...
			Исключение // Возможно, этого вида документа уже нет в ДО.
				...
				ИнтеграцияС1СДокументооборотВызовСервера.ЗаписатьПредупреждение(
					СтрШаблон(НСтр("es='1С:Документообороте antes el tipo que existía del documento %1';ru='Не найден в 1С:Документообороте ранее существовавший вид документа %1';en='Not found in 1C: Document management preexisting document type%1'"),
	...
	Если ТипОбъектаДокументооборота = "DMIncomingDocument" Тогда 
		...
		Если НастройкиТипа.documentTypeEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "documentType", НСтр("es='El tipo del documento';ru='Вид документа';en='Document type'"), "DMIncomingDocumentType", Истина);
		КонецЕсли;
			
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "correspondent", НСтр("es='El remitente';ru='Отправитель';en='Sender'"), "DMCorrespondent", Истина);
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "externalNumber", НСтр("es='№ del remitente';ru='№ отправителя';en='Sender №'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "externalDate", НСтр("es='La fecha del remitente';ru='Дата отправителя';en='Sender вate'"), "Дата");
		
		Если НастройкиТипа.organizationEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "organization", НСтр("es='La organización';ru='Организация';en='Organization'"), "DMOrganization", Истина);
		КонецЕсли;
		
		Если НастройкиВида = Неопределено Или НастройкиВида.sumEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "sum", НСтр("es='La suma';ru='Сумма';en='Amount'"), "Число");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "currency", НСтр("es='La divisa';ru='Валюта';en='Currency'"), "DMCurrency");
		КонецЕсли;
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "title", НСтр("en='Name';es='El nombre';ru='Наименование'"), "Строка", Истина);
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "summary", НСтр("es='El contenido';ru='Содержание';en='Content'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "regNumber", НСтр("es='El número de registro';ru='Регистрационный номер';en='Registration number'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "regDate", НСтр("es='La fecha del registro';ru='Дата регистрации';en='Registration date'"), "Дата");
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "signer", НСтр("es='Ha firmado';ru='Подписал';en='Signed'"), "DMContactPerson");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "addressee", НСтр("es='El destinatario';ru='Адресат';en='Destination'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "subdivision", НСтр("es='La subdivisión';ru='Подразделение';en='Subdivision'"), "DMSubdivision");
		
		Если НастройкиВида = Неопределено Или НастройкиВида.performanceDateEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "performanceDate", НСтр("es='El plazo de la realización';ru='Срок исполнения';en='Period of execution'"), "Дата");
		КонецЕсли;
		
		Если НастройкиТипа.accessLevelEnabled  = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "accessLevel", НСтр("es='El grifo del acceso';ru='Гриф доступа';en='Access bar'"), "DMAccessLevel", Истина);
		КонецЕсли;
		
		Если НастройкиТипа.activityMatterEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "activityMatter", НСтр("es='La pregunta de la actividad';ru='Вопрос деятельности';en='Question of activity'"), "DMActivityMatter", Истина);
		КонецЕсли;
		
		// Проекты.
		Если ИнтеграцияС1СДокументооборотПовтИсп.ДоступенФункционалВерсииСервиса("1.3.2.3.CORP") Тогда
			Если НастройкиТипа.projectsEnabled = Истина Тогда
				ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "project", НСтр("es='El proyecto';ru='Проект';en='Project'"), "DMProject");
			КонецЕсли;
		КонецЕсли;
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "deliveryMethod",  НСтр("es='El modo de la recepción';ru='Способ получения';en='Receiving method'"), "DMDeliveryMethod");
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "comment", НСтр("es='El comentario';ru='Комментарий';en='Comment'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "responsible", НСтр("es='Responsable';ru='Ответственный';en='Responsible'"), "DMUser");
		
		
	ИначеЕсли ТипОбъектаДокументооборота = "DMOutgoingDocument" Тогда 
		
		Если НастройкиТипа.documentTypeEnabled = Истина Тогда
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "documentType", НСтр("es='El tipo del documento';ru='Вид документа';en='Document type'"), "DMOutgoingDocumentType", Истина);
		КонецЕсли;
			
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "correspondent", НСтр("es='El destinatario';ru='Получатель';en='Recipient'"), "DMCorrespondent", Истина);
		
		Если НастройкиВида = Неопределено Или НастройкиВида.externalNumberEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "externalNumber", НСтр("es='№ del destinatario';ru='№ получателя';en='Recipient №'"), "Строка");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "externalDate", НСтр("es='La fecha del destinatario';ru='Дата получателя';en='Recipient date'"), "Дата");
		КонецЕсли;
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "title", НСтр("es='El encabezamiento';ru='Заголовок';en='Headlng'"), "Строка", Истина);
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "summary", НСтр("es='El contenido';ru='Содержание';en='Content'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "regNumber", НСтр("es='El número de registro';ru='Регистрационный номер';en='Registration number'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "regDate", НСтр("es='La fecha del registro';ru='Дата регистрации';en='Registration date'"), "Дата");
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "addressee", НСтр("es='El destinatario';ru='Адресат';en='Destination'"), "DMContactPerson");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "sent", НСтр("es='Es enviado';ru='Отправлен';en='Sent'"), "Булево");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "sendDate", НСтр("es='La fecha del envío';ru='Дата отправки';en='Departure date'"), "Дата");
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "signer", НСтр("es='Ha firmado';ru='Подписал';en='Signed'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "author", НСтр("es='Ha preparado';ru='Подготовил';en='Prepared'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "subdivision", НСтр("es='La subdivisión';ru='Подразделение';en='Subdivision'"), "DMSubdivision");
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "deliveryMethod", НСтр("es='El modo del envío';ru='Способ отправки';en='Shipping method'"), "DMDeliveryMethod");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "comment", НСтр("es='El comentario';ru='Комментарий';en='Comment'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "responsible", НСтр("es='Responsable';ru='Ответственный';en='Responsible'"), "DMUser");
	...
	ИначеЕсли ТипОбъектаДокументооборота = "DMInternalDocument" Тогда 
		...
		Если НастройкиТипа.documentTypeEnabled = Истина Тогда
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "documentType", НСтр("es='El tipo del documento';ru='Вид документа';en='Document type'"), "DMInternalDocumentType", Истина);
		КонецЕсли;
		
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "folder", НСтр("es='La carpeta';ru='Папка';en='Folder'"), "DMInternalDocumentFolder", Истина);
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "signer", НСтр("es='Ha afirmado';ru='Утвердил';en='Approved'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "author", НСтр("es='Ha preparado';ru='Подготовил';en='Prepared'"), "DMUser");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "subdivision", НСтр("es='La subdivisión';ru='Подразделение';en='Subdivision'"), "DMSubdivision");
		...
		Если НастройкиВида = Неопределено Или НастройкиВида.correspondentEnabled = Истина Тогда 
			Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
				ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "correspondent", НСтр("es='El corresponsal';ru='Корреспондент';en='Correspondent'"), "DMCorrespondent", Истина);
			Иначе
				ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "correspondent", НСтр("es='El contratante';ru='Контрагент';en='Counterparty'"), "DMCorrespondent", Истина);
			КонецЕсли;
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "contactPerson", НСтр("es='La persona de contacto';ru='Контактное лицо';en='The contact person'"), "DMContactPerson");
		КонецЕсли;
		
		Если НастройкиВида = Неопределено Или НастройкиВида.durationEnabled = Истина Тогда 
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "beginDate", НСтр("es='La fecha del comienzo de la acción';ru='Дата начала действия';en='Action start date'"), "Дата");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "endDate", НСтр("es='La fecha de la terminación de la acción';ru='Дата окончания действия';en='Expiration end date'"), "Дата");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "openEnded", НСтр("es='Ilimitado';ru='Бессрочный';en='Perpetual'"), "Булево");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "prolongationProcedure", НСтр("es='El orden de la prolongación';ru='Порядок продления';en='Renewal procedure'"), "DMProlongationProcedure");
		КонецЕсли;
	...
	ИначеЕсли ТипОбъектаДокументооборота = "DMCorrespondent" Тогда 
		...
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "name", НСтр("en='Name';es='El nombre';ru='Наименование'"), "Строка", Истина);
		Если ИнтеграцияС1СДокументооборотПовтИсп.ИспользоватьТерминКорреспонденты() Тогда
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "legalPrivatePerson", НСтр("es='El tipo del corresponsal';ru='Вид корреспондента';en='Type of correspondent'"), "DMLegalPrivatePerson", Истина);
		Иначе
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "legalPrivatePerson", НСтр("es='El tipo del contratante';ru='Вид контрагента';en='Type of counterparty'"), "DMLegalPrivatePerson", Истина);
		КонецЕсли;
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "inn", НСтр("es='EL INN';ru='ИНН';en='TIN'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "kpp", НСтр("es='КПП';ru='КПП';en='PPC:'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "okpo", НСтр("es='El código por ОКПО';ru='Код по ОКПО';en='OKPO code'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "comment", НСтр("es='El comentario';ru='Комментарий';en='Comment'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "fullName", НСтр("es='El nombre completo';ru='Полное наименование';en='Full name'"), "Строка");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "privatePerson", НСтр("es='La persona física';ru='Физическое лицо';en='Individual'"), "DMPrivatePerson");
		ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "responsible", НСтр("es='Responsable';ru='Ответственный';en='Responsible'"), "DMUser");
	...
	Если ТипОбъектаДокументооборота = "DMIncomingDocument"
		...
		Если НастройкиТипа.statusEnabled = Истина
			...
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusApproval", НСтр("es='El estado de la coordinación';ru='Состояние согласования';en='Approval status'"), "DMDocumentStatus");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusConfirmation", НСтр("es='El estado de la afirmación';ru='Состояние утверждения';en='Approval status'"), "DMDocumentStatus");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusConsideration", НСтр("es='El estado del examen';ru='Состояние рассмотрения';en='Review status'"), "DMDocumentStatus");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusPerformance", НСтр("es='El estado de la realización';ru='Состояние исполнения';en='Execution status'"), "DMDocumentStatus");
			ДобавитьСтрокуТаблицыПравилВыгрузки(Реквизиты, "statusRegistration", НСтр("es='El estado del registro';ru='Состояние регистрации';en='Registration status'"), "DMDocumentStatus");
						...
						Если МетаданныеИсточника.Реквизиты.Найти(ПравилоЗаполненияРеквизита.ИмяРеквизитаОбъектаПотребителя)
							...
							Если Не Найден Тогда
								ТекстСообщения = СтрШаблон(
									НСтр("es='%1 indicado en la regla la integración con 1С:Документооборотом. "
"Comprueben la regla de la integración o se dirijan al administrador.';ru='Не найден реквизит %1, указанный в правиле интеграции с 1С:Документооборотом."
"Проверьте правило интеграции или обратитесь к администратору.';en='The requisite %1 specified in the integration rule with 1C: Document flow was not found."
"Check the integration rule or contact your administrator.'",
		...
		Пока НомерРеквизита <= Правило.ПравилаЗаполненияРеквизитовПриВыгрузке.Количество() - 1 Цикл
			...
			Если НайденныеСтроки.Количество() = 0 Тогда
				...
				Если Не ПравилоРеквизита.ДополнительныйРеквизитДокументооборота Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("es='Es limpiada la regla del relleno del requisito %1 que falta en el documento';ru='Очищено правило заполнения реквизита %1, отсутствующего в документе';en='The rule for filling in the requisite%1 that is not in the document is cleared'",
							ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("es='Es limpiada la regla del relleno del requisito adicional que falta en el documento';ru='Очищено правило заполнения дополнительного реквизита, отсутствующего в документе';en='The rule for filling in additional details that is not in the document is cleared'",
						ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборот.ИмяСобытияЖурналаРегистрации(),
			...
			Если ПравилоРеквизита.ВариантПравилаЗаполненияРеквизитов = Перечисления.ВариантыПравилЗаполненияРеквизитов.ИзШаблона
				...
				Если Не ПравилоРеквизита.ДополнительныйРеквизитДокументооборота Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("es='Es limpiada la regla del relleno del requisito %1 que falta en el modelo';ru='Очищено правило заполнения реквизита %1, отсутствующего в шаблоне';en='The rule for filling in the attribute%1, which is not in the template, has been cleared'",
							ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("es='Es limpiada la regla del relleno del requisito adicional que falta en el modelo';ru='Очищено правило заполнения дополнительного реквизита, отсутствующего в шаблоне';en='The rule for filling in additional details that is not in the template is cleared'",
						ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборот.ИмяСобытияЖурналаРегистрации(),
			...
			Если ПравилоРеквизита.ВариантПравилаЗаполненияРеквизитов = Перечисления.ВариантыПравилЗаполненияРеквизитов.ИзШаблона
				...
				Если Не ПравилоРеквизита.ДополнительныйРеквизитДокументооборота Тогда
					ТекстСообщения = СтрШаблон(
						НСтр("es='Es limpiado el indicio ""Clave"" cerca del requisito %1 que falta en el modelo';ru='Очищен признак ""Ключевой"" у реквизита %1, отсутствующего в шаблоне';en='Cleared the “Key” attribute for the attribute %1, which is not in the template'",
							ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("es='Es limpiado el indicio ""Clave"" cerca del requisito adicional que falta en el modelo';ru='Очищен признак ""Ключевой"" у дополнительного реквизита, отсутствующего в шаблоне';en='The “Key” attribute of the additional attribute that is not in the template is cleared'",
						ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборот.ИмяСобытияЖурналаРегистрации(),
			...
			Если ШаблонЗапрещаетИзменение
				...
				Если Не ПравилоРеквизита.ДополнительныйРеквизитДокументооборота Тогда
					ТекстСообщения = СтрШаблон(НСтр("es='Es establecida la variante del relleno ""del modelo"" para el requisito %1, ya que el modelo prohíbe el cambio';ru='Установлен вариант заполнения ""Из шаблона"" для реквизита %1, поскольку шаблон запрещает изменение';en='The option ""fill from the template"" for the props%1 is set, because the template prohibits changing'"),
						ИмяРеквизита);
				Иначе
					ТекстСообщения = НСтр("es='Es establecida la variante del relleno ""del modelo"" para el requisito adicional, ya que el modelo prohíbe el cambio';ru='Установлен вариант заполнения ""Из шаблона"" для дополнительного реквизита, поскольку шаблон запрещает изменение';en='The option of filling out ""From the template"" for the additional attribute is set, since the template prohibits changing'");
				КонецЕсли;
				ЗаписьЖурналаРегистрации(
					ИнтеграцияС1СДокументооборот.ИмяСобытияЖурналаРегистрации(),
					УровеньЖурналаРегистрации.Предупреждение,,
