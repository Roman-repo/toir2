...
Процедура ПроверитьЦелостностьТома(Команда)
	...
	Если НЕ ЗначениеЗаполнено(Объект.Ссылка) Тогда
			ТекстВопроса = НСтр("es='Para la ejecución de la comprobación de la integridad es necesario anotar las noticias sobre el tomo. "
"¿Anotar?';ru='Для выполнения проверки целостности требуется записать сведения о томе."
"Записать?';en='To perform integrity checking, record volume information."
"To record? '");
