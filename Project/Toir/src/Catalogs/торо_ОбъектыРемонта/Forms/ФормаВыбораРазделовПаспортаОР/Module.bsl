...
Процедура Выбрать(Команда)
	...
	Иначе
		ТекстСообщения = НСтр("es='Es necesario escoger por lo menos 1 sección del pasaporte.';ru='Необходимо выбрать хотя бы 1 раздел паспорта.';en='Required to select at least 1 passport section.'");
