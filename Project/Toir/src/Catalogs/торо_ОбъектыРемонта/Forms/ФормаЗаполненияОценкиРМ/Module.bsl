...
Процедура ПеренестиВДокумент(Команда)
	...
	Для каждого СтрокаТЧ Из ТаблицаОценокРМ Цикл
		...
		Если НайданныеСтроки.Количество() > 1 Тогда
			ТекстСообщения = НСтр("es='¡Entre las líneas de las apreciaciones del riesgo-management hay que duplican!';ru='Среди строк оценок риск-менеджмента имеются дублирующиеся!';en='Among the lines of risk management assessments there are duplicate ones!'");
