...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа)
	...
	Если Копирование И Группа Тогда
		...
		ПоказатьПредупреждение(, НСтр("es='La adición de los nuevos grupos en la guía es prohíbida.';ru='Добавление новых групп в справочнике запрещено.';en='Adding new groups to the directory is prohibited.'"));
	КонецЕсли;
