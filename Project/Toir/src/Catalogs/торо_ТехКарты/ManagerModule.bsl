...
Функция ПечатьТехкарты(МассивОбъектов, ПараметрыПечати)
	...
	|ВЫБРАТЬ
	|	ВЫБОР
	|		КОГДА торо_РемонтыСписокОпераций.Операция.НаименованиеДляПечати = """"
	|			ТОГДА торо_РемонтыСписокОпераций.Операция.Наименование
	|		ИНАЧЕ торо_РемонтыСписокОпераций.Операция.НаименованиеДляПечати
	|   КОНЕЦ КАК Операция,
