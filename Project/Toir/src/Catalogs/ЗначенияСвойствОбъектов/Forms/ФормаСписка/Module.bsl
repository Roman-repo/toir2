	...
	Если ПустаяСтрока(СтрокаЗаголовка) Тогда
		...
		Если ЗначениеЗаполнено(Свойство) Тогда
			Если НЕ Параметры.РежимВыбора Тогда
				СтрокаЗаголовка = НСтр("es='Los significados de la propiedad %1';ru='Значения свойства %1';en='Property %1 values'");
			ИначеЕсли ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("es='Escojan el grupo de los significados de la propiedad %1';ru='Выберите группу значений свойства %1';en='Select property group%1'");
			Иначе
				СтрокаЗаголовка = НСтр("es='Escojan el significado de la propiedad %1';ru='Выберите значение свойства %1';en='Select property value%1'");
			КонецЕсли;
		...
		ИначеЕсли Параметры.РежимВыбора Тогда
			...
			Если ВыборГрупп Тогда
				СтрокаЗаголовка = НСтр("es='Escojan el grupo de los significados de la propiedad';ru='Выберите группу значений свойства';en='Select a group of property values'");
			Иначе
				СтрокаЗаголовка = НСтр("es='Escojan el significado de la propiedad';ru='Выберите значение свойства';en='Select property value'");
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;
