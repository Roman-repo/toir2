...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			// Режим подбора.
			Заголовок = НСтр("es='La selección de los grupos de los usuarios exteriores';ru='Подбор групп внешних пользователей';en='Selection of groups of external users'");
			Элементы.Список.МножественныйВыбор = Истина;
			Элементы.Список.РежимВыделения = РежимВыделенияТаблицы.Множественный;
		Иначе
			Заголовок = НСтр("es='La elección del grupo de los usuarios exteriores';ru='Выбор группы внешних пользователей';en='Select a group of external users'");
		КонецЕсли;
	Иначе
