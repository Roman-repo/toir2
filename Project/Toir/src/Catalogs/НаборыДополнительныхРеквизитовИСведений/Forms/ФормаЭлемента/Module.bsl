...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьДопРеквизиты И ИспользоватьДопСведения Тогда
		Заголовок = Объект.Наименование + " " + НСтр("es='(El juego de los requisitos adicionales y las noticias)';ru='(Набор дополнительных реквизитов и сведений)';en='(Set of additional details and information)'")
		
	ИначеЕсли ИспользоватьДопРеквизиты Тогда
		Заголовок = Объект.Наименование + " " + НСтр("es='(El juego de los requisitos adicionales)';ru='(Набор дополнительных реквизитов)';en='(Set of additional details)'")
		
	ИначеЕсли ИспользоватьДопСведения Тогда
		Заголовок = Объект.Наименование + " " + НСтр("es='(El juego de las noticias adicionales)';ru='(Набор дополнительных сведений)';en='(Set of additional information)'")
	КонецЕсли;
