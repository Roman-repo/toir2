...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='El acceso rápido a la orden ""%1""';ru='Быстрый доступ к команде ""%1""';en='Quick access to the command ""%1""'"), Параметры.ПредставлениеКоманды);
