...
Функция ПараметрыРасширеннойФормыПодбора()
	...
	ЗаголовокФормыПодбора = НСтр("es='La selección de los participantes del grupo de los usuarios';ru='Подбор участников группы пользователей';en='Selection of user group members'");
