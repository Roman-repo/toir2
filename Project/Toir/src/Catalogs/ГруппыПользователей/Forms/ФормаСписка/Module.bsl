...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.РежимВыбора Тогда
		...
		Если Параметры.ЗакрыватьПриВыборе = Ложь Тогда
			// Режим подбора.
			Заголовок = НСтр("es='La selección de los grupos de los usuarios';ru='Подбор групп пользователей';en='User group selection'");
			Элементы.Список.МножественныйВыбор = Истина;
			Элементы.Список.РежимВыделения = РежимВыделенияТаблицы.Множественный;
		Иначе
			Заголовок = НСтр("es='La elección del grupo de los usuarios';ru='Выбор группы пользователей';en='User Group Selection'");
		КонецЕсли;
