...
Процедура ЗагрузитьПрофильКлючевыхОпераций(Команда)
	...
	ПараметрыЗагрузки.Диалог.Заголовок = НСтр("es='Escojan el fichero del perfil de las operaciones claves';ru='Выберите файл профиля ключевых операций';en='Select key operations profile file'");
