...
Функция СуществующийЭлемент()
	...
	Если Выборка.Следующий() Тогда
		Результат = Новый Структура("ОписаниеОшибки", 
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='Con el código %1 hay ya un país %2. Cambien el código o usen ya los datos existentes.';ru='С кодом %1 уже существует страна %2. Измените код или используйте уже существующие данные.';en='Country code%2 already exists with code%1. Change the code or use existing data.'"),
