	...
	Если Не РежимВыбора Тогда
		...
		Если СтраныНетВСпискеСтран(Страна.Наименование) Тогда
			ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='¿Añadir el país ""%1"" del clasificador en la lista de los países del mundo?';ru='Добавить страну ""%1"" из классификатора в список стран мира?';en='Add country ""%1"" from the classifier to the list of countries in the world?'"),
				Страна.Наименование);
