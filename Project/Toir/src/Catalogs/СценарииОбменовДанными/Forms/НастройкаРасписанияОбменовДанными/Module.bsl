...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("es='Los guiones de la sincronización de los datos para: [УзелИнформационнойБазы]';ru='Сценарии синхронизации данных для: [УзелИнформационнойБазы]';en='Data synchronization scenarios for: [Information Base Node]'");
...
Процедура ВыполнитьСценарий(Команда)
	...
	Если Отказ Тогда
		Сообщение = НСтр("es='El guión de la sincronización es cumplido con las faltas.';ru='Сценарий синхронизации выполнен с ошибками.';en='The synchronization scenarios failed.'");
		Картинка = БиблиотекаКартинок.Ошибка32;
	Иначе
		Сообщение = НСтр("es='El guión de la sincronización es con éxito cumplido.';ru='Сценарий синхронизации успешно выполнен.';en='The synchronization scenarios completed successfully.'");
