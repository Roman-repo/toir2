...
Процедура УдалитьРегламентноеЗадание(Отказ)
	...
	Если РегламентноеЗаданиеОбъект <> Неопределено Тогда
		...
		Исключение
			СтрокаСообщения = НСтр("es='La falta a la desaparición de la tarea de reglamento: %1';ru='Ошибка при удалении регламентного задания: %1';en='Error deleting scheduled job:%1'");
