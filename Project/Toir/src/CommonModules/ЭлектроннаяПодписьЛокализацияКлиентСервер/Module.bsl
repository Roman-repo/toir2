...
Функция ПредставленияСвойствСубъектаСертификата() Экспорт
	...
	ПредставленияСвойств["Должность"] = НСтр("es='El puesto';ru='Должность';en='Position'");
	ПредставленияСвойств["ОГРН"] = НСтр("es='ОГРН';ru='ОГРН';en='PSRN '");
	ПредставленияСвойств["ОГРНИП"] = НСтр("es='ОГРНИП';ru='ОГРНИП';en='PSRNIP'");
	ПредставленияСвойств["СНИЛС"] = НСтр("es='СНИЛС';ru='СНИЛС';en='SNILS'");
	ПредставленияСвойств["ИНН"] = НСтр("es='EL INN';ru='ИНН';en='TIN'");
	ПредставленияСвойств["Фамилия"] = НСтр("es='El apellido';ru='Фамилия';en='Surname'");
	ПредставленияСвойств["Имя"] = НСтр("es='El nombre';ru='Имя';en='Name'");
	ПредставленияСвойств["Отчество"] = НСтр("es='El nombre patronímico';ru='Отчество';en='Patronymic'");
