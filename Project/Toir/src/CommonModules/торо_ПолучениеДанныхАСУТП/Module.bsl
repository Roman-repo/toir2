...
//
Процедура ГенераторЗаписей(КоличествоЗаписей, МенятьДату = Ложь, НачДата = Неопределено, СмещениеДаты = 300) Экспорт
	...
	Подключение.connectionString = "SERVER="+"10.32.101.34"+
		"; Database = "+"ASU_test"+
		"; DRIVER=SQL Server; UID="+"sa"+
		"; PWD="+"asJKyh62"+";";
	Подключение.Open();
