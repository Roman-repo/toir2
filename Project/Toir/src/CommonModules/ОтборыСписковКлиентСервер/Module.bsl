...
Процедура УстановитьОтборВСпискеПоАктуальности(Список, Актуальность) Экспорт
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, 
		"Просрочен",
		Актуальность = НСтр("es='Es caducado';ru='Просрочен';en='Expired'"),
		ВидСравненияКомпоновкиДанных.Равно,,
		Актуальность = НСтр("es='No es caducado';ru='Не просрочен';en='Not overdue'") ИЛИ Актуальность = НСтр("es='Es caducado';ru='Просрочен';en='Expired'"));
...
Процедура УстановитьОтборВСпискеПоДатеСобытия(Список, ДатаСобытия) Экспорт
	...
	ГруппаОтбора = ОбщегоНазначенияКлиентСервер.СоздатьГруппуЭлементовОтбора(
		...
		НСтр("es='La selección por la fecha del acontecimiento';ru='Отбор по дате события';en='Selection by event date'"), 
...
Процедура ЗаполнитьСписокВыбораОтбораПоАктуальности(СписокВыбораАктуальности) Экспорт
	...
	СписокВыбораАктуальности.Добавить("Не просрочен",     НСтр("es='No es caducado';ru='Не просрочен';en='Not overdue'"));
	СписокВыбораАктуальности.Добавить("Просрочен",        НСтр("es='Es caducado';ru='Просрочен';en='Expired'"));
	СписокВыбораАктуальности.Добавить("Истекает на дату", НСтр("es='Cumple a la fecha...';ru='Истекает на дату...';en='Expires on a date ...'"));
	СписокВыбораАктуальности.Добавить("Сегодня",          НСтр("es='Hoy';ru='Сегодня';en='Today'"));
	СписокВыбораАктуальности.Добавить("Завтра",           НСтр("es='Mañana';ru='Завтра';en='Tomorrow'"));
	СписокВыбораАктуальности.Добавить("Послезавтра",      НСтр("es='Pasado mañana';ru='Послезавтра';en='Day after tomorrow'"));
	СписокВыбораАктуальности.Добавить("Через неделю",     НСтр("es='En una semana';ru='Через неделю';en='In a week'"));
