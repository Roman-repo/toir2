...
//
// Пример:
//  СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='%1 ha ido en %2';ru='%1 пошел в %2';en='%1 went to%2'"), "Вася", "Зоопарк") = "Вася пошел
//  в Зоопарк".
//
...
//  Результат = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтрокуИзМассива(НСтр("es='%1 ha ido en %2';ru='%1 пошел в %2';en='%1 went to%2'"), ЗначенияПараметров);
