...
Процедура ДиалогЗагрузкиФайла(ОповещениеЗавершения , ИмяФайла = "") Экспорт
	...
	ПараметрыЗагрузки.Диалог.Фильтр = НСтр("es='Todos los formatos apoyados de los ficheros (*.xls; *.xlsx; *.ods; *.mxl; *.csv) | *.xls; *.xlsx; *.ods; *.mxl; *.csv|Книга Excel 97 (*.xls) | *.xls|Книга Excel 2007 (*.xlsx) | *.xlsx|Электронная la tabla OpenDocument (*.ods) | *.ods|Текстовый el documento c разделителями (*.csv) | *.csv|Табличный el documento (*.mxl) | *.mxl';ru='Все поддерживаемые форматы файлов(*.xls;*.xlsx;*.ods;*.mxl;*.csv)|*.xls;*.xlsx;*.ods;*.mxl;*.csv|Книга Excel 97 (*.xls)|*.xls|Книга Excel 2007 (*.xlsx)|*.xlsx|Электронная таблица OpenDocument (*.ods)|*.ods|Текстовый документ c разделителями (*.csv)|*.csv|Табличный документ (*.mxl)|*.mxl';en='All supported file formats (*. Xls; *. Xlsx; *. Ods; *. Mxl; *. Csv) | * .xls; *. Xlsx; *. Ods; *. Mxl; *. Csv | Excel 97 ( * .xls) | * .xls | Excel 2007 workbook (* .xlsx) | * .xlsx | OpenDocument spreadsheet (* .ods) | * .ods | Delimited text document (* .csv) | * .csv | Tabular document (* .mxl) | * .mxl'");
