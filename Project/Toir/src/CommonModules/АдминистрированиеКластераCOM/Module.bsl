		...
		Исключение
			Если ОбщегоНазначения.ЭтоWindowsСервер() Тогда 
				ТекстИсключения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='%1 "
""
"Si el componente ""comcntr"" no es registrado o su versión no coincide con exigido, "
"debe registrarla en el ordenador %2 habiendo cumplido la orden cmd con el aumento de los privilegios UAC "
"para la anotación de descuento la SO Windows, en nombre de que se cumple 1С:Предприятие. "
""
"Por ejemplo: "
"regsvr32.exe ""%3""';ru='%1"
""
...
"regsvr32.exe ""%3""';en='%1"
""
"If the component "" comcntr "" is not registered or its version does not match the required one,"
"register it on computer%2 by running cmd with UAC privilege escalation"
"for the Windows OS account on behalf of which 1C: Enterprise is run."
""
"For example:"
"regsvr32.exe ""%3 ""'"),
