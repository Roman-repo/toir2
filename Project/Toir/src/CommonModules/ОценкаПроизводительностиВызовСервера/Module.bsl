...
Функция ЗафиксироватьДлительностьКлючевыхОпераций(ЗамерыДляЗаписи) Экспорт
	...
	Если НаборЗаписей.Количество() > 0 Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("es='No consiguió conservar las mediciones de la productividad';ru='Не удалось сохранить замеры производительности';en='Failed to save performance measurements'", Метаданные.ОсновнойЯзык.КодЯзыка),
	...
	Если НаборЗаписейТехнологический.Количество() > 0 Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("es='No consiguió conservar las mediciones tecnológicas de la productividad';ru='Не удалось сохранить технологические замеры производительности';en='Failed to save process performance measurements'", Метаданные.ОсновнойЯзык.КодЯзыка),
				УровеньЖурналаРегистрации.Ошибка,,,ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
		КонецПопытки;
    КонецЕсли;
