...
//   НоваяСтрока.Наименование = НСтр("es='Como renovar la configuración';ru='Как обновить конфигурацию';en='How to update the configuration'");
//   НоваяСтрока.Ссылка = Справочники.Новости.НайтиПоРеквизиту("УИННовости", "123456"); // Новость должна присутствовать в справочнике!
//   НоваяСтрока = Форма.Новости.Добавить();
//   НоваяСтрока.Наименование = НСтр("es='Como ajustar la autorenovación';ru='Как настроить автообновление';en='How to set up auto-update'");
