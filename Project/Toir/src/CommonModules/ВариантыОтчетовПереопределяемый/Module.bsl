...
//
// Пример:
//	Настройки.Поиск.ПодсказкаВвода = НСтр("es='Por ejemplo, el precio de costa';ru='Например, себестоимость';en='For example, cost'");
...
//
// Пример:
//	Разделы.Добавить(Метаданные.Подсистемы.Анкетирование, НСтр("es='Los informes del sondeo';ru='Отчеты по анкетированию';en='Questionnaire reports'"));
//	Разделы.Добавить(ВариантыОтчетовКлиентСервер.ИдентификаторНачальнойСтраницы(), НСтр("es='Los informes básicos';ru='Основные отчеты';en='Main reports'"));
//
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.торо_УчетПоказателейЭксплуатации,"Учет показателей эксплуатации");
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.гкс_СостояниеОборудования);
