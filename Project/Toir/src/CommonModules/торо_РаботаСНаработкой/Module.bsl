...
Функция ПолучитьСтруктуруДанныхДокументаСинхронизации(МассивСтрокНаработки,Ссылка,Дата=Неопределено) Экспорт
	...
	Для Каждого СтрокаНаработки Из МассивСтрокНаработки Цикл
		...
		ТаблицаИерархииОРтек = торо_РаботаСИерархией20.ПолучитьТаблицуИерархии(СтрокаНаработки.Иерархия,Дата);
...
Функция ОбновитьНаработку(ОбъектРемонта, ТиповойОР) Экспорт
...
Функция ПолучитьСписокРодителейТиповогоОбъекта(знач Ссылка) Экспорт
