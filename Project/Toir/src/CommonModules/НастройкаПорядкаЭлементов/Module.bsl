...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	Вид.Заголовок   = НСтр("es='El ajuste aproximadamente los elementos';ru='Настройка порядка элементов';en='Setting the order of elements'");
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Команда.Представление = НСтр("es='Trasladar el elemento hacia arriba';ru='Переместить элемент вверх';en='Move item up'");
	Команда.Порядок = 1;
	...
	Команда.Представление = НСтр("es='Trasladar el elemento hacia abajo';ru='Переместить элемент вниз';en='Move item down'");
	Команда.Порядок = 2;
