	...
	Если МетаданныеСправочника.ТабличныеЧасти.Найти("ДополнительныеРеквизиты") <> Неопределено Тогда
		...
		Для каждого Свойство Из Свойства Цикл
			Если НЕ Свойство.ЭтоДополнительноеСведение Тогда
				...
				СтрокаИнфоПроКолонки.Группа = НСтр("es='Доп. Los requisitos';ru='Доп. реквизиты';en='Add. requisites'");
				...
				Если Значения.Количество() > 0 Тогда
					СтрокаИнфоПроКолонки.Примечание = СтрокаИнфоПроКолонки.Примечание  + Символы.ПС + НСтр("es='Las variantes de los significados:';ru='Варианты значений:';en='Value options:'") + Символы.ПС;
		...
		Для каждого Свойство Из ДополнительныеСведения Цикл
			...
			СтрокаИнфоПроКолонки.ОбязательнаДляЗаполнения = Свойство.ЗаполнятьОбязательно;
			СтрокаИнфоПроКолонки.Позиция = Позиция;
			СтрокаИнфоПроКолонки.Группа = НСтр("es='Доп. Las propiedades';ru='Доп. свойства';en='Add. the properties'");
			СтрокаИнфоПроКолонки.Видимость = Истина;
			СтрокаИнфоПроКолонки.Примечание = Свойство.Наименование;
			СтрокаИнфоПроКолонки.Ширина = 30;
			Позиция = Позиция + 1;
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("es='La reestructuración de los requisitos adicionales y las noticias. "
"Es posible el trabajo incorrecto de las selecciones de los requisitos adicionales y las noticias en las listas.';ru='Реструктуризация дополнительных реквизитов и сведений."
"Возможна некорректная работа отборов по дополнительным реквизитам и сведениям в списках.';en='Restructuring of additional details and information."
"The selections on additional details and information in the lists may be incorrect.'");
	...
	Обработчик.Комментарий = НСтр("es='Rellena el nombre único de los requisitos adicionales y las noticias. "
"La redacción de los requisitos adicionales y las noticias será inaccesible antes de la terminación de la renovación.';ru='Заполняет уникальное имя дополнительных реквизитов и сведений."
"Редактирование дополнительных реквизитов и сведений будет недоступно до завершения обновления.';en='Fills in the unique name of additional details and information."
"Editing additional details and information will not be available until the update is completed.'");
	Обработчик.РежимВыполнения = "Отложенно";
	...
	Обработчик.Комментарий = НСтр("es='La reestructuración de los requisitos adicionales y las noticias. "
"Antes de la terminación del tratamiento los requisitos adicionales y las noticias de algunos documentos "
"y las guías serán inaccesibles.';ru='Реструктуризация дополнительных реквизитов и сведений."
"До завершения обработки дополнительные реквизиты и сведения некоторых документов"
"и справочников будут недоступны.';en='Restructuring of additional details and information."
"Until the processing is completed, additional details and information of some documents"
"and directories will not be available. '");
...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	ВидДоступа.Представление = НСтр("es='Las noticias adicionales';ru='Дополнительные сведения';en='additional information'");
