...
Процедура ОповеститьОтложенныеОбработчикиНеВыполнены() Экспорт
	...
	ПоказатьОповещениеПользователя(
		НСтр("es='El trabajo en el programa es temporalmente limitado';ru='Работа в программе временно ограничена';en='Work in the program is temporarily limited.'"),
		НавигационнаяСсылкаОбработки(),
		НСтр("es='versión';ru='Не завершен переход на новую версию';en='Switching to the new version is not completed'"),
