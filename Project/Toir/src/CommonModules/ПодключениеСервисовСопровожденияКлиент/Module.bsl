...
Процедура ПодключитьТестовыйПериод(
	...
	Состояние(, , НСтр("es='La recepción de la información sobre los períodos accesibles de test';ru='Получение информации о доступных тестовых периодах';en='Getting information about available trial periods'"));
...
Процедура ПроверитьСостояниеЗапроса() Экспорт
	...
	Для Каждого ОписательОповещения Из ДанныеОповещений.Оповещения Цикл
		...
		ПоказатьОповещениеПользователя(
			НСтр("es='La conexión del período de test';ru='Подключение тестового периода';en='Test period connection'"),
