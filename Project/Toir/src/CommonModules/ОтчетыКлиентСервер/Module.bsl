...
//               //	Команда.Заголовок = НСтр("es='<la Representación de la orden...>';ru='<Представление команды...>';en='<Представление команды...>'");
...
Функция ПредставлениеЭлементаУсловногоОформления(ЭлементКД, НастройкаВариантаКД, Состояние) Экспорт
	...
	Если ПредставлениеОформления = "" Тогда
		ПредставлениеОформления = НСтр("es='No formalizar';ru='Не оформлять';en='Do not draw up'");
	КонецЕсли;
	...
	Если ПредставлениеПолей = "" Тогда
		ПредставлениеПолей = НСтр("es='Todos los campos';ru='Все поля';en='All fields'");
	Иначе
		ПредставлениеПолей = НСтр("es='Campos:';ru='Поля:';en='Fields:'") + " " + ПредставлениеПолей;
	КонецЕсли;
	...
	Иначе
		Разделитель = "; ";
		ПредставлениеОтбора = НСтр("es='La condición:';ru='Условие:';en='Condition:'") + " " + ПредставлениеОтбора;
	КонецЕсли;
...
Функция ПредставлениеЦвета(Цвет)
	...
	ИначеЕсли Цвет.Вид = ВидЦвета.Абсолютный Тогда
		...
		Если Представление = "0, 0, 0" Тогда
			Представление = НСтр("es='Negro';ru='Черный';en='Black'");
		ИначеЕсли Представление = "255, 255, 255" Тогда
			Представление = НСтр("es='Blanco';ru='Белый';en='White'");
		КонецЕсли;
	ИначеЕсли Цвет.Вид = ВидЦвета.АвтоЦвет Тогда
		Представление = НСтр("es='Авто';ru='Авто';en='Auto'");
	Иначе
		Представление = "";
	КонецЕсли;
	Возврат Представление;
	...
	Для Каждого ЭлементКД Из НаборСтрокКД Цикл
		...
		ИначеЕсли ТипЗнч(ЭлементКД) = Тип("ЭлементОтбораКомпоновкиДанных") Тогда
			...
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.ВИерархии Тогда
				ПредставлениеУсловия = НСтр("es='En el grupo';ru='В группе';en='In group'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.НеВИерархии Тогда
				ПредставлениеУсловия = НСтр("es='No en el grupo';ru='Не в группе';en='Not in group'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСписке Тогда
				ПредставлениеУсловия = НСтр("es='En la lista';ru='В списке';en='In the list'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.НеВСписке Тогда
				ПредставлениеУсловия = НСтр("es='No en la lista';ru='Не в списке';en='Not listed'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.ВСпискеПоИерархии Тогда
				ПредставлениеУсловия = НСтр("es='En la lista incluso subordinado';ru='В списке включая подчиненные';en='In the list including subordinates'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.НеВСпискеПоИерархии Тогда
				ПредставлениеУсловия = НСтр("es='No en la lista incluso subordinado';ru='Не в списке включая подчиненные';en='Not on the list including subordinates'");
			
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.Содержит Тогда
				ПредставлениеУсловия = НСтр("en='contain';es='Contiene';ru='Содержит'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.НеСодержит Тогда
				ПредставлениеУсловия = НСтр("es='No contiene';ru='Не содержит';en='Does not contain'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.Подобно Тогда
				ПредставлениеУсловия = НСтр("es='Corresponde al modelo';ru='Соответствует шаблону';en='Matches pattern'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.НеПодобно Тогда
				ПредставлениеУсловия = НСтр("es='No corresponde al modelo';ru='Не соответствует шаблону';en='Does not match the pattern'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.НачинаетсяС Тогда
				ПредставлениеУсловия = НСтр("es='Comienza con';ru='Начинается с';en='Begin with'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.НеНачинаетсяС Тогда
				ПредставлениеУсловия = НСтр("es='No comienza con';ru='Не начинается с';en='Does not start with'");
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.Заполнено Тогда
				ПредставлениеУсловия = НСтр("es='Es rellenado';ru='Заполнено';en='Filled out'");
				ПредставлениеЗначения = "";
			ИначеЕсли ЭлементКД.ВидСравнения = ВидСравненияКомпоновкиДанных.НеЗаполнено Тогда
				ПредставлениеУсловия = НСтр("es='No es rellenado';ru='Не заполнено';en='Not completed'");
				ПредставлениеЗначения = "";
			КонецЕсли;
...
Функция ПараметрыКопирования(ТипЭлемента, Коллекция)
	...
	ИначеЕсли ТипЭлемента <> Тип("ДанныеФормыЭлементДерева") Тогда 
		...
		ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("es='La copia de los elementos ""%1"" no es apoyada';ru='Копирование элементов ""%1"" не поддерживается';en=""Copying items '%1' is not supported"""), ТипЭлемента);
