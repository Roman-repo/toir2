...
Процедура ПроверитьСсылкиНаОбъект(Знач ОбработкаПродолжения, Знач МассивСсылок, Знач СинонимыРеквизитов) Экспорт
	...
	ЗаголовокДиалога = НСтр("es='El permiso de la redacción de los requisitos';ru='Разрешение редактирования реквизитов';en='Permission to edit details'");
...
"los requisitos siguientes no son accesible para la redacción: "
"%1. "
""
"Antes de que permitir su redacción, se recomienda estimar las consecuencias, "
"habiendo comprobado todos los lugares del uso de este elemento en el programa. "
"La búsqueda de los lugares del uso puede ocupar el tiempo largo.';ru='Для того чтобы не допустить рассогласования данных в программе,"
...
"Поиск мест использования может занять длительное время.';en='In order to prevent data inconsistencies in the program,"
"The following details are not editable:"
"%1."
""
"Before allowing them to be edited, it’s recommended that you evaluate the consequences,"
"checking all places of use of this element in the program."
"Finding places to use can take a long time.'"),
			РеквизитыПредставление);
	Иначе
...
""
"Antes de que permitir su redacción, se recomienda estimar las consecuencias, "
"habiendo comprobado todos los lugares del uso ""%2"" en el programa. "
"La búsqueda de los lugares del uso puede ocupar el tiempo largo.';ru='Для того чтобы не допустить рассогласования данных в программе,"
...
"checking all places of use ""%2 "" in the program."
"Finding places to use can take a long time.'"),
...
""
"Antes de que permitir su redacción, se recomienda estimar las consecuencias, "
"habiendo comprobado todos los lugares del uso de los elementos escogidos (%2) en el programa. "
"La búsqueda de los lugares del uso puede ocupar el tiempo largo.';ru='Для того чтобы не допустить рассогласования данных в программе,"
"реквизит %1 не доступен для редактирования."
""
"Перед тем, как разрешить его редактирование, рекомендуется оценить последствия,"
...
""
"Before allowing its editing, it is recommended to evaluate the consequences,"
"checking all places of use of the selected elements (%2) in the program."
"Finding places to use can take a long time.'"),
	...
	Кнопки.Добавить(КодВозвратаДиалога.Да, НСтр("es='Comprobar y permitir';ru='Проверить и разрешить';en='Check and allow'"));
...
Процедура ПоказатьПредупреждениеВсеВидимыеРеквизитыРазблокированы(ОбработкаПродолжения = Неопределено) Экспорт
	...
	ПоказатьПредупреждение(ОбработкаПродолжения,
		НСтр("es='La redacción de todos los requisitos visibles del objeto está permitido ya.';ru='Редактирование всех видимых реквизитов объекта уже разрешено.';en='Editing all visible details of an object is already allowed.'"));
