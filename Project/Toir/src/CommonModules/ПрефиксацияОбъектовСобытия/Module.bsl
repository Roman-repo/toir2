...
Функция РеквизитОрганизацияДоступен(Объект)
	...
	Если   (ОбщегоНазначения.ЭтоСправочник(МетаданныеОбъекта)
		...
		Если РеквизитОрганизация = Неопределено Тогда
			...
			СтрокаСообщения = НСтр("es='Para el objeto de los metadatos %1 no es determinado el requisito con el nombre %2.';ru='Для объекта метаданных %1 не определен реквизит с именем %2.';en='For metadata object%1, no attribute with the name%2 is defined.'");
