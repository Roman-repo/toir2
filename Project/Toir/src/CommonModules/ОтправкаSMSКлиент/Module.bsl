...
Процедура ПроверитьНаличиеНастроекДляОтправкиSMS(ОбработчикРезультата)
	...
	Иначе
		...
		Иначе
			ТекстСообщения = НСтр("es='Para el envío SMS es necesario hacer el ajuste de los parámetros de la conexión "
"se Dirijan al administrador.';ru='Для отправки SMS требуется произвести настройку параметров подключения"
"Обратитесь к администратору.';en='To send SMS, you need to configure the connection settings"
