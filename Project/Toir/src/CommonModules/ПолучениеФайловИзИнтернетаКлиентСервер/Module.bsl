...
#Если ВебКлиент Тогда
	ВызватьИсключение НСтр("es='Прокси no es accesible en el cliente web.';ru='Прокси не доступен в веб-клиенте.';en='A proxy is not available in the web client.'");
#Иначе
...
#Если ВебКлиент Тогда
	...
	Результат.Вставить("Представление", НСтр("es='Прокси no es accesible en el cliente web.';ru='Прокси не доступен в веб-клиенте.';en='A proxy is not available in the web client.'"));
	Возврат Результат;
