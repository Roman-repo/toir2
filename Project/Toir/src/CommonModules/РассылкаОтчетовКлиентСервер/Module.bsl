...
Функция ПредставлениеСпособовДоставки(ПараметрыДоставки) Экспорт
	Префикс = НСтр("es='El resultado';ru='Результат';en='Result'");
	ТекстПредставления = "";
	Суффикс = "";
	...
	Если Не ПараметрыДоставки.ТолькоУведомить Тогда
		...
		+ ?(ТекстПредставления = "", Префикс, " " + НСтр("es='Y';ru='и';en='and'")) 
		+ " "
		+ НСтр("es='Es enviado por correo (cm. Las inversiones)';ru='отправлен по почте (см. вложения)';en='sent by mail (see attachments)'");
	...
	Если ПараметрыДоставки.ВыполненаВПапку Тогда
		...
		+ ?(ТекстПредставления = "", Префикс, " " + НСтр("es='Y';ru='и';en='and'")) 
		+ " "
		+ НСтр("es='Es llevado a la carpeta';ru='доставлен в папку';en='delivered to folder'")
		+ " ";
	...
	Если ПараметрыДоставки.ВыполненаВСетевойКаталог Тогда
		...
		+ ?(ТекстПредставления = "", Префикс, " " + НСтр("es='Y';ru='и';en='and'")) 
		+ " "
		+ НСтр("es='Es llevado al catálogo de red';ru='доставлен в сетевой каталог';en='delivered to network directory'")
		+ " ";
	...
	Если ПараметрыДоставки.ВыполненаНаFTP Тогда
		...
		+ ?(ТекстПредставления = "", Префикс, " " + НСтр("es='Y';ru='и';en='and'")) 
		+ " "
		+ НСтр("es='Es llevado en FTP el recurso';ru='доставлен на FTP ресурс';en='delivered to FTP resource'")
		+ " ";
