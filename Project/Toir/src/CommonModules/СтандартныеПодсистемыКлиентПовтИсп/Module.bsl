...
Процедура ПроверитьПорядокЗапускаПрограммыПередНачаломРаботыСистемы()
	...
	Если ПараметрыПриложения[ИмяПараметра] = Неопределено Тогда
		ВызватьИсключение
			НСтр("es='La falta aproximadamente el lanzamiento del programa. "
"El primer procedimiento, que se ofrece del elaborador del acontecimiento De PeredNachalomRabotySistemy "
"debe ser el procedimiento БСП СтандартныеПодсистемыКлиент.ПередНачаломРаботыСистемы.';ru='Ошибка порядка запуска программы."
"Первой процедурой, которая вызывается из обработчика события ПередНачаломРаботыСистемы"
"должна быть процедура БСП СтандартныеПодсистемыКлиент.ПередНачаломРаботыСистемы.';en='Error starting the program."
"The first procedure that is called from the event handler ПередНачаломРаботыСистемы should be a BSP procedure СтандартныеПодсистемыКлиент.ПередНачаломРаботыСистемы.'");
	КонецЕсли;
...
Процедура ПроверитьПорядокЗапускаПрограммыПриНачалеРаботыСистемы()
	...
	Если Не СтандартныеПодсистемыКлиент.ЗапускПрограммыЗавершен() Тогда
		ВызватьИсключение
			НСтр("es='La falta aproximadamente el lanzamiento del programa. "
"Ante la recepción de los parámetros del trabajo del cliente el lanzamiento del programa debe ser acabado.';ru='Ошибка порядка запуска программы."
"Перед получением параметров работы клиента запуск программы должен быть завершен.';en='Error starting program."
"Before receiving client operation parameters, the program launch must be completed.'");
	КонецЕсли;
