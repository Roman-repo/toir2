...
Функция ИнициализироватьКомпонентыОбмена(НаправлениеОбмена) Экспорт
	...
	Иначе
		...
		КомпонентыОбмена.Вставить("ЗагруженныеОбъектыДополнительно", Новый Массив);
...
Процедура ПроизвестиЧтениеДанных(КомпонентыОбмена, ТаблицыДляЗагрузки = Неопределено) Экспорт
	...
	Если НЕ КомпонентыОбмена.ФлагОшибки
        ...
        Для Каждого Элемент Из КомпонентыОбмена.ЗагруженныеОбъектыДополнительно Цикл
			КомпонентыОбмена.ЗагруженныеОбъектыСеансаОбмена.Добавить(Элемент); 
		КонецЦикла;
