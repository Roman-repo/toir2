...
Функция СтандартныеИнтервалыОповещения()
	...
	Результат.Добавить(НСтр("es='5 minutos';ru='5 минут';en='5 minutes'"));
	Результат.Добавить(НСтр("es='10 minutos';ru='10 минут';en='10 minutes'"));
	Результат.Добавить(НСтр("es='15 minutos';ru='15 минут';en='15 minutes'"));
	Результат.Добавить(НСтр("es='30 minutos';ru='30 минут';en='30 minutes'"));
	Результат.Добавить(НСтр("es='1 hora';ru='1 час';en='1 hour'"));
	Результат.Добавить(НСтр("es='2 horas';ru='2 часа';en='2 hours'"));
	Результат.Добавить(НСтр("es='4 horas';ru='4 часа';en='4 hours'"));
	Результат.Добавить(НСтр("es='8 horas';ru='8 часов';en='8 hours'"));
	Результат.Добавить(НСтр("es='1 día';ru='1 день';en='1 day'"));
	Результат.Добавить(НСтр("es='2 días';ru='2 дня';en='2 days'"));
	Результат.Добавить(НСтр("es='3 días';ru='3 дня';en='3 days'"));
	Результат.Добавить(НСтр("es='1 semana';ru='1 неделю';en='1 week'"));
	Результат.Добавить(НСтр("es='2 semanas';ru='2 недели';en='2 weeks'"));
...
Функция ПолучитьСтандартныеРасписанияДляНапоминания()
	...
	Результат.Вставить(НСтр("es='Todos los lunes, a las 9:00';ru='по понедельникам, в 9:00';en='on Mondays, at 9:00'"), Расписание);
	...
	Расписание.ДниНедели = ДниНедели;
	Результат.Вставить(НСтр("es='Los viernes, a las 15:00';ru='по пятницам, в 15:00';en='on Fridays, at 15:00'"), Расписание);
	...
	Расписание.ПериодНедель = 1;
	Расписание.ВремяНачала = '00010101090000';
	Результат.Вставить(НСтр("es='Cada día, a las 9:00';ru='каждый день, в 9:00';en='every day at 9:00'"), Расписание);
