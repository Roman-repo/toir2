	...
	Если Наборы.Количество() = 0
	 ИЛИ НЕ ЗначениеЗаполнено(Наборы[0].Значение) Тогда
		...
		ПоказатьПредупреждение(,
			НСтр("es='No consiguió recibir los juegos de los requisitos adicionales del objeto. "
""
"Probablemente cerca del objeto no son rellenados los requisitos necesarios.';ru='Не удалось получить наборы дополнительных реквизитов объекта."
""
"Возможно у объекта не заполнены необходимые реквизиты.';en='Failed to get sets of additional property details."
""
"Perhaps the property has not filled out the necessary details.'"));
