...
Функция СообщенияОбОшибках() Экспорт
	...
	СообщенияОбОшибках.Вставить(8,  НСтр("es='Es indicado el nombre del fichero para la descarga de los datos';ru='Некорректно указано имя файла для выгрузки данных';en='Incorrect file name for uploading data'"));
	...
	СообщенияОбОшибках.Вставить(13, НСтр("es='La falta de la recepción del significado de la propiedad del objeto (por nombre de las propiedades de la fuente)';ru='Ошибка получения значения свойства объекта (по имени свойства источника)';en='Error getting the property value of the object (by the name of the source property)'"));
	СообщенияОбОшибках.Вставить(14, НСтр("es='La falta de la recepción del significado de la propiedad del objeto (por nombre de las propiedades del receptor)';ru='Ошибка получения значения свойства объекта (по имени свойства приемника)';en='Error getting the value of an object property (by name of the receiver property)'"));
	
	СообщенияОбОшибках.Вставить(15, НСтр("es='dado (el Nombre del fichero para la carga)';ru='Не указано имя файла для загрузки данных (Имя файла для загрузки)';en='File name to upload data (File name to upload) is not specified. '"));
			
	СообщенияОбОшибках.Вставить(16, НСтр("es='La falta de la recepción del significado de la propiedad del objeto subordinado (por nombre de las propiedades de la fuente)';ru='Ошибка получения значения свойства подчиненного объекта (по имени свойства источника)';en='Error getting the value of the property of the subordinate object (by the name of the source property)'"));
	СообщенияОбОшибках.Вставить(17, НСтр("es='La falta de la recepción del significado de la propiedad del objeto subordinado (por nombre de las propiedades del receptor)';ru='Ошибка получения значения свойства подчиненного объекта (по имени свойства приемника)';en='Error getting the value of the property of the slave object (by the name of the receiver property)'"));
	СообщенияОбОшибках.Вставить(18, НСтр("es='La falta a la creación del tratamiento con el código de los elaboradores';ru='Ошибка при создании обработки с кодом обработчиков';en='Error creating processing with handler code'"));
	СообщенияОбОшибках.Вставить(19, НСтр("es=""La falta en el elaborador del acontecimiento De PeredZagruzkoyOb'ekta"";ru='Ошибка в обработчике события ПередЗагрузкойОбъекта';en='Error in the ПередЗагрузкойОбъекта event handler'"));
	СообщенияОбОшибках.Вставить(20, НСтр("es=""La falta en el elaborador del acontecimiento de PriZagruzkeOb'ekta"";ru='Ошибка в обработчике события ПриЗагрузкеОбъекта';en='Error in the event handler ПриЗагрузкеОбъекта'"));
	СообщенияОбОшибках.Вставить(21, НСтр("es=""La falta en el elaborador del acontecimiento De PosleZagruzkiOb'ekta"";ru='Ошибка в обработчике события ПослеЗагрузкиОбъекта';en='Error in the event handler ПослеЗагрузкиОбъекта'"));
	...
	СообщенияОбОшибках.Вставить(23, НСтр("es='La falta en el elaborador del acontecimiento PosleZagruzkiDannyh (conversión)';ru='Ошибка в обработчике события ПослеЗагрузкиДанных (конвертация)';en='Error in the event handler ПослеЗагрузкиДанных (conversion)'"));
	СообщенияОбОшибках.Вставить(24, НСтр("es='La falta a la desaparición del objeto';ru='Ошибка при удалении объекта';en='Error deleting object'"));
	...
	СообщенияОбОшибках.Вставить(26, НСтр("es='La falta de la anotación del objeto';ru='Ошибка записи объекта';en='Error writing object'"));
	...
	СообщенияОбОшибках.Вставить(28, НСтр("es='La falta en el elaborador del acontecimiento De PosleObrabotkiPravilaOchistki';ru='Ошибка в обработчике события ПослеОбработкиПравилаОчистки';en='Error in the event handler ПослеОбработкиПравилаОчистки'"));
	СообщенияОбОшибках.Вставить(29, НСтр("es=""La falta en el elaborador del acontecimiento De PeredUdaleniemOb'ekta"";ru='Ошибка в обработчике события ПередУдалениемОбъекта';en='Error in the event handler ПередУдалениемОбъекта'"));
	
	СообщенияОбОшибках.Вставить(31, НСтр("es='La falta en el elaborador del acontecimiento De PeredObrabotkoyPravilaVygruzki';ru='Ошибка в обработчике события ПередОбработкойПравилаВыгрузки';en='Error in the ПередОбработкойПравилаВыгрузки event handler'"));
	СообщенияОбОшибках.Вставить(32, НСтр("es='La falta en el elaborador del acontecimiento De PosleObrabotkiPravilaVygruzki';ru='Ошибка в обработчике события ПослеОбработкиПравилаВыгрузки';en='Error in the event handler ПослеОбработкиПравилаВыгрузки'"));
	СообщенияОбОшибках.Вставить(33, НСтр("es=""La falta en el elaborador del acontecimiento De PeredVygruzkoyOb'ekta"";ru='Ошибка в обработчике события ПередВыгрузкойОбъекта';en='Error in the ПередВыгрузкойОбъекта event handler'"));
	СообщенияОбОшибках.Вставить(34, НСтр("es=""La falta en el elaborador del acontecimiento De PosleVygruzkiOb'ekta"";ru='Ошибка в обработчике события ПослеВыгрузкиОбъекта';en='Error in the event handler ПослеВыгрузкиОбъекта'"));
			
	СообщенияОбОшибках.Вставить(41, НСтр("es=""La falta en el elaborador del acontecimiento De PeredVygruzkoyOb'ekta"";ru='Ошибка в обработчике события ПередВыгрузкойОбъекта';en='Error in the ПередВыгрузкойОбъекта event handler'"));
	СообщенияОбОшибках.Вставить(42, НСтр("es=""La falta en el elaborador del acontecimiento de PriVygruzkeOb'ekta"";ru='Ошибка в обработчике события ПриВыгрузкеОбъекта';en='Error in the event handler ПриВыгрузкеОбъекта'"));
	СообщенияОбОшибках.Вставить(43, НСтр("es=""La falta en el elaborador del acontecimiento De PosleVygruzkiOb'ekta"";ru='Ошибка в обработчике события ПослеВыгрузкиОбъекта';en='Error in the event handler ПослеВыгрузкиОбъекта'"));
			
	СообщенияОбОшибках.Вставить(45, НСтр("es='No es encontrada la regla de la conversión de los objetos';ru='Не найдено правило конвертации объектов';en='Object conversion rule not found'"));
	...
	СообщенияОбОшибках.Вставить(49, НСтр("es='La falta en el elaborador del acontecimiento De PosleObrabotkiVygruzki del grupo de las propiedades';ru='Ошибка в обработчике события ПослеОбработкиВыгрузки группы свойств';en='Error in the event handler ПослеОбработкиВыгрузки properties group'"));
	СообщенияОбОшибках.Вставить(50, НСтр("es='La falta en el elaborador del acontecimiento PeredVygruzkoy (el objeto de la colección)';ru='Ошибка в обработчике события ПередВыгрузкой (объекта коллекции)';en='Error in the ПередВыгрузкой event handler (collection object)'"));
	СообщенияОбОшибках.Вставить(51, НСтр("es='La falta en el elaborador del acontecimiento de PriVygruzke (el objeto de la colección)';ru='Ошибка в обработчике события ПриВыгрузке (объекта коллекции)';en='Error in the event handler ПриВыгрузке (collection object)'"));
	СообщенияОбОшибках.Вставить(52, НСтр("es='La falta en el elaborador del acontecimiento De PosleVygruzki (el objeto de la colección)';ru='Ошибка в обработчике события ПослеВыгрузки (объекта коллекции)';en='Error in the event handler ПослеВыгрузки (collection object)'"));
	...
	СообщенияОбОшибках.Вставить(54, НСтр("es=""La falta en el elaborador global del acontecimiento PosleZagruzkiOb'ekta (conversión)"";ru='Ошибка в глобальном обработчике события ПослеЗагрузкиОбъекта (конвертация)';en='Error in the global event handler ПослеЗагрузкиОбъекта (conversion)'"));
	СообщенияОбОшибках.Вставить(55, НСтр("es='La falta en el elaborador del acontecimiento PeredVygruzkoy (propiedades)';ru='Ошибка в обработчике события ПередВыгрузкой (свойства)';en='Error in the ПередВыгрузкой event handler (properties)'"));
	СообщенияОбОшибках.Вставить(56, НСтр("es='La falta en el elaborador del acontecimiento de PriVygruzke (propiedad)';ru='Ошибка в обработчике события ПриВыгрузке (свойства)';en='Error in the event handler ПриВыгрузке (properties)'"));
	...
	СообщенияОбОшибках.Вставить(63, НСтр("es='La falta en el elaborador del acontecimiento PosleVygruzkiDannyh (conversión)';ru='Ошибка в обработчике события ПослеВыгрузкиДанных (конвертация)';en='Error in the event handler ПослеВыгрузкиДанных (conversion)'"));
	СообщенияОбОшибках.Вставить(64, НСтр("es=""La falta en el elaborador global del acontecimiento PeredKonvertatsieyOb'ekta (conversión)"";ru='Ошибка в глобальном обработчике события ПередКонвертациейОбъекта (конвертация)';en='Error in the global event handler ПередКонвертациейОбъекта (conversion)'"));
	СообщенияОбОшибках.Вставить(65, НСтр("es=""La falta en el elaborador global del acontecimiento PeredVygruzkoyOb'ekta (conversión)"";ru='Ошибка в глобальном обработчике события ПередВыгрузкойОбъекта (конвертация)';en='Error in the global event handler ПередВыгрузкойОбъекта  (conversion)'"));
	СообщенияОбОшибках.Вставить(66, НСтр("es='La falta de la recepción de la colección de los objetos subordinados de los datos entrantes';ru='Ошибка получения коллекции подчиненных объектов из входящих данных';en='Error retrieving a collection of subordinate objects from incoming data'"));
	СообщенияОбОшибках.Вставить(67, НСтр("es='La falta de la recepción de la propiedad del objeto subordinado de los datos entrantes';ru='Ошибка получения свойства подчиненного объекта из входящих данных';en='Error getting property of a slave object from incoming data'"));
	СообщенияОбОшибках.Вставить(68, НСтр("es='La falta de la recepción de la propiedad del objeto de los datos entrantes';ru='Ошибка получения свойства объекта из входящих данных';en='Error getting object properties from incoming data'"));
	
	СообщенияОбОшибках.Вставить(69, НСтр("es=""La falta en el elaborador global del acontecimiento PosleVygruzkiOb'ekta (conversión)"";ru='Ошибка в глобальном обработчике события ПослеВыгрузкиОбъекта (конвертация)';en='Error in the global event handler ПослеВыгрузкиОбъекта (conversion)'"));
	
	СообщенияОбОшибках.Вставить(71, НСтр("es='de la Fuente';ru='Не найдено соответствие для значения Источника';en='No match found for Source value'"));
	
	СообщенияОбОшибках.Вставить(72, НСтр("es='La falta a la descarga de los datos para el nudo del plan del cambio';ru='Ошибка при выгрузке данных для узла плана обмена';en='Error while uploading data for exchange plan node'"));
	
	СообщенияОбОшибках.Вставить(73, НСтр("es='La falta en el elaborador del acontecimiento De PosledovatelnostPoleyPoiska';ru='Ошибка в обработчике события ПоследовательностьПолейПоиска';en='Error in the event handler ПоследовательностьПолейПоиска'"));
	СообщенияОбОшибках.Вставить(74, НСтр("es='Es necesario recargar las reglas del cambio para la descarga de los datos.';ru='Необходимо перезагрузить правила обмена для выгрузки данных.';en='Required to reload the exchange rules to upload data.'"));
	
	СообщенияОбОшибках.Вставить(75, НСтр("es='La falta en el elaborador del acontecimiento PosleZagruzkiPravilObmena (conversión)';ru='Ошибка в обработчике события ПослеЗагрузкиПравилОбмена (конвертация)';en='Error in the event handler ПослеЗагрузкиПравилОбмена (conversion)'"));
	СообщенияОбОшибках.Вставить(76, НСтр("es='La falta en el elaborador del acontecimiento PeredOtpravkoyInformatsiiObUdalenii (conversión)';ru='Ошибка в обработчике события ПередОтправкойИнформацииОбУдалении (конвертация)';en='Error in the ПередОтправкойИнформацииОбУдалении event handler (conversion)'"));
...
"Can not flag a predefined item for deletion. Delete mark has not been set for the object.'"));
	//
	СообщенияОбОшибках.Вставить(81, НСтр("es='Ha surgido la colisión de los cambios de los objetos. "
"El objeto de esta base informativa era sustituido por la versión del objeto de la segunda base informativa.';ru='Возникла коллизия изменений объектов."
"Объект этой информационной базы был заменен версией объекта из второй информационной базы.';en='A collision of object changes has occurred."
"The object of this infobase has been replaced by a version of the object from the second infobase.'"));
	//
	СообщенияОбОшибках.Вставить(82, НСтр("es='Ha surgido la colisión de los cambios de los objetos. "
"El objeto de la segunda base informativa no es aceptado. El objeto de esta base informativa no es cambiado.';ru='Возникла коллизия изменений объектов."
"Объект из второй информационной базы не принят. Объект этой информационной базы не изменен.';en='A collision of object changes has occurred."
"An object from the second infobase has not been accepted. The object of this infobase is not modified.'"));
	//
	СообщенияОбОшибках.Вставить(83, НСтр("es='La falta del recurso a la parte tabular del objeto. La parte tabular del objeto no puede ser cambiada.';ru='Ошибка обращения к табличной части объекта. Табличная часть объекта не может быть изменена.';en='Error accessing the tabular part of the object. The tabular part of the object cannot be changed.'"));
	СообщенияОбОшибках.Вставить(84, НСтр("es='La colisión de las fechas de la prohibición del cambio.';ru='Коллизия дат запрета изменения.';en='Collision of dates of prohibition of change.'"));
	...
	СообщенияОбОшибках.Вставить(177, НСтр("es=""La falta en el elaborador del acontecimiento PeredPolucheniemIzmenennyhOb'ektov (conversión)"";ru='Ошибка в обработчике события ПередПолучениемИзмененныхОбъектов (конвертация)';en='Error in the ПередПолучениемИзмененныхОбъектов event handler (conversion)'"));
	СообщенияОбОшибках.Вставить(178, НСтр("es='La falta en el elaborador del acontecimiento PoslePolucheniyaInformatsiiObUzlahObmena (conversión)';ru='Ошибка в обработчике события ПослеПолученияИнформацииОбУзлахОбмена (конвертация)';en='Error in the event handler ПослеПолученияИнформацииОбУзлахОбмена (conversion)'"));
...
Функция ПланОбменаАвтономнойРаботы() Экспорт
	...
	Если Результат.Количество() = 0 Тогда
		...
		ВызватьИсключение НСтр("es='El trabajo autónomo en el sistema no es previsto.';ru='Автономная работа в системе не предусмотрена.';en='Autonomous work in the system is not provided.'");
		
	ИначеЕсли Результат.Количество() > 1 Тогда
		
		ВызватьИсключение НСтр("es='Es creado más de un plan del cambio para el trabajo autónomo.';ru='Создано более одного плана обмена для автономной работы.';en='More than one sharing plan for battery life has been created.'");
...
Функция КаталогВременногоХранилищаФайлов(БезопасныйРежим = Неопределено) Экспорт
	...
	Иначе
		...
		Если Не Каталог.Существует() Тогда
			...
			ШаблонСообщения = НСтр("es='El catálogo de los ficheros temporales no existe. "
"Es necesario persuadirse que en los ajustes del programa es dado el significado correcto de parámetro "
"""%1"".';ru='Каталог временных файлов не существует."
"Необходимо убедиться, что в настройках программы задано правильное значение параметра"
"""%1"".';en='The temporary file directory does not exist."
"You must make sure that the correct parameter value is set in the program settings"
"""%1"".'");
