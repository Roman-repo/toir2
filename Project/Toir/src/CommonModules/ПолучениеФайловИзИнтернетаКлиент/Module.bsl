...
#Если ВебКлиент Тогда
	ВызватьИсключение НСтр("es='Скачивание de los ficheros en el cliente es inaccesible en el trabajo en el cliente web.';ru='Скачивание файлов на клиент недоступно при работе в веб-клиенте.';en='Downloading files to the client is not available when working in the web client.'");
#Иначе
