...
Процедура ПоказатьПредупрежденияПриЗавершенииРаботы() Экспорт
	...
	Пояснение = НСтр("es='Y cumplir las acciones adicionales';ru='и выполнить дополнительные действия';en='and perform additional actions'");
	...
	КонецЕсли;
	ПоказатьОповещениеПользователя(НСтр("es='Presionen para acabar el trabajo';ru='Нажмите, чтобы завершить работу';en='Click to end work'"), 
