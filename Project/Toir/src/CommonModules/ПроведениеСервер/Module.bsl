...
Процедура ПодготовитьНаборыЗаписейКПроведению(Объект, ВыборочноОчищатьРегистры = Истина) Экспорт
	...
	Если РучнаяКорректировка Тогда
		...
		КонецЦикла;
		ТекстСообщения = НСтр("es='Los movimientos del documento son redactados a mano y no pueden ser automáticamente actualizados';ru='Движения документа отредактированы вручную и не могут быть автоматически актуализированы';en='Document movements are manually edited and cannot be automatically updated.'");
