...
Процедура ПроверитьСоответствиеСотрудниковОрганизации(Организация, Сотрудник, Отказ) Экспорт
	...
	Если ГоловнаяОрганизацияСотрудника <> ГоловнаяОрганизация Тогда
		...
		ШаблонСообщения = НСтр("es='El empleado %1 no corresponde a la organización %2.';ru='Сотрудник %1 не соответствует организации %2.';en='Employee%1 does not match organization%2.'");
