	...
	Если (лкСистемнаяИнформация.ТипПлатформы = ТипПлатформы.Windows_x86)
		...
		Исключение
			...
			ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='La falta al uso de Windows Script Host: "
"%1';ru='Ошибка при использовании Windows Script Host:"
"%1';en='Error while using Windows Script Host:"
"%1'"),
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке));
			ИнтернетПоддержкаПользователейВызовСервера.ЗаписатьСообщениеВЖурналРегистрации(
				НСтр("es='БИП:ОблачныйАрхив. El ajuste';ru='БИП:ОблачныйАрхив.Отладка';en='БИП:ОблачныйАрхив.Отладка'"), // ИмяСобытия
				НСтр("es='БИП:ОблачныйАрхив. El ajuste';ru='БИП:ОблачныйАрхив.Отладка';en='БИП:ОблачныйАрхив.Отладка'"), // ИдентификаторШага
