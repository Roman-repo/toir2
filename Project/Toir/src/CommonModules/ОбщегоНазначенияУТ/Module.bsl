...
Функция ПроверитьЗаполнениеРеквизитовОбъекта(Объект, МассивПроверяемыхРеквизитов) Экспорт
	...
	ШаблонОшибкиРеквизита = НСтр("es='Campo ""%ИмяРеквизита del %"" no es rellenado';ru='Поле ""%ИмяРеквизита%"" не заполнено';en='Field ""%ИмяРеквизита%"" is not filled'");
	ШаблонОшибкиТЧ = НСтр("es='No es introducido ni una línea en la lista ""%ИмяРеквизита del %""';ru='Не введено ни одной строки в список ""%ИмяРеквизита%""';en='Not a single line was entered in the list ""%ИмяРеквизита%""'");
	ШаблонОшибкиРеквизитаТЧ = НСтр("es='""';ru='Не заполнена колонка ""%ИмяРеквизита%"" в строке %НомерСтроки% списка ""%ИмяТабличнойЧасти%""';en='The column ""%ИмяРеквизита%"" in the line  %НомерСтроки% of the list  ""%ИмяТабличнойЧасти%"" is not filled'");
...
Функция ПолучитьСписокПользователейПоМассивуРолей(МассивРолей, ПредставлениеТекущегоПользователя = Неопределено) Экспорт
	...
	Если ПредставлениеТекущегоПользователя = Неопределено Тогда
		ПредставлениеТекущегоПользователя = НСтр("es='<Mis documentos>';ru='<Мои документы>';en='<Мои документы>'");
	КонецЕсли;
...
Процедура ПроверитьЗаполнениеКоличества(Объект, ПроверяемыеРеквизиты, Отказ,ПараметрыПроверки = Неопределено) Экспорт
	...
	ШаблонОшибкаКоличества = НСтр("es='""';ru='Не заполнена колонка ""%ПредставлениеКолонки%"" в строке %НомерСтроки% списка ""%ПредставлениеТЧ%""';en='The column ""%ПредставлениеКолонки%"" in the line %НомерСтроки% of the list """"%ПредставлениеТЧ%"" is not filled'");
	ШаблонОшибкаПересчета = НСтр("es='Es descubierta la cantidad de cero al recuento en la unidad del almacenaje en la línea %НомерСтроки del % de la lista ""%ПредставлениеТЧ del %""';ru='Обнаружено нулевое количество при пересчете в единицу хранения в строке %НомерСтроки% списка ""%ПредставлениеТЧ%""';en='Zero quantity was found when converted to storage unit in line %НомерСтроки% of the list ""%ПредставлениеТЧ%""'");
