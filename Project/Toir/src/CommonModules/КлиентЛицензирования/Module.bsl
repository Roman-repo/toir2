	...
	Исключение
		...
		ИнтернетПоддержкаПользователей.ЗаписатьОшибкуВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='No consiguió renovar el significado del parámetro adicional en los ajustes del cliente del licenciamiento. "
"%1';ru='Не удалось обновить значение дополнительного параметра в настройках клиента лицензирования."
"%1';en='Failed to update the value of the additional parameter in the licensing client settings."
"%1'"),
...
Функция ДанныеАутентификацииВУстаревшемБезопасномХранилище()
	...
	Исключение
		...
		ИнтернетПоддержкаПользователей.ЗаписатьОшибкуВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='La falta a la recepción de los datos аутентификации del depósito seguro que ha caducado de los datos. "
"%1';ru='Ошибка при получении данных аутентификации из устаревшего безопасного хранилища данных."
"%1';en='Error retrieving authentication data from an outdated secure data store."
"%1'"),
				ПодробноеПредставлениеОшибки(ИнформацияОбОшибке())));
