...
Процедура ОбработкаЗагрузки(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если (НЕ ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей())
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("es='БИП:Новости. El depósito de los ajustes de las novedades';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: News. News settings repository'"), // ИмяСобытия
			НСтр("es='Las novedades. El depósito de los ajustes de las novedades. ОбработкаЗагрузки. La infracción de los derechos de admisión';ru='Новости. Хранилище настроек новостей. ОбработкаЗагрузки. Нарушение прав доступа';en='News. News settings storage. ОбработкаЗагрузки. Access rights  violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("es='La tentativa de la llamada ХранилищаНастроек.НастройкиНовостей.ОбработкаЗагрузки, cuando es inaccesible el papel de ChtenieNovostey o PolnyePrava y no es incluido el régimen privilegiado.';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаЗагрузки, когда недоступна роль ЧтениеНовостей или ПолныеПрава и не включен привилегированный режим.';en='Attempting to call ХранилищаНастроек.НастройкиНовостей.ОбработкаЗагрузки when the ЧтениеНовостей or ПолныеПраваrole is not available and privileged mode is not enabled.'"), // Комментарий
...
Процедура ОбработкаПолученияОписания(КлючОбъекта, КлючНастроек, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если (НЕ ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей())
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("es='БИП:Новости. El depósito de los ajustes de las novedades';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: News. News settings repository'"), // ИмяСобытия
			НСтр("es='Las novedades. El depósito de los ajustes de las novedades. ОбработкаПолученияОписания. La infracción de los derechos de admisión';ru='Новости. Хранилище настроек новостей. ОбработкаПолученияОписания. Нарушение прав доступа';en='News. News settings storage. ОбработкаПолученияОписания. Access rights violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("es='La tentativa de la llamada ХранилищаНастроек.НастройкиНовостей.ОбработкаПолученияОписания, cuando es inaccesible el papel de ChtenieNovostey o PolnyePrava y no es incluido el régimen privilegiado.';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаПолученияОписания, когда недоступна роль ЧтениеНовостей или ПолныеПрава и не включен привилегированный режим.';en='Attempting to call ХранилищаНастроек.НастройкиНовостей.ОбработкаПолученияОписания, when the ЧтениеНовостей or ПолныеПраваrole is not available and privileged mode is not enabled.'"), // Комментарий
			Истина); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
...
Процедура ОбработкаСохранения(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если (НЕ ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей())
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("es='БИП:Новости. El depósito de los ajustes de las novedades';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: News. News settings repository'"), // ИмяСобытия
			НСтр("es='Las novedades. El depósito de los ajustes de las novedades. ОбработкаСохранения. La infracción de los derechos de admisión';ru='Новости. Хранилище настроек новостей. ОбработкаСохранения. Нарушение прав доступа';en='News. News settings storage. ОбработкаСохранения. Access rights violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("es='La tentativa de la llamada ХранилищаНастроек.НастройкиНовостей.ОбработкаСохранения, cuando es inaccesible el papel de ChtenieNovostey o PolnyePrava y no es incluido el régimen privilegiado.';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаСохранения, когда недоступна роль ЧтениеНовостей или ПолныеПрава и не включен привилегированный режим.';en='Attempting to call ХранилищаНастроек.НастройкиНовостей.ОбработкаСохранения, when the ЧтениеНовостей or ПолныеПраваrole is not available and privileged mode is not enabled.'"), // Комментарий
			Истина); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
		...
		УстановитьПривилегированныйРежим(Истина);
			...
			Исключение
				...
				ТекстСообщения = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("es='No consiguió anotar la constante de NastroykiNovostey. "
"Probablemente, en este momento hay una anotación en la tarea de fondo o en otra sesión. "
"КлючОбъекта: %1 "
"ajustes: "
"%2 "
"Número de la sesión: %3 "
"Número de la unión: %4 "
"Detalles: "
"%5';ru='Не удалось записать константу НастройкиНовостей."
...
"Номер соединения: %4"
"Подробности:"
"%5';en='Failed to write НастройкиНовостей constant."
"Perhaps at this moment the recording is in the background job or in another session."
"КлючОбъекта::%1"
"Settings:"
"%2"
"Session number:%3"
...
"%5'"),
				...
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					НСтр("es='БИП:Новости. El depósito de los ajustes de las novedades';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: News. News settings repository'"), // ИмяСобытия
					НСтр("es='Las novedades. El depósito de los ajustes de las novedades. ОбработкаСохранения. La falta';ru='Новости. Хранилище настроек новостей. ОбработкаСохранения. Ошибка';en='News. News settings storage. ОбработкаСохранения. Error'"), // ИдентификаторШага
	...
	ИначеЕсли КлючОбъекта = "ОтборыПоЛентамНовостейНастроенныеАдминистратором" Тогда
		...
		Иначе
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				...
				, // ОбъектМетаданных
				, // Данные
				НСтр("es='La falta durante la comprobación del juego de las anotaciones del registro de OtboryPoLentamNovosteyObschie (la llave del objeto ОтборыПоЛентамНовостейНастроенныеАдминистратором) - es posible, no son rellenados unos campos.';ru='Ошибка при проверке набора записей регистра ОтборыПоЛентамНовостейОбщие (ключ объекта ОтборыПоЛентамНовостейНастроенныеАдминистратором) - возможно, не заполнены какие-то поля.';en='Error checking register recordset ОтборыПоЛентамНовостейОбщие (object key ОтборыПоЛентамНовостейНастроенныеАдминистратором) - some fields may not be filled.'"), // Комментарий
				ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		КонецЕсли;
		...
		Если ЗаписыватьДанные = Истина Тогда
			...
			Иначе
				ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
					...
					, // ОбъектМетаданных
					, // Данные
					НСтр("es='La falta durante la comprobación del juego de las anotaciones del registro de OtboryPoLentamNovosteyDlyaOblastiDannyh (la llave del objeto de OtboryPoLentamNovosteyDlyaOblastiDannyh) - es posible, no son rellenados unos campos.';ru='Ошибка при проверке набора записей регистра ОтборыПоЛентамНовостейДляОбластиДанных (ключ объекта ОтборыПоЛентамНовостейДляОбластиДанных) - возможно, не заполнены какие-то поля.';en='Error checking register recordset ОтборыПоЛентамНовостейДляОбластиДанных (object key ОтборыПоЛентамНовостейДляОбластиДанных) - some fields may not be filled.'"), // Комментарий
					ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
			КонецЕсли;
		КонецЕсли;
	...
	ИначеЕсли КлючОбъекта = "ОтборыПоЛентамНовостейПользовательские" Тогда
		...
		Иначе
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				...
				, // ОбъектМетаданных
				, // Данные
				НСтр("es='La falta durante la comprobación del juego de las anotaciones del registro Otborypolentamnovosteypolzovatelsky (la llave del objeto Otborypolentamnovosteypolzovatelsky) - es posible, no son rellenados unos campos.';ru='Ошибка при проверке набора записей регистра ОтборыПоЛентамНовостейПользовательские (ключ объекта ОтборыПоЛентамНовостейПользовательские) - возможно, не заполнены какие-то поля.';en='Error checking register recordset ОтборыПоЛентамНовостейПользовательские (object key ОтборыПоЛентамНовостейПользовательские) - some fields may not be filled.'"), // Комментарий
				ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		КонецЕсли;
	...
	ИначеЕсли КлючОбъекта = "ОтключенныеЛентыНовостей" Тогда
		...
		Иначе
			ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
				...
				, // ОбъектМетаданных
				, // Данные
				НСтр("es='La falta durante la comprobación del juego de las anotaciones del registro de OtklyuchennyeLentyNovostey (la llave del objeto de OtklyuchennyeLentyNovostey) - es posible, no son rellenados unos campos.';ru='Ошибка при проверке набора записей регистра ОтключенныеЛентыНовостей (ключ объекта ОтключенныеЛентыНовостей) - возможно, не заполнены какие-то поля.';en='Error checking register recordset ОтключенныеЛентыНовостей (object key ОтключенныеЛентыНовостей) - some fields may not be filled.'"), // Комментарий
				ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
		КонецЕсли;
	...
	ИначеЕсли КлючОбъекта = "ДоступныеЛентыНовостей" Тогда
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			, // ОбъектМетаданных
			, // Данные
			НСтр("es='La falta a la anotación de los ajustes de las novedades. Los ajustes para la llave de DostupnyeLentyNovostey no deben inscribirse. Se puede anotar solamente OtklyuchennyeLentyNovostey.';ru='Ошибка при записи настроек новостей. Настройки для ключа ДоступныеЛентыНовостей не должны записываться. Записывать можно только ОтключенныеЛентыНовостей.';en='Error while writing news settings. Settings for the key ДоступныеЛентыНовостей should not be recorded. You can only record ОтключенныеЛентыНовостей.'"), // Комментарий
			ОбработкаНовостейВызовСервера.ВестиПодробныйЖурналРегистрации()); // ВестиПодробныйЖурналРегистрации
...
Процедура ОбработкаУстановкиОписания(КлючОбъекта, КлючНастроек, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Если (НЕ ОбработкаНовостейПовтИсп.ЕстьРолиЧтенияНовостей())
		...
		ИнтернетПоддержкаПользователей.ЗаписатьСообщениеВЖурналРегистрации(
			НСтр("es='БИП:Новости. El depósito de los ajustes de las novedades';ru='БИП:Новости.Хранилище настроек новостей';en='BIP: News. News settings repository'"), // ИмяСобытия
			НСтр("es='Las novedades. El depósito de los ajustes de las novedades. ОбработкаУстановкиОписания. La infracción de los derechos de admisión';ru='Новости. Хранилище настроек новостей. ОбработкаУстановкиОписания. Нарушение прав доступа';en='News. News settings storage. ОбработкаУстановкиОписания. Access rights violation'"), // ИдентификаторШага
			УровеньЖурналаРегистрации.Ошибка, // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
			, // Данные
			НСтр("es='La tentativa de la llamada ХранилищаНастроек.НастройкиНовостей.ОбработкаУстановкиОписания, cuando es inaccesible el papel de ChtenieNovostey o PolnyePrava y no es incluido el régimen privilegiado.';ru='Попытка вызова ХранилищаНастроек.НастройкиНовостей.ОбработкаУстановкиОписания, когда недоступна роль ЧтениеНовостей или ПолныеПрава и не включен привилегированный режим.';en='Attempting to call ХранилищаНастроек.НастройкиНовостей.ОбработкаУстановкиОписания when the ЧтениеНовостей or ПолныеПраваrole is not available and privileged mode is not enabled.'"), // Комментарий
			Истина); // ВестиПодробныйЖурналРегистрации
		Возврат;
	КонецЕсли;
