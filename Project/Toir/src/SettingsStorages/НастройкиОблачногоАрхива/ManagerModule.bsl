...
Процедура ОбработкаСохранения(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Иначе
		...
		Результат = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("es='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаСохранения: no es encontrada la llave del objeto %1';ru='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаСохранения: не найден ключ объекта %1';en='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаСохранения: object key not found %1'"),
			КлючОбъекта);
...
Процедура ОбработкаЗагрузкиЛокальная(КлючОбъекта, КлючНастроек, Настройки, ОписаниеНастроек, ИмяПользователяИБ)
	...
	Иначе
		...
		Результат = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("es='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаЗагрузки: no es encontrada la llave del objeto %1';ru='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаЗагрузки: не найден ключ объекта %1';en='ХранилищаНастроек.НастройкиОблачногоАрхива.ОбработкаЗагрузки: object key not found %1'"),
			КлючОбъекта);
		ВызватьИсключение Результат;
