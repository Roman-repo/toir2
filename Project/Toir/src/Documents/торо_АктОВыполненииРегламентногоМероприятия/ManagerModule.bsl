...
// Акт о выполнении регламентного мероприятия
	...
	КомандаПечати.Представление = НСтр("es='El acta sobre la ejecución de la medida de reglamento';ru='Акт о выполнении регламентного мероприятия';en='Regulatory implementation act'");
