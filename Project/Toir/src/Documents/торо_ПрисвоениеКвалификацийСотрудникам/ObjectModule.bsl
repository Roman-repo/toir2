...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если КвалификацииСотрудников.Количество() = 0 Тогда
		ТекстСообщения = НСтр("es='En el documento no es rellenada la parte tabular de las calificaciones de los empleados. ¡La realización es imposible!';ru='В документе не заполнена табличная часть квалификаций сотрудников. Проведение невозможно!';en='The document does not fill out the tabular part of employee qualifications. Conducting is impossible!'");
