...
Функция ВыполнитьПроверкиРаспоряжения(Распоряжение, Склад) Экспорт 
	...
	Иначе
		...
		ТекстОшибки = НСтр("es='Para el almacén ""%Склад del %"" la formalización de las órdenes de salida no es necesario. "
"El relleno del documento no es cumplido.';ru='Для склада ""%Склад%"" оформление расходных ордеров не требуется."
"Заполнение документа не выполнено.';en='For the warehouse"" ""% Склад%"" ""execution of expenditure orders is not required."
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("es='El consumo interior de las mercancías';ru='Внутреннее потребление товаров';en='Domestic consumption of goods'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ВнутреннееПотреблениеТоваров") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			НСтр("es='El consumo interior de las mercancías';ru='Внутреннее потребление товаров';en='Domestic consumption of goods'"),
