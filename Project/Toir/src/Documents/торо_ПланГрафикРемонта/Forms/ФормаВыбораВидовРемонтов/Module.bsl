...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не Параметры.Свойство("ДокументППР") Тогда
		ТекстСообщения = НСтр("es='Para la apertura de la forma es necesario indicar el documento el plan-gráfico ППР';ru='Для открытия формы необходимо указать документ план-график ППР';en='To open the form, you must specify the document schedule'");
