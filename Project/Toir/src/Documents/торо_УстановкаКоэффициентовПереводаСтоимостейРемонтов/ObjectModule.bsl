...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если ВидОперации = Перечисления.торо_ВидыДокументаВводНачДанных.ПоОбъектуРемонта Тогда
		Если КоэффициентыПеревода.Количество() = 0 Тогда
			ТекстСообщения = НСтр("es='En el documento no es rellenado ni una parte tabular. ¡La realización es imposible!';ru='В документе не заполнена ни одна табличная часть. Проведение невозможно!';en='No tabular part is filled in the document. Conducting is impossible!'");
