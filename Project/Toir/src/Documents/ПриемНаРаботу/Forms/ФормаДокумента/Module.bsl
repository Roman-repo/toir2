...
Функция УсловияПриемаПоВидуЗанятости(ВидЗанятости)
	...
	Если ВидЗанятости = ПредопределенноеЗначение("Перечисление.ВидыЗанятости.ОсновноеМестоРаботы") Тогда
		...
		Возврат НСтр("es='El lugar básico del trabajo, el pleno empleo';ru='Основное место работы, полная занятость';en='Main work place, full-time'");
		
	Иначе
		
		Возврат НСтр("es='El trabajo a la vez, la semana reducida de trabajo';ru='Работа по совместительству, сокращенная рабочая неделя';en='Part-time work, shortened work week'");
