...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("es='El ingreso de las mercancías y los servicios';ru='Поступление товаров и услуг';en='Receipt of goods and services'");
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПриходнаяНакладная") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			"ПриходнаяНакладная",
			НСтр("es='El ingreso de las mercancías y los servicios';ru='Поступление товаров и услуг';en='Receipt of goods and services'"),
...
Функция СформироватьПечатнуюФормуПриходнойНакладной(МассивОбъектов, ОбъектыПечати)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |			ТОГДА ПРЕДСТАВЛЕНИЕССЫЛКИ(ПоступлениеТоваровУслугТовары.Номенклатура.ЕдиницаИзмерения)
	               |		ИНАЧЕ ПРЕДСТАВЛЕНИЕССЫЛКИ(ПоступлениеТоваровУслугТовары.Упаковка)
	               |	КОНЕЦ КАК ЕдИзм,
	...
	Пока ВыборкаДокумент.Следующий() Цикл
		...
		ОбластьПокупателя.Параметры.Организация = ВыборкаДокумент.Организация;
