...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Запрос.Текст = 
		...
		|	ВТ_ОперацииБезIDТК.Количество КАК Количество,
	...
	Пока Выборка.Следующий() Цикл
		...
		Движение.IDРемонта = Выборка.РемонтыОборудования_ID;
		Движение.IDОперации = Выборка.ID;
		Движение.Операция = Выборка.Операция;
		Движение.IDРодителя = Выборка.ТехКарта_ID;
		Движение.ВидДокумента = Перечисления.торо_ВидДокумента.ПлановыеЗатраты;
		Движение.Процент = 100 * Выборка.Количество ;
	КонецЦикла;
