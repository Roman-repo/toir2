...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если СоставРемонтнойБригады.Количество() = 0 Тогда
		ТекстСообщения = НСтр("es='En el documento no es rellenada la parte tabular de la composición de la brigada de reparación. ¡La realización es imposible!';ru='В документе не заполнена табличная часть состава ремонтной бригады. Проведение невозможно!';en='The document does not fill out the tabular part of the composition of the repair team. Conducting is impossible!'");
