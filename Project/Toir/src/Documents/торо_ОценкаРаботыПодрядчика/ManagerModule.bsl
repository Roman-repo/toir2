...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("es='La apreciación del trabajo del contratista';ru='Оценка работы подрядчика';en='Contractor performance assessment'");
...
Функция ПечатьОценкиКачестваРаботПодрядчика(МассивОбъектов, ПараметрыПечати) 
	...
	Для каждого Объект из МассивОбъектов Цикл
		...
		обЗаголовок.Параметры.Организация = Объект.Организация;
