...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ЗначениеЗаполнено(ДатаНачалаДействия) И ЗначениеЗаполнено(ДатаОкончанияДействия) Тогда
		...
		Если ДатаНачалаДействия > ДатаОкончанияДействия Тогда
			...
			ТекстСообщения = НСтр("es='La fecha de la terminación de la acción del permiso debe ser no menos fechas del comienzo';ru='Дата окончания действия разрешения должна быть не меньше даты начала';en='The expiration date of the permit must not be less than the start date'");
	...
	ПроверитьДублиНабора("Материалы", НСтр("es='Es descubierta la duplicación de las líneas en el juego de los materiales sustituidos.';ru='Обнаружено дублирование строк в наборе заменяемых материалов.';en='Duplicate lines found in a set of replaceable materials.'"), Отказ);
	
	ПроверитьДублиНабора("Аналоги", НСтр("es='Es descubierta la duplicación de las líneas en el juego de los análogos.';ru='Обнаружено дублирование строк в наборе аналогов.';en='Duplicate lines found in a set of analogues.'"), Отказ);
