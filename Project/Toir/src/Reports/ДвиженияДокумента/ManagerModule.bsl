...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта_Горизонталь.Описание = НСтр("es='La instalación horizontal de las columnas con las medidas, los recursos y los requisitos de los registros.';ru='Горизонтальное размещение колонок с измерениями, ресурсами и реквизитами регистров.';en='Horizontal placement of columns with measurements, resources and register details.'");
	НастройкиВарианта_Горизонталь.НастройкиДляПоиска.КлючевыеСлова = НСтр("es='Los movimientos del documento';ru='Движения документа';en='Document movements'");
	
	НастройкиВарианта_Вертикаль = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Дополнительный");
	НастройкиВарианта_Вертикаль.Описание = НСтр("es='La instalación vertical de las columnas con las medidas, los recursos y los requisitos permite disponer los datos es más compacto, para la presentación de los registros con una gran cantidad de las columnas.';ru='Вертикальное размещение колонок с измерениями, ресурсами и реквизитами позволяет расположить данные более компактно, для просмотра регистров с большим количеством колонок.';en='Vertical arrangement of columns with measurements, resources and details allows arranging data more compactly for viewing registers with a large number of columns.'");
	НастройкиВарианта_Вертикаль.НастройкиДляПоиска.КлючевыеСлова = НСтр("es='Los movimientos del documento';ru='Движения документа';en='Document movements'");
...
Функция ДобавитьКомандуОтчетОДвиженияхДокумента(КомандыОтчетов, Параметры, ДокументыСОтчетомОДвижениях = Неопределено) Экспорт
	...
	Команда.Представление      = НСтр("es='Los movimientos del documento';ru='Движения документа';en='Document movements'");
