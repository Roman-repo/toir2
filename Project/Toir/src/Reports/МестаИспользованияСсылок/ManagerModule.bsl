...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("es='La búsqueda de los lugares del uso de los objetos de la aplicación.';ru='Поиск мест использования объектов приложения.';en='Search for places to use application objects.'");
КонецПроцедуры
...
Функция ДобавитьКомандуМестаИспользования(КомандыОтчетов) Экспорт
	...
	Команда.Представление      = НСтр("es='Los lugares del uso';ru='Места использования';en='Places of use'");
