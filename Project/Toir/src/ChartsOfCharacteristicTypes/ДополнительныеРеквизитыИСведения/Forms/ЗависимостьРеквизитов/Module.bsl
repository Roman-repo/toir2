...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("es='%1 requisitos adicionales ""%2""';ru='%1 дополнительного реквизита ""%2""';en='%1 extra requisite ""%2""'");
	Если НастраиваемоеСвойство = "Доступен" Тогда
		ПредставлениеСвойства = НСтр("es='La accesibilidad';ru='Доступность';en='Availability'");
	ИначеЕсли НастраиваемоеСвойство = "ЗаполнятьОбязательно" Тогда
		ПредставлениеСвойства = НСтр("es='La necesidad del relleno';ru='Обязательность заполнения';en='Mandatory Filling'");
	Иначе
		ПредставлениеСвойства = НСтр("es='La visibilidad';ru='Видимость';en='Visibility'");
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='No es igual';ru='Не равно';en='Not equal'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='No es rellenado';ru='Не заполнено';en='Not completed'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='En la lista';ru='В списке';en='In the list'"));
	...
	ЭлементУсловногоОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='No en la lista';ru='Не в списке';en='Not listed'"));
