...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ЭтоДополнительноеСведение Тогда
		...
		Заголовок = НСтр("es='Cambiar el ajuste de la noticia adicional';ru='Изменить настройку дополнительного сведения';en='Change advanced information setting'");
	Иначе
...
Функция ЗаписатьНаСервере()
	...
	НаименованиеЗадания = НСтр("es='El cambio del ajuste de la propiedad adicional';ru='Изменение настройки дополнительного свойства';en='Change advanced property setting'");
