...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.ВыборОбщегоСвойства Тогда
		...
		Если ЭтоДополнительноеСведение = Истина Тогда
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("es='La elección de la noticia general adicional';ru='Выбор общего дополнительного сведения';en='Select General General Information'");
		ИначеЕсли ЭтоДополнительноеСведение = Ложь Тогда
			АвтоЗаголовок = Ложь;
			Заголовок = НСтр("es='La elección del requisito general adicional';ru='Выбор общего дополнительного реквизита';en='Choice of the general additional requisite'");
		КонецЕсли;
	...
	ИначеЕсли Параметры.ВыборВладельцаДополнительныхЗначений Тогда
		...
		АвтоЗаголовок = Ложь;
		Заголовок = НСтр("es='La elección del modelo';ru='Выбор образца';en='Sample selection'");
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(
		...
		НСтр("es='Generales (para algunos juegos)';ru='Общие (для нескольких наборов)';en='General (for multiple sets)'"),
		Истина);
