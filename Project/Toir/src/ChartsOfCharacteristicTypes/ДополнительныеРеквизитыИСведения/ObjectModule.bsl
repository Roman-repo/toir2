...
#Иначе
ВызватьИсключение НСтр("en='Inadmissible call of an object on the client.';es='La llamada inadmisible del objeto sobre el cliente.';ru='Недопустимый вызов объекта на клиенте.'");
#КонецЕсли