...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если СравниваемыеВерсии.Количество() > 1 Тогда
		...
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='La comparación de las versiones ""%1"" (№№ %2)';ru='Сравнение версий ""%1"" (№№ %2)';en='Compare versions of ""%1"" (No.%2)'"),
			ОбщегоНазначения.ПредметСтрокой(СсылкаНаОбъект), СтрокаНомераВерсий);
	Иначе
		Заголовок = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("es='La versión del objeto ""%1"" № %2';ru='Версия объекта ""%1"" №%2';en='Version of the object ""%1"" No.%2'"),
...
Процедура ОткрытьФормуСравненияТабличныхДокументов(ИмяТабличногоДокумента, Версия0, Версия1)
	...
	ЗаголовокШаблон = НСтр("es='La versión № %1';ru='Версия №%1';en='Version №%1'");
