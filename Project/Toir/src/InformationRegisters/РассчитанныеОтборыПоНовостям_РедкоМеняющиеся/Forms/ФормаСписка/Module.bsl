...
Процедура УстановитьУсловноеОформление()
	...
	// 1. Версия платформы, скрыта
		...
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='Es escondida';ru='Скрыта';en='Hidden'"));
	...
	// 2. Версия платформы, видна
		...
		// Оформление
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='Es visible';ru='Видна';en='Видна'"));
	...
	// 3. Версия платформы, отбор не настроен - видна
		...
		// Оформление
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='La selección no es ajustado, visible';ru='Отбор не настроен, видна';en='Selection not configured, visible'"));
