	...
	Для каждого Строка Из Таблица Цикл
		...
		Если ОбъектМетаданных = Неопределено Тогда
			ВызватьИсключение СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("es='La falta en el procedimiento de PriZapolneniiZavisimosteyPravDostupa "
"del módulo UpravlenieDostupomPereopredelyaemyy general. "
""
"No es encontrada tabla subordinada ""%1"".';ru='Ошибка в процедуре ПриЗаполненииЗависимостейПравДоступа"
"общего модуля УправлениеДоступомПереопределяемый."
""
"Не найдена подчиненная таблица ""%1"".';en=""Error in procedure ПриЗаполненииЗависимостейПравДоступа of general module УправлениеДоступомПереопределяемый. The master table '%1' was not found."""),
...
"del módulo UpravlenieDostupomPereopredelyaemyy general. "
""
"No es encontrada tabla principal ""%1"".';ru='Ошибка в процедуре ПриЗаполненииЗависимостейПравДоступа"
"общего модуля УправлениеДоступомПереопределяемый."
""
"Не найдена ведущая таблица ""%1"".';en=""Error in procedure ПриЗаполненииЗависимостейПравДоступа of general module УправлениеДоступомПереопределяемый. The master table '%1' was not found."""),
