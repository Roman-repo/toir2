...
Функция ВозможенЗапросРазрешенийНаИспользованиеВнешнихРесурсов()
	...
	Иначе
		...
		Если Не Пользователи.ЭтоПолноправныйПользователь() Тогда
			...
			ВызватьИсключение НСтр("es='No basta los derechos de admisión para la interpelación de los permisos por el uso de los recursos exteriores.';ru='Недостаточно прав доступа для запроса разрешений на использование внешних ресурсов.';en='There are not enough access rights to request permissions to use external resources.'");
