...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.КакОткрывать.СписокВыбора.Добавить(0, НСтр("es='Para la presentación';ru='Для просмотра';en='To view'"));
		Элементы.КакОткрывать.СписокВыбора.Добавить(1, НСтр("es='Para la redacción';ru='Для редактирования';en='For editing'"));
