...
Процедура ОбновитьВсеТиповыеПравила(Команда)
	...
	ПоказатьОповещениеПользователя(НСтр("es='La renovación de las reglas es con éxito acabada.';ru='Обновление правил успешно завершено.';en='Rules update completed successfully.'"));
