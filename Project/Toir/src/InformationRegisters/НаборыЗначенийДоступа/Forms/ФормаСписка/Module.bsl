...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='La comprobación del derecho la Lectura';ru='Проверка права Чтение';en='Rights check Read'"));
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='La comprobación del derecho el Cambio';ru='Проверка права Изменение';en='Rights check Change'"));
