...
Процедура УстановитьУсловноеОформление()
	...
	ЭлементОформления.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("es='Para todas las tablas, excepto indicado';ru='Для всех таблиц, кроме указанных';en='For all tables except specified'"));
