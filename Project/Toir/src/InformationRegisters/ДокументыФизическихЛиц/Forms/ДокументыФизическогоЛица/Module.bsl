...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Физлицо") Тогда
		...
		Если Не ЕстьУдостоверение И ЕстьДокументы Тогда
			...
			ТекстСообщения = НСтр("es='Para la persona física %1 no es dado el documento que certifica la persona.';ru='Для физлица %1 не задан документ, удостоверяющий личность.';en='An identity document was not set for individual %1.'");
