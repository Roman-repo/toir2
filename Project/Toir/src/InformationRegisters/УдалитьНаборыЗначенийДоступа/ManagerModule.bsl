...
Функция ПереместитьДанныеВНовыйРегистр() Экспорт
	...
	Если Выборка.Количество() < 10000 Тогда
		...
		ЗаписьЖурналаРегистрации(
			НСтр("es='La dirección del acceso. El relleno de los datos para la restricción del acceso';ru='Управление доступом.Заполнение данных для ограничения доступа';en='Access Control: Fill in data to restrict access'",
				 ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Информация,
			,
			,
			НСтр("es='Es acabado el traslado de los datos del registro de UdalitNaboryZnacheniyDostupa.';ru='Завершен перенос данных из регистра УдалитьНаборыЗначенийДоступа.';en='Register УдалитьНаборыЗначенийДоступа. data transfer completed'"),
	...
	Иначе
		ЗаписьЖурналаРегистрации(
			...
			,
			,
			НСтр("es='Es cumplido el paso del traslado de los datos del registro de UdalitNaboryZnacheniyDostupa.';ru='Выполнен шаг переноса данных из регистра УдалитьНаборыЗначенийДоступа.';en='The step of transferring data from the УдалитьНаборыЗначенийДоступа has been completed.'"),
			РежимТранзакцииЗаписиЖурналаРегистрации.Транзакционная);
	КонецЕсли;
