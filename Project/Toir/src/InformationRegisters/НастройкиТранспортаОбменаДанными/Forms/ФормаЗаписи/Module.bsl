...
Процедура ОповеститьПользователяОРезультатахПодключения(Знач ОшибкаПодключения)
	...
	ТекстПредупреждения = ?(ОшибкаПодключения, НСтр("es='No consiguió establecer la conexión.';ru='Не удалось установить подключение.';en='Failed to establish connection.'"),
											   НСтр("es='La conexión es con éxito establecida.';ru='Подключение успешно установлено.';en='Connection successfully established.'"));
