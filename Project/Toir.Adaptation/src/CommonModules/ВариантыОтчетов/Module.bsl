...
Функция гкс_СформироватьОтчет(Знач Параметры, Знач ПроверятьЗаполнение, Знач ПолучатьФлажокПустой)
	...
	#Вставка
	Если Параметры.Свойство("СдвигЧП") Тогда 
		ДопСвойства.Вставить("СдвигЧП", Параметры.СдвигЧП);
	КонецЕсли;
	#КонецВставки
